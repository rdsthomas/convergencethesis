---
title: 'Maschinengeld'
subtitle: 'Warum KI, Roboter und Krypto eine Ökonomie ohne Menschen erschaffen'
author: 'Thomas Huhn'
date: 'März 2026'
lang: de-DE
...
Ich habe dieses Buch geschrieben, weil mich eine Frage nicht losgelassen hat. Als Investor, als Unternehmer, als jemand, der das Tempo dieser Veränderungen jeden Tag am eigenen Leib erlebt:


Was passiert, wenn Maschinen nicht nur denken und handeln können, sondern auch ihr eigenes Geld haben, und irgendwann ihre eigenen Unternehmen?
...
Was Sie in diesem Buch finden werden — und warum es sich lohnt, es bis zum Ende zu lesen: Dieses Buch wird Ihnen helfen, Ihr Vermögen in einer Welt zu sichern, die sich radikal verändert. Es wird Ihnen zeigen, wer die Gewinner und wer die Verlierer dieser Transformation sein werden — und wie Sie auf der richtigen Seite stehen.
...
Peter Thiel hat einmal gesagt, die wertvollsten Unternehmen bauen auf Überzeugungen auf, die fast niemand teilt, die aber richtig sind. Ich glaube, das gilt auch für Investmententscheidungen.


Dieses Buch ist meine Überzeugung. Prüfen Sie sie. Hinterfragen Sie sie. Und dann entscheiden Sie selbst.


Thomas Huhn, Februar 2026

![Abbildung 1: Die Konvergenz-These — KI, Robotik und Krypto verschmelzen zur Maschinenökonomie](images/00-konvergenz-venn-color.png)
...
Es gibt Momente in der Geschichte, in denen sich das Fundament der Wirtschaft verschiebt. Nicht sanft und vorhersehbar, sondern abrupt. Ein Beben, das alte Strukturen zertrümmert und neue aus dem Boden treibt.
...
Und ich investiere. In Bitcoin und Ethereum, seit Jahren. In KI-Aktien. In Robotik-Unternehmen. Mit meinem eigenen Geld, nicht mit dem meiner Kunden. Nassim Taleb nennt das Skin in the Game, die Bereitschaft, die eigenen Konsequenzen zu tragen. Wenn meine These falsch ist, verliere ich Geld. Das schärft die Analyse auf eine Weise, die keine akademische Forschung ersetzen kann.


Diese Doppelrolle, als jemand, der Neues entwickelt und als Investor, gibt mir eine Perspektive, die die meisten Bücher über dieses Thema nicht haben. Ich kann nicht nur erklären, was passiert, sondern warum es passiert und wie schnell, weil ich die Entwicklungszyklen aus der täglichen Arbeit kenne.
...
![Abbildung 2: 250 Jahre technologische Umbrüche — Gewinner und Verlierer jeder Revolution](images/01-250-jahre-umbrueche-color.png)

*Abbildung 2: 250 Jahre technologische Umbrüche — Gewinner und Verlierer jeder Revolution*


![Abbildung 3: Infrastruktur schlägt Anwendung — das gleiche Muster in vier Revolutionen](images/01b-infrastruktur-vs-anwendung-color.png)

*Abbildung 3: Infrastruktur schlägt Anwendung — das gleiche Muster in vier Revolutionen*
...
Am 30. November 2022 veröffentlichte OpenAI ChatGPT. Innerhalb von fünf Tagen hatte die Anwendung eine Million Nutzer. Innerhalb von zwei Monaten hundert Millionen. Kein Produkt in der Geschichte der Technologie hatte je schneller diese Schwelle erreicht, nicht das iPhone, nicht TikTok, nicht Instagram.
...
DeepSeek und das Ende des Compute-Monopols  Abbildung 6: DeepSeek — Der Sputnik-Moment der KI (Trainingskosten im Vergleich)
...
Phase 2 betrifft Wissensarbeiter und Unternehmen. Der adressierbare Markt: Hunderte von Milliarden Dollar jährlich. McKinseys Schätzung von 2,6 bis 4,4 Billionen Dollar Wertschöpfungspotenzial bezieht sich auf diese Phase. Jedes Unternehmen mit Büroarbeitsplätzen, von der Anwaltskanzlei bis zum DAX-Konzern.
...
![Abbildung 4: Die vier Phasen der KI — vom Werkzeug zur autonomen Maschine](images/02a-vier-phasen-ki-color.png)

*Abbildung 4: Die vier Phasen der KI — vom Werkzeug zur autonomen Maschine*


![Abbildung 5: Das KI-Ökosystem — Labore, Hyperscaler und ihre Verflechtungen](images/02b-ki-landscape-color.png)

*Abbildung 5: Das KI-Ökosystem — Labore, Hyperscaler und ihre Verflechtungen*


![Abbildung 6: DeepSeek — Der Sputnik-Moment der KI (Trainingskosten im Vergleich)](images/02c-deepseek-kosten-color.png)
...
21 Millionen Einheiten — nicht inflationierbar, nicht konfiszierbar, von keiner Regierung kontrolliert und von keiner Zentralbank manipulierbar.
...
![Abbildung 7: Maschine vs. Bankensystem — warum Krypto die Antwort ist](images/03a-maschine-vs-bank-color.png)

*Abbildung 7: Maschine vs. Bankensystem — warum Krypto die Antwort ist*


![Abbildung 8: Stablecoin-Volumen überholt Visa (2024: $27.6 Billionen)](images/03b-stablecoin-vs-visa-color.png)
...
Kapitel 3b: Wenn alles ein Token wird
...
Die Spannbreite allein, von 2 bis 30 Billionen, zeigt, dass niemand wirklich weiß, wie schnell das geht. Aber über die Richtung sind sich alle einig. Und dass die Wachstumskurve nicht linear sein wird, sondern exponentiell, wie bei jeder anderen Technologie in diesem Buch.
...
Japan ist der stille Pionier. Die Japan Financial Services Agency hat einen klaren Rahmen für Security Token Offerings geschaffen. SBI Holdings, Nomura und MUFG sind aktiv. Und, das ist der springende Punkt, Japan erlaubt tokenisierte Immobilien-STOs für Retail-Investoren ab etwa 500 Dollar. Während die USA Kleinanleger aussperren, lässt Japan sie herein. Mit Regeln, aber ohne die Millionenschwelle.
...
Das unsichtbare Schlachtfeld: Stablecoins, Dollar-Dominanz und die Schuldenbombe
...
Und da liegt das Problem der BRICS-Alternative: Die Mitglieder vertrauen einander nicht genug. Indien will seine Rupie nicht an den Yuan koppeln. Brasilien hat kein Interesse an einem System, das Peking kontrolliert. Russland ist aus der Not dabei, nicht aus Überzeugung. Indonesiens Außenministerium hat öffentlich erklärt, man sei „nicht an De-Dollarisierung interessiert". Trumps Drohung, BRICS-Ländern 100-Prozent-Zölle aufzuerlegen, hat weitere Mitglieder nervös gemacht.
...
![Abbildung 9: Von der physischen zur tokenisierten Welt](images/03c-tokenisierung-flow-color.png)

*Abbildung 9: Von der physischen zur tokenisierten Welt*


![Abbildung 10: Wer tokenisiert was? Die Wall-Street-Giganten steigen ein](images/03d-wer-tokenisiert-was-color.png)
...
Kapitel 3c: Wenn Maschinen Unternehmen gründen
...
Kein Uber, kein Lyft, kein CEO, kein Buchhalter, kein Mechaniker mit offenen Rechnungen — alles läuft über Code.
...
KI-Agenten, die autonom handeln können (Kapitel 2) plus Kryptowährungen als ihr Zahlungsmittel (Kapitel 3) plus tokenisierte Assets, die sie kaufen und verkaufen können (Kapitel 3b) plus Smart Contracts als ihre Geschäftsregeln plus DAOs als ihre Unternehmensstruktur.
...
![Abbildung 11: Anatomie einer Maschinen-Firma (DAO) — vom Auto zur autonomen Wirtschaftseinheit](images/03e-dao-anatomie-color.png)

*Abbildung 11: Anatomie einer Maschinen-Firma (DAO) — vom Auto zur autonomen Wirtschaftseinheit*
...
Kapitel 4: Die geopolitische Dimension — USA, China und Europas Schweigen
...
Ich sage das, was folgt, als Europäer. Als Deutscher. Mit dem Schmerz dessen, der zusehen muss, wie sein Kontinent eine historische Chance verspielt.
...
Meine amerikanischen Freunde bekommen weiterhin ihre 4,7 Prozent. Ich bekomme null. Nicht weil ich ein höheres Risiko eingänge oder Coinbase in Europa weniger sicher operierte — sondern weil europäische Regulierer entschieden haben, dass Stablecoins Zahlungsmittel sein sollen, keine Sparanlage. Die Absicht mag gut sein. Das Ergebnis ist, dass europäische Bürger systematisch schlechter gestellt werden als amerikanische.
...
Das bedeutet nicht, dass man sein gesamtes Portfolio in Krypto stecken sollte. Es bedeutet, dass Krypto in einem geopolitisch diversifizierten Portfolio eine Funktion hat, die kein anderes Asset erfüllen kann: die Absicherung gegen das Risiko, dass die Regeln des Spiels sich ändern — und zwar von Spielern, deren Interessen nicht mit den eigenen übereinstimmen.

![Abbildung 12: Die KI-Weltkarte — USA dominiert, China rivalisiert, Europa reguliert](images/04a-ki-weltkarte-color.png)

*Abbildung 12: Die KI-Weltkarte — USA dominiert, China rivalisiert, Europa reguliert*


![Abbildung 13: Der Chip-Krieg — TSMCs Nadelöhr in der globalen KI-Lieferkette](images/04b-chip-krieg-tsmc-color.png)
...
Kapitel 5: Energie — Der unsichtbare Engpass
...
Warum die Tech-Giganten Atomkraftwerke kaufen  Abbildung 14: Tech-Giganten werden Energiekonzerne
...
Microsoft hat 16 Milliarden Dollar in ein Abkommen investiert, um den Three Mile Island-Reaktor in Pennsylvania wieder in Betrieb zu nehmen. Ja, den Three Mile Island — den Ort des schwersten Nuklearunfalls in der Geschichte der USA. Die Ironie ist offensichtlich. Aber Microsofts Kalkül ist nüchtern: Three Mile Island liefert zuverlässig Grundlaststrom, ohne CO₂-Emissionen, in der Nähe wichtiger Rechenzentren an der Ostküste. Die Vergangenheit des Standorts ist ein PR-Problem. Die Physik ist solide.
...
Das sind keine Randnotizen. Das sind die größten Unternehmen der Welt, die Milliarden investieren, um ihre eigene Stromversorgung zu sichern — weil der Markt nicht schnell genug liefern kann, was sie brauchen.
...
COP30 hat das Problem offiziell anerkannt: 33 Länder haben sich zur Verdreifachung der Kernkraftkapazität bis 2050 bekannt. Die Nachfrage nach Uran und Anreicherung wird steigen. Das Angebot wächst langsamer. Die Preise haben nur eine Richtung.
...
![Abbildung 14: Tech-Giganten werden Energiekonzerne — die größten Kraftwerk-Deals der KI-Ära](images/05a-kraftwerk-kaeufer-color.png)

*Abbildung 14: Tech-Giganten werden Energiekonzerne — die größten Kraftwerk-Deals der KI-Ära*


![Abbildung 15: Energiehunger der KI — US-Rechenzentren fressen 12% des Stromnetzes bis 2030](images/05b-energiehunger-ki-color.png)

*Abbildung 15: Energiehunger der KI — US-Rechenzentren fressen 12% des Stromnetzes bis 2030*




Kapitel 6: Der menschliche Preis — Arbeit, Sinn und gesellschaftliche Verwerfungen
...
Für den größten Teil der Menschheitsgeschichte hat „Arbeit" nicht existiert, zumindest nicht in der Form, die wir kennen. Jäger und Sammler, die über 90 Prozent der menschlichen Geschichte ausmachen, arbeiteten schätzungsweise drei bis fünf Stunden am Tag, je nach Saison und Umgebung. Der Rest war Soziales, Geschichten erzählen, Handwerk, Spiel. Es gab keinen „Chef" im modernen Sinne, sondern Stammesführer, deren Autorität auf Erfahrung, Mut oder Verwandtschaft beruhte und die jederzeit infrage gestellt werden konnte. „Steuern" waren ein Anteil an der Jagdbeute, der mit der Gruppe geteilt wurde, nicht aus Zwang, sondern weil Kooperation Überleben sicherte.


Die agrarische Revolution vor etwa 10.000 Jahren änderte alles. Sesshaftigkeit erforderte Landbesitz. Landbesitz erforderte Schutz. Schutz erforderte Krieger. Krieger erforderten Versorgung. Und so entstand, über Jahrtausende hinweg, das Feudalsystem: Ein Lehnsherr besaß das Land. Bauern bearbeiteten es. Dafür gab der Lehnsherr Schutz und nahm Abgaben. Typischerweise zwischen einem Drittel und der Hälfte der Ernte, oft mehr.


Das Feudalsystem war keine Anomalie. Es war die dominante Wirtschaftsordnung auf fast allen Kontinenten, für fast die gesamte aufgezeichnete Geschichte. Von den pharaonischen Fronarbeitern über die römischen Latifundien, die mittelalterlichen Lehnsgüter, die japanischen Daimyō bis zu den russischen Leibeigenen: Die Struktur war immer dieselbe. Eine kleine Klasse besaß die produktiven Ressourcen (Land). Eine große Klasse arbeitete darauf und gab den Großteil des Ertrags ab. Die Rechtfertigung wechselte (göttliches Recht, militärische Stärke, Tradition), aber die Ökonomie blieb gleich: Wer das Land kontrollierte, kontrollierte die Arbeit.


Dann kam die Industrialisierung, und sie brauchte etwas, das es bis dahin nicht gegeben hatte: gehorsame, pünktliche, gleichförmig ausgebildete Arbeiter.


Die Erfindung des Arbeiters


Die Fabrik war eine neue Art von Arbeitsort, die eine neue Art von Mensch erforderte. Ein Bauer auf seinem Feld arbeitete nach dem Rhythmus der Jahreszeiten, nach seinem eigenen Urteil, in seinem eigenen Tempo. Ein Fabrikarbeiter musste um sechs Uhr morgens an einer Maschine stehen, acht bis zwölf Stunden lang, im Takt der Maschine, ohne eigenständige Entscheidungen. Er musste lesen können (um Anweisungen zu verstehen), rechnen können (um Stückzahlen zu kontrollieren), und vor allem: gehorchen können.


Das preußische Schulsystem, formalisiert unter Friedrich dem Großen im späten 18. Jahrhundert, lieferte genau das. Es war das erste staatliche Bildungssystem der Welt, und es hatte ein klares Ziel: gehorsame Untertanen und zuverlässige Soldaten produzieren. Kinder wurden in Altersgruppen eingeteilt (wie Fabrikschichten), saßen in Reihen (wie an Fließbändern), folgten einem starren Stundenplan (wie Schichtpläne), und lernten vor allem eines: Autorität zu respektieren und Anweisungen zu befolgen.


Horace Mann, der erste Bildungssekretär von Massachusetts, reiste 1843 nach Preußen, war begeistert und brachte das Modell in die USA. Von dort verbreitete es sich um die Welt. Das Schulsystem, das wir heute kennen, mit Klassenzimmern, Stundenplänen, Noten, Prüfungen und dem Aufstieg durch Jahrgangsstufen, wurde nicht entworfen, um unabhängiges Denken zu fördern. Es wurde entworfen, um eine Arbeitskraft zu produzieren, die in Fabriken und Büros funktioniert.


Die Begriffe „White Collar" und „Blue Collar" selbst sind Erfindungen des 20. Jahrhunderts. „White Collar" wurde 1919 von Upton Sinclair geprägt, „Blue Collar" folgte in den 1920er Jahren. Die Unterscheidung zwischen Kopfarbeit und Handarbeit, zwischen dem Mann im Büro und dem Mann in der Fabrik, die wir heute für so selbstverständlich halten, ist gerade einmal hundert Jahre alt.


Was davor als „Arbeit" galt, war fundamental anders. Ein mittelalterlicher Handwerker, ein Schmied oder Weber, arbeitete in seinem eigenen Tempo, nach seiner eigenen Methode, oft in seinem eigenen Haus. Er hatte keine „Karriere" im modernen Sinne, keinen „Arbeitgeber", keine „Arbeitszeitregelung". Die Idee, dass ein Mensch seine Zeit an eine Organisation verkauft, die ihm dafür monatlich eine feste Summe überweist, wäre ihm absurd vorgekommen. Und historisch gesehen ist sie absurd: Sie existiert seit weniger als 0,1 Prozent der Menschheitsgeschichte. Wer hat profitiert? Die arbeitsteilige Gesellschaft mit ihren White-Collar- und Blue-Collar-Schichten wurde nicht von den Arbeitern selbst erfunden. Sie wurde von den Besitzern der Produktionsmittel erfunden, den Fabrikanten des 19. Jahrhunderts, den Industriebaronen, den Rockefellers und Carnegies und Krupps, weil sie ein System brauchten, das zuverlässig und skalierbar menschliche Arbeitskraft in wirtschaftliche Erträge umwandelte.


Das Schulsystem lieferte die Rohstoffe: pünktliche, fügsame, ausreichend gebildete Arbeitskräfte. Die Fabrik verarbeitete sie. Die Unternehmenshierarchie, eine Erfindung des frühen 20. Jahrhunderts, inspiriert von der militärischen Befehlskette, organisierte sie. Das Ergebnis war eine Gesellschaftsordnung, in der die Besitzer des Kapitals den Großteil der Wertschöpfung abschöpften, während die Arbeiter (ob Blue oder White Collar) genug erhielten, um zu konsumieren und die nächste Generation von Arbeitern aufzuziehen.


Marx hat das 1848 so formuliert: „Die moderne bürgerliche Gesellschaft, die aus dem Untergang der feudalen Gesellschaft hervorgegangen ist, hat die Klassengegensätze nicht aufgehoben. Sie hat nur neue Klassen, neue Bedingungen der Unterdrückung, neue Formen des Kampfes an die Stelle der alten gesetzt."


Man muss kein Marxist sein, um die Struktur zu erkennen: Der Feudalherr wird zum Fabrikbesitzer, dann zum CEO; der Bauer zum Fabrikarbeiter, dann zum Angestellten. Die Abgabe heißt nicht mehr „Zehnt", sondern „Gewinnmarge". Aber die Grundstruktur, eine Klasse besitzt die Produktionsmittel, eine andere arbeitet damit und gibt den Großteil des Mehrwerts ab, ist dieselbe.
...
Die Frage ist nicht, ob es neue Feudalherren geben wird. Es wird sie geben. Die Frage ist, ob Sie zu ihnen gehören oder zu ihren Bauern.
...
Diesmal gibt es gute Gründe, warum das Muster brechen könnte.
...
Emad Mostaque formuliert das in „The Last Economy“ prägnant: „We are about to achieve post-scarcity in the realm of intelligence, and our scarcity-based economic system is going to process this abundance as poverty.“ Wir stehen kurz davor, im Bereich der Intelligenz den Mangel zu überwinden — und unser auf Knappheit gebautes Wirtschaftssystem wird diese Fülle als Armut verbuchen.
...
Mostaque geht noch weiter und beschreibt, was er „nicht-metabolische Arbeit“ nennt: KI und Roboter brauchen keinen Schlaf, kein Essen, keine Krankenversicherung, keine Rente. Sie brauchen Strom. In einer rein ökonomischen Kalkulation, die nur Produktivität pro Kosteneinheit misst, kann der Wert menschlicher Arbeit negativ werden — weil die Kosten für Versicherung, Arbeitsrecht, Krankheitstage und Fehlerquoten den Output übersteigen, den ein Mensch gegenüber einer Maschine noch liefern kann. Das klingt brutal. Und es soll brutal klingen, weil es die Frage aufwirft, die dieses Kapitel stellt: Was ist der menschliche Preis, wenn die Maschinen nicht nur billiger arbeiten, sondern wenn die gesamte Metrik, mit der wir Arbeit messen, zu ihren Gunsten konstruiert ist?
...
![Abbildung 16: Welche Jobs verschwinden, welche entstehen (WEF Future of Jobs Report)](images/06a-jobs-verschwinden-entstehen-color.png)

*Abbildung 16: Welche Jobs verschwinden, welche entstehen (WEF Future of Jobs Report)*


![Abbildung 17: Die Geschichte der Arbeit — vier Epochen und der aktuelle Umbruch](images/06b-geschichte-der-arbeit-color.png)
...
Kapitel 7: Regulierung — Der Elefant im Raum
...
Die Frage ist nicht ob Regulierung kommt. Sie kommt. Die Frage ist wie sie kommt, und was das für Investoren bedeutet.
...
Präsident Biden hatte 2023 eine Executive Order zu KI erlassen, die Transparenz, Sicherheit und verantwortungsvollen Einsatz betonte — aber keine verbindlichen Regulierungen schuf. Die Verordnung setzte auf freiwillige Commitments der Tech-Industrie und beauftragte Bundesbehörden, Leitlinien zu entwickeln.
...
Das ist keine Verschwörungstheorie. Es ist die ökonomische Logik von Regulierung, die seit George Stiglers „Theory of Regulation" aus den 1970er Jahren bekannt ist: Regulierung wird oft von genau den Unternehmen begrüßt und mitgestaltet, die sie angeblich einschränkt — weil sie deren Marktposition schützt.
...
Wir kennen jetzt die Technologie, die Geopolitik, die Energie und die Regulierung. Im nächsten Kapitel spielen wir die wahrscheinlichste Entwicklung der nächsten zehn Jahre durch — ein konkretes Szenario, das diese Faktoren zusammenführt.

![Abbildung 18: Regulierungs-Geschwindigkeiten — USA, China und Europa im Vergleich](images/07-regulierung-ampel-color.png)
...
Kapitel 8: Das wahrscheinlichste Szenario: 2026–2035
...
Doch das ist nicht alles: Die ersten humanoiden Roboter arbeiten in kontrollierten Umgebungen. Teslas Fabriken, Amazon-Lagerhäuser, japanische Pflegeheime. Sie machen keine komplexen Aufgaben, sie sortieren, transportieren, stapeln. Aber sie funktionieren. Und sie werden mit jedem Monat besser.
...
Werbeagenturen, Softwareentwicklungsfirmen, Steuerberater bei Routinearbeiten, Rechtsanwälte bei Standardfällen: Alle diese Branchen werden nicht verschwinden, aber sie werden schrumpfen. Dramatisch. Die Frage ist nicht ob, sondern wie schnell. Und die Antwort ist: schneller als die meisten denken.
...
![Abbildung 19: Die Zeitleiste 2026–2035 — vom KI-Agenten zum Roboter-Haushalt](images/08-szenario-2026-2035-color.png)

*Abbildung 19: Die Zeitleiste 2026–2035 — vom KI-Agenten zum Roboter-Haushalt*




Kapitel 9: Das nächste Interface – Von der Tastatur zum Gedanken
...
![Abbildung 20: Die Evolution der Interfaces — von der Lochkarte zum Gedanken](images/09-bci-interface-evolution-color.png)

*Abbildung 20: Die Evolution der Interfaces — von der Lochkarte zum Gedanken*




Kapitel 10: Ethik und Philosophie der Maschinenökonomie
...
Das ist keine romantische Verklärung. Es ist eine nüchterne Einsicht: Wenn Maschinen alles können außer zu wollen, dann wird das Wollen zur letzten menschlichen Kernkompetenz. Was Mostaque die „Arts of Being Human“ nennt — Weisheit, Geschmack, moralisches Urteil, Empathie, Sinnstiftung — das sind keine Soft Skills mehr, die man in Bewerbungsgesprächen herunterbetet. Es sind die letzten ökonomischen Inputs, die nicht automatisierbar sind. Die Frage „Werden wir zum Werkzeug?“ lässt sich also auch anders stellen: Werden wir den Übergang schaffen vom Produzenten zum Navigateur? Vom Arbeiter zum Kompass?
...
Die Maschinenökonomie wird kommen. Die Frage ist nicht, ob wir sie verhindern können. Die Frage ist, ob wir sie so gestalten, dass sie menschliches Gedeihen fördert, statt es zu untergraben. Und ob wir als Investoren auf der richtigen Seite dieser Gestaltung stehen.
...
Kapitel 11: Unsterblichkeit als Investmentthese — Wie KI die Grenzen des Alterns verschiebt
Es gibt eine Konvergenz, die noch radikaler ist als alles, was wir bisher besprochen haben. Radikaler als autonome Agenten, radikaler als Maschinengeld, radikaler sogar als Brain-Computer Interfaces, die Gedanken in Welten verwandeln.
...
Im Januar 2026, auf der Biotech Showcase während der JPM-Woche, einer der größten Biotech-Konferenzen weltweit, präsentierte ein Unternehmen aus Miami Beach Daten, die das ändern könnten. Immortio Bio, gegründet Ende 2023, geführt von CEO Dr. Boris Resnik und dem wissenschaftlichen Leiter Dr. Thomas Ichim, der über 130 Publikationen und 360 Patente in regenerativer Medizin und Immunologie vorweisen kann.
Ihre Idee war simpel und radikal zugleich: Warum versuchen wir, Zombie-Zellen mit Medikamenten zu töten, wenn wir das Immunsystem trainieren können, es selbst zu tun?
Ihre Plattform heißt Senovax, und sie funktioniert wie eine Impfung. Aber nicht gegen ein Virus. Gegen das Altern. Man entnimmt dem Patienten dendritische Zellen, das sind die Lehrmeister des Immunsystems. Separat erzeugt man im Labor seneszente Zellen aus dem Gewebe des Patienten, indem man sie künstlich altert. Dann bringt man beides zusammen. Die dendritischen Zellen studieren die Oberflächen-Marker der seneszenten Zellen und erstellen gewissermaßen einen Steckbrief. Dann injiziert man die trainierten Immunzellen zurück in den Körper. Ab jetzt hat das Immunsystem ein Ziel: jede seneszente Zelle, die diese Marker trägt.
Was diesen Ansatz von Pillen unterscheidet, ist fundamental. Das Immunsystem geht überall hin, in jedes Gewebe, jedes Organ. Man muss nicht hoffen, dass ein Medikament in der richtigen Konzentration am richtigen Ort ankommt. Das Immunsystem ist selektiv: Es greift Zellen mit bestimmten Markern an und lässt gesunde Zellen in Ruhe. Und es hat ein Gedächtnis. Einmal trainiert, erinnert es sich. Eine Behandlung könnte dauerhaften Schutz bieten.
Aber Zombie-Zellen zu töten ist nur die halbe Arbeit. Stellen Sie sich vor, die Armee rückt in eine Stadt ein und eliminiert jeden Zombie. Bedrohung beseitigt. Aber wenn man sich dann umschaut, sind die Straßen verwüstet, die Gebäude zerstört, die Infrastruktur am Boden. Man braucht nicht nur Soldaten. Man braucht auch einen Bautrupp.
Und genau das hat Immortio Bio verstanden. Ihre zweite Plattform heißt Stem Cell Revivify. Sie erzeugt personalisierte mesenchymale Stammzellen, die auf den jeweiligen Patienten abgestimmt sind. Mesenchymale Stammzellen sind die Reparaturarbeiter des Körpers: Sie können sich in Knochen-, Knorpel-, Fett- oder Bindegewebszellen verwandeln und setzen regenerative Signale frei, die geschädigtem Gewebe bei der Heilung helfen.
Das Problem mit bisherigen Stammzelltherapien war immer die Umgebung. Wer Stammzellen in einen Körper injiziert, der voller seneszenter Zellen steckt, die entzündliche SASP-Faktoren auspumpen, kann zusehen, wie die Stammzellen zugrunde gehen, bevor sie ihre Arbeit tun können. Blumen in einer Giftmülldeponie pflanzen. Dr. Ichim formuliert es so: Seneszente Zellen und ihre entzündlichen Sekrete hemmen die Geweberegeneration aktiv. Indem wir diese Barriere zuerst mit Senovax beseitigen, können personalisierte Stammzellen Funktionen wiederherstellen, die mit keinem der beiden Ansätze allein erreichbar wären.
Erst die Barriere entfernen. Dann wiederaufbauen. Das ist die ganze Idee.
Die Ergebnisse, die Immortio Bio im Januar 2026 präsentierte, sind in einem validierten Altersmodell entstanden, dem Doxorubicin-induzierten systemischen Seneszenz-Modell bei Mäusen. Ein Standard der Branche, bei dem ein Chemotherapeutikum Mäuse künstlich altern lässt, indem es ihren Körper mit seneszenten Zellen flutet.
Senovax allein: gute Ergebnisse. Stammzellen allein: gute Ergebnisse. Die Kombination: Verdopplung der Lebensdauer.
Nicht eine moderate Verbesserung. Nicht ein statistisch signifikanter Anstieg. Verdopplung.
Um das einzuordnen: In der gesamten Geschichte der Longevity-Forschung haben die besten Interventionen, kalorische Restriktion, Rapamycin, Metformin, die Lebensdauer von Mäusen um 20 bis 30 Prozent verlängert. Verdopplung ist eine völlig andere Kategorie.
Und es war nicht nur die Lebensdauer. Die Mäuse waren gesünder. Die Kombinationstherapie senkte die SASP-Entzündungsmarker drastisch, steigerte Verjüngungsfaktoren, verbesserte die Leberfunktion (gemessen an niedrigeren ALT-Werten, einem Standard-Biomarker für Lebergesundheit) und erhöhte die Kletterkraft der Tiere, ein etabliertes Maß für Vitalität in Alterungsstudien.
Der Krebs-Winkel macht die Sache noch interessanter. Tumore umgeben sich mit seneszenten Zellen. Krebs braucht diese Zombie-Zellen regelrecht zum Wachsen: Er schafft eine beschleunigt alternde Umgebung um sich herum, und die seneszenten Zellen in dieser Umgebung liefern Wachstumsfaktoren, die den Tumor füttern. Krebs baut sich sein eigenes Versorgungsnetzwerk aus Zombie-Zellen.
Was passiert, wenn man mit Senovax dieses Versorgungsnetzwerk zerstört? Man entzieht dem Tumor seine Infrastruktur. Immortio Bio hat Daten veröffentlicht, die Tumorreduktion in Mausmodellen für Lungenkrebs, Brustkrebs, Bauchspeicheldrüsenkrebs und Hirnkrebs zeigen. In Kombination mit bereits zugelassenen Checkpoint-Inhibitoren (Anti-PD-L1 und Anti-CTLA-4 Immuntherapien) erzielte Senovax synergistische Effekte: bessere Tumorreduktion als jede Therapie allein.
Dr. Ichim sagt dazu: Nach unserem Kenntnisstand ist dies der erste klinische Kandidat, der das Immunsystem darauf trainiert, nicht den Krebs selbst anzugreifen, sondern die Zellen, die ihn beschützen. Im Gegensatz zu Krebszellen, die ständig mutieren und sich der Behandlung entziehen, mutieren die seneszenten Zellen um den Tumor herum nicht. Sie sind ein stabiles Ziel.
Das ist der entscheidende Punkt. Krebs ist so schwer zu behandeln, weil er sich ständig verändert. Die Zombie-Zellen, die ihn am Leben halten, tun das nicht. Sie sind ein festes Ziel für das Immunsystem.
Die FDA prüft derzeit Senovax für eine klinische Studie bei fortgeschrittenem Lungenkrebs. Ein IND (Investigational New Drug Application) ist eingereicht. Wenn er bewilligt wird, könnten die ersten Studien am Menschen über den Krebs-Pfad beginnen, und die Longevity-Anwendungen würden folgen.
Zwei Einschränkungen muss man ehrlich benennen. Erstens: Das Mausmodell verwendet chemisch induziertes Altern, nicht natürliches. Die Ergebnisse bei natürlich gealterten Mäusen stehen noch aus. Zweitens: Mäuse sind keine Menschen. Der Weg von einer verdoppelten Mäuse-Lebensdauer zu einer Therapie, die menschliches Altern verlangsamt, ist lang und voller Fallstricke.
Aber die Wissenschaft ist solide. Der FDA-Pfad ist eingeleitet. Und wenn auch nur ein Bruchteil dieser Ergebnisse auf den Menschen übertragbar ist, reden wir nicht über ein paar zusätzliche Jahre. Wir reden über eine grundlegende Verschiebung dessen, was menschliches Altern bedeutet.
...
In Kapitel 6 haben wir beschrieben, wie die Maschinenökonomie zu einer Sinnkrise führt, weil Arbeit als identitätsstiftendes Element wegfällt. Jetzt multiplizieren Sie diese Krise mit der Unendlichkeit.
...
In Kapitel 9 haben wir beschrieben, wie Brain-Computer Interfaces und KI-generierte Welten synthetische Erfahrungen schaffen werden, die von Realität nicht zu unterscheiden sind. Jetzt fügen wir humanoide Roboter hinzu, die nicht nur physisch, sondern emotional auf Menschen reagieren können.
...
![Abbildung 21: Das Smart Money wettet auf Unsterblichkeit — die größten Longevity-Investments](images/11-longevity-smart-money-color.png)

*Abbildung 21: Das Smart Money wettet auf Unsterblichkeit — die größten Longevity-Investments*
...
Kapitel 12: Die Barbell-Strategie — Ein Portfolio für die Maschinenökonomie
...
Der Templeton-Test: Wo ist der maximale Pessimismus? John Templeton sagte: "Bull markets are born on pessimism." Die besten Investments findet man dort, wo die Angst am größten ist.
...
Die Soros-Frage: Wo ist die falsche Prämisse? George Soros wurde reich, indem er Trends fand, deren Grundannahme falsch war. "Find the trend whose premise is false."
...
Die Munger-Inversion: Was kann schiefgehen? Charlie Munger sagte: "Sag mir, wo ich sterben werde, damit ich nicht dorthin gehe." Statt zu fragen, wie man mit der Maschinenökonomie Geld verdient, fragen wir: Wie verliert man sicher Geld?
...
![Abbildung 22: Die Barbell-Strategie — Kern (60–70%) vs. asymmetrische Wetten (30–40%)](images/12a-barbell-strategie-color.png)

*Abbildung 22: Die Barbell-Strategie — Kern (60–70%) vs. asymmetrische Wetten (30–40%)*


![Abbildung 23: Drei Portfolio-Varianten — konservativ, ausgewogen, aggressiv](images/12b-portfolio-varianten-color.png)
...
Emad Mostaque beschreibt in „The Last Economy“ einen Mechanismus, der das Konzentrationsrisiko über das historische Muster hinaus verschärft: das „Network Prison“. Seine These: In digitalen Märkten folgt die Verteilung nicht der Glockenkurve, sondern dem Potenzgesetz. Eine winzige Zahl von Knoten hat gigantische Verbindungen, die Masse hat fast keine. Das ist kein moralisches Versagen, sondern mathematische Unvermeidbarkeit: Preferential Attachment — die Reichen werden reicher, weil Netzwerke so funktionieren. KI verstärkt diesen Effekt bis zur „gravitational collapse“: Bessere Daten ziehen mehr Nutzer an, mehr Nutzer produzieren bessere Daten, bessere Daten trainieren bessere Modelle. Die erfolgreichen Netzwerke werden zu schwarzen Löchern, aus denen weder Nutzer noch Kapital entkommen. Für Investoren ist das eine zweischneidige Klinge: Wer drin ist, profitiert vom Sog. Wer auf den falschen Knoten gesetzt hat, verliert alles.
...
Existenzielles Risiko: Die Frage, die niemand beantworten kann Geoffrey Hinton, Nobelpreisträger und einer der Väter des Deep Learning, schätzt eine zehn- bis zwanzigprozentige Wahrscheinlichkeit, dass KI innerhalb der nächsten dreißig Jahre zur menschlichen Auslöschung führt. In einem früheren Interview nannte er sogar fünfzig Prozent. Yoshua Bengio, ein weiterer Turing-Preisträger, warnt vor „irreversiblem Kontrollverlust über autonome KI-Systeme". Über hundert KI-Professoren haben ein Statement unterzeichnet, das KI-Risiko auf eine Stufe mit Pandemien und Atomkrieg stellt.
...
Regulierung: Immer nur eine Bremse Der EU AI Act wird ab August 2026 vollständig anwendbar. MiCA erzwingt die Lizenzierung aller Krypto-Dienstleister in Europa. Compliance-Kosten von 200.000 Euro pro Jahr und mehr für Startups. Ich habe in früheren Kapiteln ausführlich dargelegt, was diese Regulierung kostet und wen sie trifft (vor allem die Kleinen).
...
Krypto-Volatilität: Erfahrung schlägt Theorie Bitcoin ist seit seinem Allzeithoch um etwa 50 Prozent gefallen. Von rund 126.000 Dollar auf 65.000. Die Nachrichtenportale titeln „Krypto-Crash". Analysten sprechen vom Ende des Bull Runs.
...
Der persönliche Stresstest: Was ich über Drawdowns gelernt habe Das letzte und vielleicht wichtigste Risiko ist kein Marktrisiko. Es bist du selbst.
...
![Abbildung 24: Risiko-Matrix — Wahrscheinlichkeit vs. Impact der größten Risiken](images/13-risiko-matrix-color.png)

*Abbildung 24: Risiko-Matrix — Wahrscheinlichkeit vs. Impact der größten Risiken*




Kapitel 14: Warum jetzt – Und warum Zögern der größte Fehler ist
...
Und dann: Halten. Nicht jeden Tag ins Portfolio schauen. Nicht bei jedem Kursrückgang nervös werden. Einmal im Quartal überprüfen, einmal im Jahr rebalancen. Die Barbell-Strategie ist eine Langfriststrategie. Sie funktioniert über Dekaden, nicht über Tage. Die Schlussfrage Die Konvergenz von Künstlicher Intelligenz, Robotik und Kryptowährungen ist nicht eine Möglichkeit unter vielen. Sie ist die wahrscheinlichste Zukunft. KI wird die Intelligenz liefern, Roboter werden die physische Arbeit übernehmen, und Krypto wird das Schmiermittel der Maschinenökonomie sein. Wer diese drei Säulen versteht und in sie investiert, positioniert sich auf der richtigen Seite der größten Vermögenstransformation unserer Lebenszeit.
...
wenn du das eines Tages liest, wirst du nicht verstehen, warum dein Opa ein ganzes Buch über Maschinen und Geld geschrieben hat. Das ist okay. Ich will dir trotzdem erzählen, warum ich es getan habe.


Du bist drei Jahre alt, während ich das schreibe. Du hast eine Krankheit, die so selten ist, dass die Ärzte keinen Namen für die Behandlung haben, weil es keine Standardbehandlung gibt. Jeder Schritt in deiner Therapie ist ein Experiment. Deine Eltern, deine Oma und ich, wir tun, was wir können. Aber es gibt Momente, in denen das, was wir können, nicht genug ist.
...
KI-Systeme analysieren heute schon Millionen von Molekülkombinationen in Stunden statt in Jahrzehnten. Sie kartieren genetische Mutationen, die so selten sind, dass kein menschlicher Forscher genug Fälle sieht, um Muster zu erkennen. Sie beschleunigen die Medikamentenentwicklung auf eine Weise, die vor fünf Jahren undenkbar war. AlphaFold hat die dreidimensionale Struktur von über 200 Millionen Proteinen vorhergesagt und damit der Biologie in einem Jahr mehr gegeben als menschliche Forscher in einem halben Jahrhundert erarbeitet hatten.


Während ich dieses Buch schrieb, hat ein kleines Biotech-Unternehmen in Miami gezeigt, dass man das Immunsystem trainieren kann, die Zellen zu jagen und zu zerstören, die unseren Körper alt und krank machen. Nicht mit Medikamenten, die man lebenslang schlucken muss, sondern mit einer Impfung, die das Immunsystem einmal lernt und dann nicht vergisst. In Kombination mit Stammzellen, die den Körper danach wiederaufbauen, haben sie die Lebensdauer von Mäusen verdoppelt. Und derselbe Ansatz kann auch die Zellen zerstören, die Tumore am Leben halten. Die Grenzen zwischen Krebsforschung und Altersforschung verschwimmen, weil die Ursachen verwandt sind. Was heute Mäusen hilft, wird morgen Menschen helfen.


Die Technologie, die in diesem Buch beschrieben wird, ist nicht abstrakt. Sie ist der Grund, warum ich glaube, dass deine Krankheit, für die es heute keine Standardbehandlung gibt, weil die Mutation so selten ist, dass die menschliche Forschung schlicht zu wenige Fälle kennt, in zehn Jahren eine behandelbare Krankheit sein wird. Nicht weil ich naiv bin. Sondern weil ich sehe, was diese Maschinen können, wie schnell sie besser werden, und weil ich weiß, dass die Knappheit, die heute die Medizin begrenzt, nicht die Menge an vorhandenen Medikamenten ist, sondern die Geschwindigkeit, mit der wir neue finden.


KI wird diese Geschwindigkeit verändern. Nicht um den Faktor zwei oder drei. Um den Faktor hundert. Tausend. Und irgendwo in dieser Beschleunigung liegt die Antwort auf deine Mutation.


Ich bin Technologie-Optimist. Nicht weil ich glaube, dass Technologie keine Risiken hat. In diesem Buch habe ich ein ganzes Kapitel über die Risiken geschrieben, über Jobverlust, über Suchtpotenzial, über Kontrollverlust. Ich bin Optimist, weil die Alternative Resignation ist. Und Resignation hilft dir nicht.


Die Welt, in der du aufwächst, wird anders sein als die, die ich kenne. Maschinen werden arbeiten. KI-Agenten werden wirtschaften. Roboter werden in Fabriken stehen und in Krankenhäusern helfen. Kryptowährungen werden das Schmiermittel sein, das diese Maschinenökonomie zusammenhält. Das klingt fremd, vielleicht beunruhigend.


Aber es ist auch eine Welt, in der kein Kind an einer Krankheit sterben muss, nur weil die Mutation zu selten ist, als dass die menschliche Forschung sie schnell genug versteht. In der Maschinen die Arbeit übernehmen, die Menschen nicht tun wollen, und Menschen die Zeit bekommen, die Dinge zu tun, die nur Menschen tun können. Füreinander da sein. Spielen. Lieben. Sich um eine kranke Enkeltochter kümmern und ihr Geschichten erzählen, bis sie einschläft.


Dieses Buch ist meine Art, an dieser Zukunft mitzubauen. Nicht als Ingenieur, der den Code schreibt, sondern als jemand, der erklärt, warum dieser Code geschrieben werden muss, und der investiert, damit die Unternehmen, die ihn schreiben, die Mittel haben, es zu tun.


Und es ist ein Versprechen an dich: Ich werde nicht aufhören, nach der Antwort zu suchen. Nicht als Arzt, der deine Blutwerte liest, das können andere besser. Sondern als jemand, der versteht, welche Technologien die Antwort liefern können, und der alles tut, damit sie schnell genug kommen.
...
Ethereum: Die zweitgrößte Blockchain nach Bitcoin — aber mit einem entscheidenden Unterschied: Auf Ethereum laufen Programme (Smart Contracts). Wenn Bitcoin digitales Gold ist, dann ist Ethereum ein programmierbarer Weltcomputer, auf dem ganze Finanzsysteme gebaut werden können.
...
Energie und Uran: Der Global X Uranium ETF (ISIN: IE000NDWFGA5) investiert in Uranproduzenten und Versorger. Für die Nuklear-These aus Kapitel 5 eine gezielte Wette.
...
Howard Marks: "The Most Important Thing" — Die Investmentphilosophie, die diesem Buch zugrunde liegt. Nassim Nicholas Taleb: "Antifragile" — Warum Volatilität kein Feind ist, sondern ein Freund. Ray Kurzweil: "The Singularity Is Nearer" (2024) — Die aktualisierte Version seiner Prognosen zur technologischen Singularität. Emad Mostaque: "The Last Economy" (2025) — Der theoretische Unterbau zur Intelligence Inversion: Warum Intelligenz die letzte ökonomische Ressource ist, die von knapp zu abundant wird, und was das für Gesellschaft, Währungen und die Rolle des Menschen bedeutet. Kostenlos verfügbar auf thelasteconomy.com. David Sinclair: "Lifespan" — Die Wissenschaft der Langlebigkeit, Grundlage für Kapitel 11. Peter Thiel: "Zero to One" — Wie Monopole in der Technologie entstehen und warum Wettbewerb überschätzt wird. Balaji Srinivasan: "The Network State" — Die politische Dimension von Krypto und dezentraler Governance.


On-Chain-Daten und Research


DefiLlama (defillama.com) — TVL-Daten für alle DeFi-Protokolle, kostenlos und open source. Dune Analytics (dune.com) — Benutzerdefinierte On-Chain-Dashboards für Ethereum, Solana und andere Chains. Glassnode (glassnode.com) — Bitcoin- und Ethereum-On-Chain-Metriken für Investoren. The Block (theblock.co) — Research-Dashboards für Krypto-Marktdaten und institutionelle Flows. rwa.xyz — Speziell für tokenisierte Real-World Assets: TVL, Protokollvergleiche, Wachstumsraten.


KI und Technologie


Situational Awareness (situational-awareness.ai) — Leopold Aschenbrenners Essay über die Geschwindigkeit der KI-Entwicklung. AI Index Report (Stanford HAI) — Jährlicher Bericht zur globalen KI-Landschaft mit Daten statt Meinungen. NVIDIA GTC Keynotes (nvidia.com/gtc) — Jensen Huangs Präsentationen sind die beste Primärquelle für den Stand der KI-Hardware.


Weiterbildung


Google AI Essentials (coursera.org) — Kostenloser Einsteigerkurs für KI-Grundlagen. Blockchain Fundamentals (edx.org, Berkeley) — Grundlagen der Blockchain-Technologie, akademisch fundiert. Prompt Engineering for Everyone (DeepLearning.AI) — Praktischer Kurs für den Umgang mit KI-Systemen.
