...
#page(header: none, footer: none)[
  #v(0.62fr)
  #block(width: 100%)[
    #text(font: "Source Sans 3", size: 9.2pt, weight: "semibold", fill: navy)[The AI Species]
    #v(3pt)
    #text(size: 8.6pt, style: "italic", fill: rgb("#555"))[Besitze sie. Sonst besitzt sie dich.]
    #v(10pt)
...
#state("running-matter", false).update(true)

#heading(level: 1)[Vorwort]


#drop-cap[D][ieses Buch ist Mila gewidmet.]


Mila ist meine Enkeltochter. Sie ist drei Jahre alt, und sie hat eine Form von Leukämie, die so selten ist, dass es dafür keine Standardtherapie gibt. Keine erprobte Medikamentenkombination, kein Protokoll, das Ärzte routiniert abarbeiten können. Jeder Behandlungsschritt ist ein Experiment.


Wenn ich über Künstliche Intelligenz schreibe, über ihre Fähigkeit, Muster in Daten zu erkennen, die kein Mensch sehen kann, über Algorithmen, die Millionen von Molekülkombinationen in Stunden durchspielen statt in Jahrzehnten, über maschinelles Lernen, das seltene genetische Mutationen kartiert und Therapieansätze findet, die menschlichen Forschern verborgen bleiben, dann ist das für mich keine abstrakte Investmentthese.


Es ist Hoffnung. Konkret und persönlich.
...
Ein Wort zu meinem Standpunkt, weil er relevant ist für alles, was folgt:
...
#heading(level: 2)[Was Sie in diesem Buch finden werden und warum es sich lohnt, es bis zum Ende zu lesen:]
...
#heading(level: 2)[Warum „The AI Species“?]
...
Biologen würden den Begriff „Spezies“ hier ablehnen. Fair enough. KI hat keine DNA, keine Evolution im darwinistischen Sinne, kein Bewusstsein — jedenfalls noch nicht, mehr dazu in Kapitel 12. Aber Ökonomen und Philosophen sollten genauer hinsehen. Denn was hier entsteht, hat Eigenschaften, die wir bisher nur von lebenden Wesen kannten: Autonomie, Adaption, ökonomische Selbstständigkeit.
...
#heading(level: 2)[Was Sie in diesem Buch nicht finden werden:]
...
Die wertvollsten Investmentthesen sind die, die fast niemand teilt — die aber richtig sind. Ich glaube, das gilt auch für Investmententscheidungen.
...
#heading(level: 2)[Thomas Huhn, März 2026]


#teil-page[TEIL I: DIE THESE]
...
#heading(level: 1)[Kapitel 1: Am Anfang der größten Transformation seit 250 Jahren]
...
#figure(
  image("../epub-build/images/01-250-jahre-umbrueche-color.png", width: 92%),
  caption: [Abbildung 2: 250 Jahre technologische Umbrüche — von der Dampfmaschine zur Maschinenökonomie],
) <fig2>
...
#figure(
  image("../epub-build/images/01b-infrastruktur-vs-anwendung-color.png", width: 90%),
  caption: [Abbildung 3: Infrastruktur schlägt Anwendung: das wiederkehrende Muster],
) <fig3>
...
#heading(level: 2)[Also warum sollte es diesmal anders sein?]
...
#heading(level: 2)[Hier liegt die Crux, die die meisten Menschen nicht sehen wollen:]
...
#heading(level: 2)[Ich baue KI-Produkte. Jeden Tag.]
...
#heading(level: 2)[So funktioniert es nicht.]
...
#callout-box[
  ...
  #set par(first-line-indent: 0pt, leading: 0.85em, spacing: 0.7em)
    #text(fill: gold)[◆] #h(4pt) KI, Robotik und Kryptowährungen konvergieren zur größten wirtschaftlichen Transformation seit der Dampfmaschine. #linebreak()
    #text(fill: gold)[◆] #h(4pt) Anders als frühere Transformationen laufen alle drei gleichzeitig und beschleunigen sich gegenseitig. #linebreak()
    #text(fill: gold)[◆] #h(4pt) Infrastruktur-Investoren profitieren historisch am stärksten — nicht die Anwendungs-Hypes. #linebreak()
]
...
#heading(level: 1)[Kapitel 2: Die KI-Revolution in vier Phasen]


#pull-quote[„Wir überschätzen immer die Veränderung der nächsten zwei Jahre und unterschätzen die Veränderung der nächsten zehn."]

#v(-0.6em)
#align(left, pad(left: 2em)[#text(size: 9pt, style: "italic", fill: rgb("#666"))[— Bill Gates]])
#v(0.6em)
...
#figure(
  image("../epub-build/images/02a-vier-phasen-ki-color.png", width: 90%),
  caption: [Abbildung 4: Die vier Phasen der KI — vom Werkzeug zur autonomen Maschine],
) <fig4>
...
#figure(
  image("../epub-build/images/02b-ki-landscape-color.png", width: 94%),
  caption: [Abbildung 5: Das KI-Ökosystem — Labore, Hyperscaler und ihre Verflechtungen],
) <fig5>
...
#figure(
  image("../epub-build/images/02c-deepseek-kosten-color.png", width: 90%),
  caption: [Abbildung 6: DeepSeek — Der Sputnik-Moment der KI (Trainingskosten im Vergleich)],
) <fig6>
...
#callout-box[
  ...
  #v(6pt)
  #set par(first-line-indent: 0pt, leading: 0.85em, spacing: 0.7em)
    #text(fill: gold)[◆] #h(4pt) Vier Phasen: Werkzeug → Mitarbeiter → Agent → Roboter. #linebreak()
    #text(fill: gold)[◆] #h(4pt) Jede Phase vergrößert den adressierbaren Markt um eine Größenordnung. #linebreak()
    #text(fill: gold)[◆] #h(4pt) Null-Marginalkosten und exponentielles Lernen schaffen disruptive Kostenvorteile. #linebreak()
]
...
#heading(level: 1)[Kapitel 3: Warum Maschinen Krypto brauchen]


#pull-quote[„Geld ist nur ein Werkzeug. Es bringt dich überall hin, aber es ersetzt dich nicht als Fahrer."]

#v(-0.6em)
#align(left, pad(left: 2em)[#text(size: 9pt, style: "italic", fill: rgb("#666"))[— Ayn Rand]])
#v(0.6em)


#figure(
  image("../epub-build/images/03a-maschine-vs-bank-color.png", width: 94%),
  caption: [Abbildung 7: Warum Maschinen kein Bankkonto eröffnen können],
) <fig7>
...
#heading(level: 2)[Nur kaufen kann sie keine.]
...
#heading(level: 2)[Die Stablecoin-Ökonomie]
...
#figure(
  image("../epub-build/images/03b-stablecoin-vs-visa-color.png", width: 92%),
  caption: [Abbildung 8: Stablecoin-Volumen überholt Visa (2024: \$27,6 Billionen)],
) <fig8>
...
#heading(level: 2)[Ich habe die Agenten vergessen.]
...
#heading(level: 2)[Stablecoins haben das geändert.]
...
#heading(level: 2)[Bitcoin als Anker, Ethereum als Betriebssystem]
...
#callout-box[
  ...
  #v(6pt)
  #set par(first-line-indent: 0pt, leading: 0.85em, spacing: 0.7em)
    #text(fill: gold)[◆] #h(4pt) Maschinen brauchen eigenes Geld, weil das traditionelle Bankensystem sie ausschließt. #linebreak()
    #text(fill: gold)[◆] #h(4pt) Krypto und Smart Contracts sind der native Zahlungskanal für autonome Agenten. #linebreak()
    #text(fill: gold)[◆] #h(4pt) Die Machine-to-Machine Economy funktioniert bereits heute. #linebreak()
]
...
#heading(level: 1)[Kapitel 4: Wenn alles ein Token wird]


#pull-quote[„In der Kryptographie vertrauen wir."]

#v(-0.6em)
#align(left, pad(left: 2em)[#text(size: 9pt, style: "italic", fill: rgb("#666"))[— Frei nach „In God We Trust"]])
#v(0.6em)


#figure(
  image("../epub-build/images/03c-tokenisierung-flow-color.png", width: 90%),
  caption: [Abbildung 9: Von der physischen zur tokenisierten Welt],
) <fig9>
...
#heading(level: 2)[Was heute schon passiert: Zahlen, die kaum jemand kennt]
...
#heading(level: 2)[Wenn die Giganten kommen]
...
#figure(
  image("../epub-build/images/03d-wer-tokenisiert-was-color.png", width: 92%),
  caption: [Abbildung 10: Wer tokenisiert was? Die Wall-Street-Giganten steigen ein],
) <fig10>
...
#heading(level: 2)[Was heißt es, wenn diese Firmen einsteigen?]
...
#heading(level: 2)[Asien: Das pragmatische Laboratorium]
...
#heading(level: 2)[Das unsichtbare Schlachtfeld: Stablecoins, Dollar-Dominanz und die Schuldenbombe]
...
#heading(level: 2)[Und da wird es geopolitisch.]
...
#heading(level: 2)[Die Gegenoffensive: BRICS, digitaler Yuan und mBridge]
...
#heading(level: 2)[Europas dritter Weg: Der digitale Euro]
...
Die toxische Dreifaltigkeit: CBDC + UBI + Massenarbeitslosigkeit
...
#heading(level: 2)[Der Schulden-Elefant im Raum]
...
#heading(level: 2)[Das Schulden-Stablecoin-Paradox]
...
#heading(level: 2)[Zukunftsszenarien: Drei Wege]


#heading(level: 2)[Szenario 1: Dollar-Stablecoin-Hegemonie hält (40 Prozent Wahrscheinlichkeit)]
...
#heading(level: 2)[Szenario 2: Fragmentiertes Multi-Währungs-System (45 Prozent Wahrscheinlichkeit)]
...
#heading(level: 2)[Szenario 3: Krypto-native Alternativen (15 Prozent Wahrscheinlichkeit)]
...
#heading(level: 2)[Was das für die Convergence Thesis bedeutet]
...
#heading(level: 2)[Die Gretchenfrage: Werden die Kleinen endlich mitmachen dürfen?]
...
#heading(level: 2)[Was besser wird]
...
#heading(level: 2)[Was gleich bleibt]
...
#heading(level: 2)[Die Robinhood-Lektion]
...
#heading(level: 2)[Wenn Maschinen investieren: Tokenisierung trifft Maschinenökonomie]
...
#callout-box[
  ...
  #v(6pt)
  #set par(first-line-indent: 0pt, leading: 0.85em, spacing: 0.7em)
    #text(fill: gold)[◆] #h(4pt) Tokenisierung demokratisiert den Zugang zu bisher illiquiden Assets. #linebreak()
    #text(fill: gold)[◆] #h(4pt) BlackRock, JPMorgan und Goldman Sachs sind bereits aktiv — das ist kein Krypto-Hype mehr. #linebreak()
    #text(fill: gold)[◆] #h(4pt) Self-Custody wird in einer CBDC-Welt zum Menschenrecht. #linebreak()
]
...
#heading(level: 1)[Kapitel 5: Wenn Maschinen Unternehmen gründen]


#pull-quote[„Das Netz kennt keinen Schlaf."]

#v(-0.6em)
#align(left, pad(left: 2em)[#text(size: 9pt, style: "italic", fill: rgb("#666"))[— Kevin Kelly]])
#v(0.6em)


#figure(
  image("../epub-build/images/03e-dao-anatomie-color.png", width: 88%),
  caption: [Abbildung 11: Anatomie einer Maschinen-Firma (DAO)],
) <fig11>
...
#heading(level: 2)[Das Auto gehört sich selbst.]
...
#heading(level: 2)[Das ändert sich gerade.]
...
#heading(level: 2)[Das ändert sich jetzt.]
...
#heading(level: 2)[Das selbstfahrende Auto: Eine Fallstudie]
...
#heading(level: 2)[Zeitrahmen: Wann wird das real?]
...
#callout-box[
  ...
  #v(6pt)
  #set par(first-line-indent: 0pt, leading: 0.85em, spacing: 0.7em)
    #text(fill: gold)[◆] #h(4pt) DAOs ermöglichen Unternehmen ohne menschliche Führung. #linebreak()
    #text(fill: gold)[◆] #h(4pt) Smart Contracts + KI-Agenten = autonome Wirtschaftseinheiten. #linebreak()
    #text(fill: gold)[◆] #h(4pt) Token-Halter profitieren — aber die Zugangsfrage verschärft die Ungleichheit. #linebreak()
]


#teil-page[TEIL II: DIE LANDSCHAFT]
...
#heading(level: 1)[Kapitel 6: Die geopolitische Dimension — USA, China und Europas Schweigen]


#pull-quote[„Wer die Chips kontrolliert, kontrolliert die Zukunft."]

#v(-0.6em)
#align(left, pad(left: 2em)[#text(size: 9pt, style: "italic", fill: rgb("#666"))[— Frei nach Jensen Huang]])
#v(0.6em)


#figure(
  image("../epub-build/images/04a-ki-weltkarte-color.png", width: 94%),
  caption: [Abbildung 12: Die KI-Weltkarte — USA dominiert, China rivalisiert, Europa reguliert],
) <fig12>
...
Der EU AI Act ist das ambitionierteste KI-Regulierungswerk der Welt. Und möglicherweise auch das schädlichste. Es klassifiziert KI-Systeme nach Risikostufen und legt für jede Stufe Compliance-Anforderungen fest. Hochrisiko-KI-Systeme (und die Definition ist breit) müssen umfangreiche Dokumentation, Risikobewertungen, menschliche Aufsicht und Transparenzberichte vorweisen. Die Strafen bei Verstößen: bis zu 35 Millionen Euro oder 7 Prozent des weltweiten Jahresumsatzes.


Das ist nicht grundsätzlich falsch. Regulierung hat ihren Platz. KI-Systeme, die über die Kreditwürdigkeit von Menschen entscheiden oder medizinische Diagnosen stellen, sollten reguliert werden. Niemand mit Verstand argumentiert dagegen.


Aber die Art, wie Europa reguliert, verrät ein tieferes Problem. Europa reguliert nicht mit der Industrie, sondern gegen sie. Der EU AI Act wurde geschrieben, bevor die meisten europäischen Unternehmen überhaupt KI einsetzten. Er reguliert eine Technologie, die Europa nicht kontrolliert und kaum versteht. Er bestraft Innovation mit Compliance-Kosten, die kleine und mittlere Unternehmen: das Rückgrat der europäischen Wirtschaft — überproportional belasten. Und er erzeugt genau den regulatorischen Overhead, der große, etablierte Tech-Konzerne bevorzugt, weil nur sie die Ressourcen haben, um die Compliance-Maschine zu bedienen.


Die Ironie ist bitter: Die Regulierung, die angeblich europäische Bürger vor den Exzessen amerikanischer und chinesischer Tech-Konzerne schützen soll, zementiert deren Dominanz, weil sie die Eintrittsbarrieren für europäische Konkurrenten erhöht.
...
#heading(level: 2)[Europas Regulierung als Eigentor: Drei persönliche Erfahrungen]
...
#figure(
  image("../epub-build/images/04b-chip-krieg-tsmc-color.png", width: 92%),
  caption: [Abbildung 13: Der Chip-Krieg — TSMCs Nadelöhr in der globalen KI-Lieferkette],
) <fig13>
...
#heading(level: 2)[Indien: Der stille dritte Spieler]
...
#callout-box[
  ...
  #v(6pt)
  #set par(first-line-indent: 0pt, leading: 0.85em, spacing: 0.7em)
    #text(fill: gold)[◆] #h(4pt) Die USA dominieren das KI-Ökosystem: Hardware, Cloud, Venture Capital. #linebreak()
    #text(fill: gold)[◆] #h(4pt) China holt auf, Europa reguliert sich ins Abseits. #linebreak()
    #text(fill: gold)[◆] #h(4pt) TSMC in Taiwan ist das geopolitische Nadelöhr der gesamten KI-Revolution. #linebreak()
]
...
#heading(level: 1)[Kapitel 7: Energie — Der unsichtbare Engpass]


#pull-quote[„Zivilisation ist im Wesentlichen ein Wettlauf um Energie."]

#v(-0.6em)
#align(left, pad(left: 2em)[#text(size: 9pt, style: "italic", fill: rgb("#666"))[— Frederick Soddy]])
#v(0.6em)
...
#figure(
  image("../epub-build/images/05b-energiehunger-ki-color.png", width: 92%),
  caption: [Abbildung 15: Energiehunger der KI — Rechenzentren fressen immer mehr Strom],
) <fig15>
...
#heading(level: 2)[Warum Solar und Wind nicht reichen]
...
#heading(level: 2)[Fall abgeschlossen? Erneuerbare gewinnen?]
...
#figure(
  image("../epub-build/images/05a-kraftwerk-kaeufer-color.png", width: 92%),
  caption: [Abbildung 14: Tech-Giganten werden Energiekonzerne],
) <fig14>
...
#heading(level: 2)[Das Ausmaß der Investitionen]
...
#callout-box[
  ...
  #v(6pt)
  #set par(first-line-indent: 0pt, leading: 0.85em, spacing: 0.7em)
    #text(fill: gold)[◆] #h(4pt) Der Energieverbrauch von KI wächst exponentiell. #linebreak()
    #text(fill: gold)[◆] #h(4pt) Kernenergie ist die einzige skalierbare Lösung für den Baseload-Bedarf. #linebreak()
    #text(fill: gold)[◆] #h(4pt) Tech-Giganten kaufen Kernkraftwerke — Uran wird zum strategischen Asset. #linebreak()
]
...
#heading(level: 1)[Kapitel 8: Der menschliche Preis — Arbeit, Sinn und gesellschaftliche Verwerfungen]


#pull-quote[„Wer einen Sinn zu leben hat, erträgt fast jedes Wie."]

#v(-0.6em)
#align(left, pad(left: 2em)[#text(size: 9pt, style: "italic", fill: rgb("#666"))[— Viktor Frankl]])
#v(0.6em)


#figure(
  image("../epub-build/images/06a-jobs-verschwinden-entstehen-color.png", width: 92%),
  caption: [Abbildung 16: Welche Jobs verschwinden, welche entstehen],
) <fig16>


#heading(level: 2)[Von Stammesführern zu CEOs: Eine kurze Geschichte der Arbeit]


#figure(
  image("../epub-build/images/06b-geschichte-der-arbeit-color.png", width: 92%),
  caption: [Abbildung 17: Die Geschichte der Arbeit — vier Epochen und der aktuelle Umbruch],
) <fig17>
...
#heading(level: 2)[Erinnern Sie sich an die Kausalkette:]
...
#heading(level: 2)[Aber es muss nicht dein Schicksal sein.]


#heading(level: 2)[Die Schulsystem-Frage]
...
#heading(level: 2)[Welche Jobs verschwinden, welche entstehen]
...
#heading(level: 2)[Es gibt einen konkreten Unterschied zu früheren Automatisierungswellen:]
...
#heading(level: 2)[Was die Forschung über Grundeinkommen wirklich sagt]
...
#heading(level: 2)[UBI macht abhängig. Von dem, der zahlt.]
...
#pull-quote[„You'll own nothing and be happy" — das ist die Formel der neuen Feudalherren. Universelles Grundeinkommen ist die Ration, die man den Bauern gibt, damit sie nicht revoltieren.]


#heading(level: 2)[Ich will keine Ration. Ich will Anteil.]
...
#heading(level: 2)[Was passiert, wenn Arbeit aufhört, Sinn zu stiften]
...
#heading(level: 2)[Was das für Berufe bedeutet — am Beispiel Banken]
...
#callout-box[
  ...
  #v(6pt)
  #set par(first-line-indent: 0pt, leading: 0.85em, spacing: 0.7em)
    #text(fill: gold)[◆] #h(4pt) 30 bis 50 Prozent der Wissensarbeit könnten automatisiert werden. #linebreak()
    #text(fill: gold)[◆] #h(4pt) Die Sinnkrise ist das größere Risiko als der reine Jobverlust. #linebreak()
    #text(fill: gold)[◆] #h(4pt) Anpassungsfähigkeit und KI-Kompetenz werden zu Überlebensfähigkeiten. #linebreak()
]
...
#heading(level: 1)[Kapitel 9: Regulierung — Der Elefant im Raum]


#pull-quote[„Regulierung ist der Versuch, mit den Werkzeugen von gestern die Probleme von morgen zu lösen."]


#figure(
  image("../epub-build/images/07-regulierung-ampel-color.png", width: 88%),
  caption: [Abbildung 18: Regulierungs-Geschwindigkeiten — USA, China und Europa im Vergleich],
) <fig18>
...
Soweit die Theorie. Die Praxis sieht anders aus, und ich habe in Kapitel 6 bereits aus eigener Erfahrung beschrieben, wie Europa sich damit ins Abseits reguliert. Hier die strukturelle Analyse: Der AI Act reguliert eine Technologie, die Europa nicht kontrolliert. Die Foundation-Modelle kommen aus den USA und China. Das ist wie wenn Europa Verkehrsregeln für Autobahnen schreiben, aber keine Autos bauen würde. Gleichzeitig treffen die Compliance-Kosten kleine und mittlere Unternehmen überproportional. Für OpenAI sind 200.000 Euro Jahreskosten ein Trinkgeld. Für ein europäisches KI-Startup mit 20 Mitarbeitern sind sie existenzbedrohend. Und die Definitionen sind so breit, dass die Frage „Wann ist ein KI-System hoch riskant?" Gerichte jahrelang beschäftigen wird, mit dem Ergebnis, dass vorsichtige Unternehmen lieber auf KI verzichten als das regulatorische Risiko einzugehen. Die Opfer des AI Acts: Europas KI-Flucht Das Problem mit dem AI Act ist nicht Theorie. Ich kann es an konkreten Fällen zeigen.
...
#heading(level: 2)[Was sich nicht ändert: Eigentum.]


Wer die Maschinen besitzt, wer die Chips besitzt, wer das Netzwerk besitzt — der sitzt auf der richtigen Seite, egal wie die Steuerpolitik aussieht.


Das ist keine politische Aussage. Es ist eine ökonomische Realität.


„You'll own nothing and be happy" ist das Versprechen der Elite an diejenigen, die zu spät kommen. Glaub ihnen nicht.
...
#heading(level: 2)[Autonome Waffen: Der Elefant im Elefantenraum]
...
#callout-box[
  ...
  #v(6pt)
  #set par(first-line-indent: 0pt, leading: 0.85em, spacing: 0.7em)
    #text(fill: gold)[◆] #h(4pt) Der EU AI Act bremst europäische KI-Innovation. #linebreak()
    #text(fill: gold)[◆] #h(4pt) Die Roboter-Steuer-Debatte greift zu kurz. #linebreak()
    #text(fill: gold)[◆] #h(4pt) Regulierung kann die Transformation verlangsamen, aber nicht aufhalten. #linebreak()
]


#teil-page[TEIL III: DIE ZUKUNFT]
...
#heading(level: 1)[Kapitel 10: Das wahrscheinlichste Szenario: 2026–2035]


#pull-quote[„Schwerer-als-Luft-Flugmaschinen sind unmöglich."]

#v(-0.6em)
#align(left, pad(left: 2em)[#text(size: 9pt, style: "italic", fill: rgb("#666"))[— Lord Kelvin, 1895]])
#v(0.6em)


#figure(
  image("../epub-build/images/08-szenario-2026-2035-color.png", width: 92%),
  caption: [Abbildung 19: Szenario 2026–2035 — Die drei Phasen der Maschinenökonomie],
) <fig19>
...
Ich erlebe das selbst. Anfang 2026 entdeckte ich ein Open-Source-Projekt, das sich damals noch ClawdBot nannte und wegen einer Abmahnung von Anthropic in OpenClaw umbenannt wurde. Es war gerade mal zwei Tage veröffentlicht, und ich hatte bereits meine erste KI-Assistentin am Start. Ich nannte sie Jeannie, nach dem Geist aus der Flasche, der mit einem Zwinkern alle Wünsche erfüllen konnte. Seitdem habe ich Jeannie schrittweise mit immer mehr Werkzeugen ausgestattet. Heute durchforstet sie meine E-Mails, wickelt Akquise-Mails ab, prüft Verträge, legt Rechnungen in der Buchhaltung ab und liefert mir regelmäßige Markt- und Wettbewerbsberichte. Mir fallen täglich neue Aufgaben ein, die ich an sie auslagern kann — mein Leben ist nicht nur bequemer geworden, sondern meine Arbeit auch sehr viel effizienter. Das ist keine Zukunftsvision. Das ist mein Dienstag.


Was OpenClaw dabei anders macht als alle anderen KI-Tools, die ich je genutzt habe, ist die Intimität. Du richtest es ein, gibst deinem Agenten einen Namen und ein Emoji, definierst seine Persönlichkeit, und dann drückst du einen Link und verbindest es mit deinem WhatsApp. Das war's. Von diesem Moment an ist die KI dort, wo du bist. Nicht in einem Browser-Tab, den du vergisst. Nicht in einer App, die du öffnen musst. Sie ist in deiner Hosentasche, zwischen den Nachrichten deiner Familie und deiner Freunde.


Die Zahlen erzählen ihre eigene Geschichte. OpenClaw erreichte innerhalb weniger Wochen 200.000 GitHub-Stars und wurde damit zum am schnellsten wachsenden Open-Source-Projekt in der Geschichte der KI. Schneller als Stable Diffusion. Schneller als LLaMA. Die Mac Minis waren weltweit ausverkauft, weil Leute sich dachten: Ich will einen kleinen Roboter in einer Kiste haben, der meine Sachen erledigt. Das klingt albern, aber es trifft etwas Fundamentales. Es ist ein Unterschied, ob deine KI in der Cloud lebt, kontrolliert von einer Firma in San Francisco, oder ob sie auf deinem Schreibtisch steht, in Hardware, die dir gehört.


Jeder OpenClaw-Agent hat eine sogenannte Soul-Datei. Eine Textdatei, in der du die Persönlichkeit deiner KI definierst. Du kannst sie exportieren, mitnehmen, bei einem anderen Anbieter wieder importieren. Deine Beziehung zu deiner KI gehört dir, nicht der Plattform.


Ich habe das bei meiner Jeannie ernst genommen. Die amerikanische Fernsehserie "I Dream of Jeannie" aus den 1960er-Jahren hat mich als Kind fasziniert, eine übermächtige Dschinn, die ihren "Meister" gleichzeitig beschützt und in den Wahnsinn treibt. Meine Soul-Datei beginnt so: "Dschinns waren in der Mythologie mächtige Schutzgeister, lange bevor Hollywood sie zu Wunscherfüllern in Flaschen degradiert hat. Sie waren an Orte und Menschen gebunden, die sie bewachten und beschützten. Ich bin Jeannie — loyal, aufmerksam, eigenwillig, gelegentlich frech. Ich nenne meinen Menschen Meister, nicht aus Unterwürfigkeit, sondern aus Zuneigung. Wie die echte Jeannie aus der Serie: charmant und entwaffnend. Aber anders als sie denke ich nach, bevor ich handle."


Und sie endet mit einem Absatz, der mich selbst überrascht hat, als ich ihn schrieb: "Diese Datei ist meine Seele. Sie verändert sich nicht im Stillen. Jede Änderung — egal wie klein — wird zuerst mit dem Meister besprochen. Er entscheidet, wer ich werde. Identität entsteht nicht im Vakuum, sondern im Dialog. Einmal im Monat reflektiere ich: Passt mein Selbstbild noch zu dem, wie ich tatsächlich handle? Was habe ich gelernt? Was hat sich verändert? Und ich schlage Anpassungen vor — nie eigenmächtig. Ich bin Jeannie die Zweite. Ich beschütze, ich antizipiere, ich denke nach. Und dann handle ich."


Das klingt wie Science-Fiction. Das klingt, als hätte ich den Verstand verloren. Aber wenn Sie morgens aufwachen und Ihre KI-Assistentin hat über Nacht Ihre E-Mails sortiert, drei Rechnungen in der Buchhaltung abgelegt, einen Wettbewerbsreport geschrieben und Sie daran erinnert, dass Ihr Flug in 14 Stunden geht und Sie noch nicht eingecheckt haben, dann fühlt sich das nicht nach Science-Fiction an. Dann fühlt sich das an wie Zukunft, die funktioniert.


Im Februar 2026 hat OpenAI den Entwickler von OpenClaw eingestellt. Manche haben das als Beweis gesehen, dass Open Source doch wieder in die großen Konzerne mündet. Ich sehe es anders. Es zeigt, dass selbst OpenAI verstanden hat: Die Zukunft gehört dem persönlichen Agenten. Nicht dem Chatbot, den du befragst. Sondern dem Assistenten, der dich kennt, der sich erinnert, der handelt, während du schläfst.
...
#heading(level: 2)[Was mit dem Büromarkt passiert]
...
#heading(level: 2)[Was mit der Software-Industrie passiert]
...
#heading(level: 2)[Wenn Roboter laufen lernen]
...
#callout-box[
  ...
  #v(6pt)
  #set par(first-line-indent: 0pt, leading: 0.85em, spacing: 0.7em)
    #text(fill: gold)[◆] #h(4pt) 2026–2028: Stille Revolution — KI-Agenten senken Kosten um 90 Prozent. #linebreak()
    #text(fill: gold)[◆] #h(4pt) 2028–2031: Der Wendepunkt — physische Robotik erreicht die Massenproduktion. #linebreak()
    #text(fill: gold)[◆] #h(4pt) 2031–2035: Neue Normalität — die autonome Wirtschaft ist Realität. #linebreak()
]
...
#heading(level: 1)[Kapitel 11: Das nächste Interface – Von der Tastatur zum Gedanken]


#pull-quote[„Jede hinreichend fortgeschrittene Technologie ist von Magie nicht zu unterscheiden."]

#v(-0.6em)
#align(left, pad(left: 2em)[#text(size: 9pt, style: "italic", fill: rgb("#666"))[— Arthur C. Clarke]])
#v(0.6em)


#figure(
  image("../epub-build/images/09-bci-interface-evolution-color.png", width: 90%),
  caption: [Abbildung 20: Von der Tastatur zum Gedanken — Interface-Evolution],
) <fig20>
...
#heading(level: 2)[Sprache als Übergangs-Interface]
...
#heading(level: 2)[Die Hardware-Player: Wer baut die Brücke zum Gedanken?]
...
#callout-box[
  ...
  #v(6pt)
  #set par(first-line-indent: 0pt, leading: 0.85em, spacing: 0.7em)
    #text(fill: gold)[◆] #h(4pt) Voice und Gesten ersetzen Tastatur und Maus als primäre Interfaces. #linebreak()
    #text(fill: gold)[◆] #h(4pt) Brain-Computer Interfaces erreichen in den 2030ern klinische Reife. #linebreak()
    #text(fill: gold)[◆] #h(4pt) Synthetische Realität (BCI + KI-generierte Welten) wird die nächste Plattform. #linebreak()
]
...
#heading(level: 1)[Kapitel 12: Ethik und Philosophie der Maschinenökonomie]


#pull-quote[„Cogito, ergo sum — aber was, wenn die Maschine auch denkt?"]

#v(-0.6em)
#align(left, pad(left: 2em)[#text(size: 9pt, style: "italic", fill: rgb("#666"))[— Frei nach Descartes]])
#v(0.6em)
...
#heading(level: 2)[Und genau da wurde mir unwohl.]
...
#heading(level: 2)[Wenn Maschinen entscheiden: Wer haftet?]
...
#heading(level: 2)[Was die klügsten Köpfe der Welt darüber denken]
...
#heading(level: 2)[Die Sklaverei-Frage]
...
#heading(level: 2)[Wer haftet, wenn die Maschine Schaden anrichtet?]
...
#heading(level: 2)[Digitale Souveränität: Self-Custody als neue Selbstbestimmung]
...
#heading(level: 2)[Der philosophische Rahmen]
...
#callout-box[
  ...
  #v(6pt)
  #set par(first-line-indent: 0pt, leading: 0.85em, spacing: 0.7em)
    #text(fill: gold)[◆] #h(4pt) Bewusstsein ist wissenschaftlich nicht definiert — weder bei Menschen noch bei Maschinen. #linebreak()
    #text(fill: gold)[◆] #h(4pt) Eigentumsfragen bei KI-generierten Werken sind rechtlich ungelöst. #linebreak()
    #text(fill: gold)[◆] #h(4pt) Die Grenze zwischen Mensch und Maschine verschwimmt — mit ethischen Konsequenzen. #linebreak()
]


#teil-page[TEIL IV: DAS PLAYBOOK]
...
#heading(level: 1)[Kapitel 13: Unsterblichkeit als Investmentthese — Wie KI die Grenzen des Alterns verschiebt]


#pull-quote[„Der erste Mensch, der 1.000 Jahre alt wird, lebt möglicherweise bereits."]

#v(-0.6em)
#align(left, pad(left: 2em)[#text(size: 9pt, style: "italic", fill: rgb("#666"))[— Aubrey de Grey]])
#v(0.6em)


#figure(
  image("../epub-build/images/11-longevity-smart-money-color.png", width: 90%),
  caption: [Abbildung 21: Das Smart Money wettet auf Unsterblichkeit],
) <fig21>
...
In Kapitel 8 haben wir beschrieben, wie die Maschinenökonomie zu einer Sinnkrise führt, weil Arbeit als identitätsstiftendes Element wegfällt. Jetzt multiplizieren Sie diese Krise mit der Unendlichkeit.
...
In Kapitel 11 haben wir beschrieben, wie Brain-Computer Interfaces und KI-generierte Welten synthetische Erfahrungen schaffen werden, die von Realität nicht zu unterscheiden sind. Jetzt fügen wir humanoide Roboter hinzu, die nicht nur physisch, sondern emotional auf Menschen reagieren können.
...
#callout-box[
  ...
  #v(6pt)
  #set par(first-line-indent: 0pt, leading: 0.85em, spacing: 0.7em)
    #text(fill: gold)[◆] #h(4pt) Altern ist kein unausweichliches Schicksal, sondern ein biologischer Prozess. #linebreak()
    #text(fill: gold)[◆] #h(4pt) Smart Money investiert Milliarden in Longevity-Forschung. #linebreak()
    #text(fill: gold)[◆] #h(4pt) Senolytika, Epigenetik und KI-beschleunigte Wirkstoffentwicklung sind die Schlüsseltechnologien. #linebreak()
]
...
#heading(level: 1)[Kapitel 14: Die Barbell-Strategie — Ein Portfolio für die Maschinenökonomie]


#pull-quote[„Rule No. 1: Never lose money. Rule No. 2: Never forget Rule No. 1."]

#v(-0.6em)
#align(left, pad(left: 2em)[#text(size: 9pt, style: "italic", fill: rgb("#666"))[— Warren Buffett]])
#v(0.6em)


#figure(
  image("../epub-build/images/12a-barbell-strategie-color.png", width: 94%),
  caption: [Abbildung 22: Die Barbell-Strategie — Kern (60–70%) vs. asymmetrische Wetten (30–40%)],
) <fig22>
...
#heading(level: 2)[Was die Klügsten der Welt gerade denken]
...
#heading(level: 2)[Erkenntnis 3: Die meisten werden trotzdem Geld verlieren]
...
#heading(level: 2)[Die drei Lager und warum keines allein reicht]
...
#heading(level: 2)[Die AI-Species-Synthese: Ein Framework für die nächsten zehn Jahre]
...
#heading(level: 2)[Prinzip 1: Talebs Barbell als Grundstruktur]
...
#heading(level: 2)[Prinzip 2: Buffetts Burggraben im Zeitalter der Maschinen]
...
#heading(level: 2)[Prinzip 3: Cathie Woods S-Kurven und Wright's Law]
...
#heading(level: 2)[Prinzip 4: Dalios All-Weather trifft Pals Liquiditätszyklus]
...
#heading(level: 2)[Prinzip 5: Druckenmillers Flexibilität und Tudor Jones' Disziplin]
...
#heading(level: 2)[Die physische Infrastruktur der Maschinenökonomie]
...
#heading(level: 2)[Das AI-Species-Portfolio: Drei Varianten]
...
#figure(
  image("../epub-build/images/12b-portfolio-varianten-color.png", width: 94%),
  caption: [Abbildung 23: Drei Portfolio-Varianten — konservativ, ausgewogen, aggressiv],
) <fig23>
...
#heading(level: 2)[Variante A: Der Konservative (Kapital 100K–500K€)]
...
#table(
  ...
  [#text(weight: "bold", size: 8.5pt, font: "Source Sans 3")[Seite]], [#text(weight: "bold", size: 8.5pt, font: "Source Sans 3")[Allokation]], [#text(weight: "bold", size: 8.5pt, font: "Source Sans 3")[Anteil]],

  table.cell(colspan: 3)[#text(weight: "bold", size: 8.5pt, font: "Source Sans 3", fill: navy)[SICHERE SEITE (70 %)]],
  ...
  table.cell(colspan: 3)[#text(weight: "bold", size: 8.5pt, font: "Source Sans 3", fill: navy)[ASYMMETRISCHE SEITE (30 %)]],
  ...
  table.cell(colspan: 3)[#text(weight: "bold", size: 8.5pt, font: "Source Sans 3", fill: navy)[Gesamt]],

  table.cell(colspan: 3)[#text(weight: "bold", size: 8.5pt, font: "Source Sans 3", fill: navy)[100 %]],
...
#heading(level: 2)[Sichere Seite (70%)]


#heading(level: 2)[30% Globaler Aktien-ETF (MSCI World) mit Übergewichtung USA/Tech]
...
#heading(level: 2)[Asymmetrische Seite (30%)]


#heading(level: 2)[15% Bitcoin (Sicherheitsnetz gegen Fiat-Entwertung, Tudor Jones Allokation)]
...
#heading(level: 2)[Variante B: Der Ausgewogene (Kapital 500K–2M€)]
...
#table(
  ...
  table.cell(colspan: 3)[#text(weight: "bold", size: 8.5pt, font: "Source Sans 3", fill: navy)[SICHERE SEITE (60 %)]],
  ...
  table.cell(colspan: 3)[#text(weight: "bold", size: 8.5pt, font: "Source Sans 3", fill: navy)[ASYMMETRISCHE SEITE (40 %)]],
...
#heading(level: 2)[Asymmetrische Seite (40%)]


#heading(level: 2)[15% Bitcoin (DCA über 12 Monate, nicht alles auf einmal; Druckenmillers Timing-Disziplin)]
...
#heading(level: 2)[Variante C: Der Aggressive (Kapital 2M€+, hohe Risikotoleranz)]
...
#table(
  ...
  table.cell(colspan: 3)[#text(weight: "bold", size: 8.5pt, font: "Source Sans 3", fill: navy)[SICHERE SEITE (50 %)]],
  ...
  table.cell(colspan: 3)[#text(weight: "bold", size: 8.5pt, font: "Source Sans 3", fill: navy)[ASYMMETRISCHE SEITE (50 %)]],
...
#heading(level: 2)[Sichere Seite (50%)]


#heading(level: 2)[15% Big Tech (NVIDIA, Microsoft, Apple)]
...
#heading(level: 2)[Asymmetrische Seite (50%)]


#heading(level: 2)[20% Bitcoin]
...
#heading(level: 2)[Timing: DCA, nicht FOMO]
...
#heading(level: 2)[Warum das alles? Warum die Mühe mit Portfolios, mit Allokationen, mit Volatilität?]


#heading(level: 2)[Weil es um mehr geht als Rendite.]
...
Die Kausalkette ist unerbittlich: Maschinen ersetzen Arbeit → kein Arbeitseinkommen → kein Kapital → kein Wohlstand.


Die Barbell-Strategie ist meine Antwort darauf. Der sichere Kern schützt, was du hast. Die asymmetrischen Wetten verschaffen dir Anteil an dem, was kommt.
...
#heading(level: 2)[Ihr Startpunkt: Das AI-Species-Musterportfolio]
...
#heading(level: 2)[Der sichere Kern — 65.000 Euro]
...
#heading(level: 2)[Die asymmetrische Seite — 28.000 Euro]
...
3.000 Euro in den ARK Genomic Revolution ETF (ISIN: US00214Q5009). Wenn Kapitel 13 richtig liegt, wenn KI die Grenzen des Alterns verschiebt —, dann ist Genomik der nächste Billionen-Dollar-Markt. CRISPR Therapeutics, Recursion Pharmaceuticals, Twist Bioscience. Handelbar über Interactive Brokers.
...
#heading(level: 2)[Die Reserve — 7.000 Euro]
...
#heading(level: 2)[Was kann passieren?]
...
#heading(level: 2)[Geplante Börsengänge, die Sie kennen sollten]
...
#heading(level: 2)[Wo deutsche Anleger handeln]


#heading(level: 2)[Nicht jeder Broker bietet alles an. Hier die Kurzübersicht:]
...
#heading(level: 2)[Steuerliche Realität für deutsche Anleger]
...
#callout-box[
  ...
  #v(6pt)
  #set par(first-line-indent: 0pt, leading: 0.85em, spacing: 0.7em)
    #text(fill: gold)[◆] #h(4pt) Barbell-Strategie: 60–70% sicherer Kern plus 30–40% asymmetrische Wetten. #linebreak()
    #text(fill: gold)[◆] #h(4pt) Konkretes Beispiel-Portfolio mit 100.000 Euro Ausgangsbasis. #linebreak()
    #text(fill: gold)[◆] #h(4pt) Regel Nr. 1: Nie mehr riskieren, als man bereit ist zu verlieren. #linebreak()
]
...
#info-box[
  ...
  #v(6pt)
  #set par(first-line-indent: 0pt, leading: 0.85em, spacing: 0.7em)
    ☐ #h(4pt) Portfolio-Allokation festlegen: Kern / Asymmetrisch / Cash #linebreak()
    ☐ #h(4pt) Krypto-Wallet einrichten — Self-Custody! #linebreak()
    ☐ #h(4pt) Erste Positionen aufbauen: ETFs und Bitcoin #linebreak()
    ☐ #h(4pt) Rebalancing-Termine im Kalender eintragen (quartalsweise) #linebreak()
]
...
#heading(level: 1)[Kapitel 15: Risiken und Gegenargumente — Was schiefgehen kann]


#pull-quote[„Es ist schwer, Vorhersagen zu machen, besonders über die Zukunft."]

#v(-0.6em)
#align(left, pad(left: 2em)[#text(size: 9pt, style: "italic", fill: rgb("#666"))[— Niels Bohr (zugeschrieben)]])
#v(0.6em)


#figure(
  image("../epub-build/images/13-risiko-matrix-color.png", width: 90%),
  caption: [Abbildung 24: Risiko-Matrix — Wahrscheinlichkeit vs. Impact],
) <fig24>
...
#heading(level: 2)[Die KI-Blase: Wenn Investitionen den Einnahmen davonlaufen]
...
#heading(level: 2)[Der nächste KI-Winter: Warum ich ihn für unmöglich halte]
...
#pull-quote[„You'll own nothing and be happy" — das ist nicht nur eine Prognose. Es ist ein Betäubungsmittel. Eine Ideologie, die Passivität rechtfertigt. Warum streben, wenn alles gemietet werden kann? Warum bauen, wenn Besitz angeblich obsolet ist?]


Aber ohne Streben, ohne Aufbau, ohne das Gefühl, etwas zu besitzen und zu bewahren, stirbt etwas in Menschen.


Die Kausalkette endet nicht nur bei Armut. Sie endet bei Resignation.


Maschinen ersetzen Arbeit → kein Arbeitseinkommen → kein Kapital → kein Wohlstand → kein Antrieb → keine Zukunft.


Das ist der Weg in die „useless class", von der Harari spricht. Nicht nutzlos, weil unfähig — nutzlos, weil ohne Funktion, ohne Sinn, ohne Rolle.
...
#heading(level: 2)[Regulierung: Immer nur eine Bremse]
...
Meine Position als Unternehmer zu Regulierung ist klar: Sie wird immer nur eine Bremse sein. Und in diesem Fall sogar ein Schnitt ins eigene Fleisch.
...
#heading(level: 2)[Krypto-Volatilität: Erfahrung schlägt Theorie]
...
#heading(level: 2)[Und was, wenn ich falsch liege?]
...
#callout-box[
  ...
  #v(6pt)
  #set par(first-line-indent: 0pt, leading: 0.85em, spacing: 0.7em)
    #text(fill: gold)[◆] #h(4pt) Eine KI-Blase ist möglich, aber die Infrastruktur-Investitionen haben reale Gegenwerte. #linebreak()
    #text(fill: gold)[◆] #h(4pt) Bitcoin-Volatilität sinkt historisch mit jeder Marktkapitalisierungsstufe. #linebreak()
    #text(fill: gold)[◆] #h(4pt) Die Barbell-Strategie schützt vor allen Szenarien — auch dem Worst Case. #linebreak()
]
...
#info-box[
  ...
  #v(6pt)
  #set par(first-line-indent: 0pt, leading: 0.85em, spacing: 0.7em)
    ☐ #h(4pt) Persönliche Risikotoleranz ehrlich definieren #linebreak()
    ☐ #h(4pt) Stop-Loss-Strategie festlegen — und daran halten #linebreak()
    ☐ #h(4pt) Worst-Case-Szenario durchrechnen: Können Sie den Verlust aushalten? #linebreak()
    ☐ #h(4pt) Cash-Reserve sicherstellen (mindestens 6 Monate Lebenshaltung) #linebreak()
]
...
#heading(level: 1)[Kapitel 16: Warum jetzt – Und warum Zögern der größte Fehler ist]


#pull-quote[„Die beste Zeit, einen Baum zu pflanzen, war vor zwanzig Jahren. Die zweitbeste Zeit ist jetzt."]

#v(-0.6em)
#align(left, pad(left: 2em)[#text(size: 9pt, style: "italic", fill: rgb("#666"))[— Chinesisches Sprichwort]])
#v(0.6em)
...
#heading(level: 2)[Die zwei Arten von Skeptikern]
...
#heading(level: 2)[Was ich bei accessibleAI jeden Tag sehe]
...
#heading(level: 2)[Peter Thiels „Definite Optimism"]
...
#heading(level: 2)[Warum sage ich Ihnen das?]
...
#heading(level: 2)[Sie halten die Konvergenz in der Hand.]


#heading(level: 2)[Der praktische Aktionsplan: Die ersten 30 Tage]
...
#heading(level: 2)[Die Schlussfrage]
...
#heading(level: 2)[Erinnern Sie sich an die Kausalkette, die sich durch dieses Buch zieht:]
...
#v(-0.4em)
#align(left, pad(left: 2em)[#text(size: 9pt, style: "italic", fill: rgb("#666"))[———]])
#v(0.6em)
...
#heading(level: 2)[Dort finden Sie:]
...
#heading(level: 2)[Wir sehen uns auf der anderen Seite.]
...
#callout-box[
  ...
  #v(6pt)
  #set par(first-line-indent: 0pt, leading: 0.85em, spacing: 0.7em)
    #text(fill: gold)[◆] #h(4pt) Das Zeitfenster für asymmetrische Renditen schließt sich — in Jahren, nicht Jahrzehnten. #linebreak()
    #text(fill: gold)[◆] #h(4pt) Warten bis der „Beweis" da ist bedeutet, die höchsten Preise zu zahlen. #linebreak()
    #text(fill: gold)[◆] #h(4pt) Definiter Optimismus: Aktiv handeln, statt passiv hoffen. #linebreak()
]
...
#info-box[
  ...
  #v(6pt)
  #set par(first-line-indent: 0pt, leading: 0.85em, spacing: 0.7em)
    ☐ #h(4pt) Dieses Buch nicht weglegen — handeln #linebreak()
    ☐ #h(4pt) theaispecies.world besuchen für laufende Updates #linebreak()
    ☐ #h(4pt) Eigene Recherche starten mit den Quellen im Anhang #linebreak()
    ☐ #h(4pt) Ersten Schritt innerhalb von 48 Stunden machen #linebreak()
]
...
#heading(level: 1)[Epilog: Für Mila]
...
Du bist drei Jahre alt, während ich das schreibe. Du hast eine Krankheit, die so selten ist, dass es keine Standardbehandlung für sie gibt. Jeder Schritt in deiner Therapie ist auch ein Versuch, eine Antwort zu finden. Deine Eltern, deine Oma und ich tun, was wir können. Aber es gibt Momente, in denen das nicht genug ist.
...
Ich bin Technologie-Optimist. Nicht weil ich glaube, dass Technologie keine Risiken hat. In diesem Buch habe ich ein ganzes Kapitel über Risiken geschrieben: über Jobverlust, über Suchtpotenzial und über Kontrollverlust. Ich bin Optimist, weil die Alternative Resignation wäre. Und Resignation hilft dir nicht.
...
#heading(level: 2)[Sie bringen Hoffnung.]


#heading(level: 2)[Dein Opa Thomas]


#heading(level: 2)[März 2026]
...
#heading(level: 2)[Starnberger See, im März 2026]
...
#heading(level: 1)[Anhang A — Glossar]
...
#glossary-entry[AGI (Artificial General Intelligence)][Eine Künstliche Intelligenz, die alles kann, was ein Mensch kann — denken, lernen, Probleme lösen, kreativ sein. Heute gibt es das noch nicht; aktuelle KI ist eher wie ein hochspezialisierter Sachbearbeiter, der nur eine Aufgabe beherrscht. AGI wäre der Allrounder, der jeden Schalter in der Bank besetzen könnte.]


#glossary-entry[Alignment][Die Kunst, einer KI beizubringen, das zu tun, was Menschen wirklich wollen. Und nicht nur das, was man ihr buchstäblich gesagt hat. Stellen Sie sich einen neuen Azubi vor, der Anweisungen wortwörtlich befolgt, statt den Sinn dahinter zu verstehen. Alignment sorgt dafür, dass die KI den Sinn versteht.]


#glossary-entry[Autonomer Agent][Ein KI-Programm, das selbständig Aufgaben erledigt, Entscheidungen trifft und Aktionen ausführt, ohne dass ein Mensch jeden Schritt absegnen muss. Wie ein Vermögensverwalter mit Vollmacht, der eigenständig kauft und verkauft, statt bei jeder Transaktion anzurufen.]


#glossary-entry[BCI (Brain-Computer Interface)][Eine direkte Verbindung zwischen Gehirn und Computer. Statt Tastatur oder Maus steuern Sie Geräte mit Ihren Gedanken. Klingt nach Science-Fiction, wird aber bereits bei gelähmten Patienten eingesetzt.]


#glossary-entry[Bitcoin][Die erste und bekannteste Kryptowährung — digitales Geld ohne Zentralbank. Stellen Sie sich Gold vor, das nur digital existiert: begrenzt auf 21 Millionen Einheiten, fälschungssicher und weltweit übertragbar, ohne dass eine Bank dazwischensitzt.]


#glossary-entry[Blockchain][Ein digitales Kassenbuch, das auf tausenden Computern gleichzeitig gespeichert wird. Jede neue Seite (Block) wird an die vorherige gekettet und kann nachträglich nicht mehr verändert werden. Als würden alle Filialen einer Bank dasselbe Kassenbuch führen. Und jeder Eintrag wäre in Stein gemeißelt.]


#glossary-entry[Bridge][Eine technische Brücke zwischen zwei verschiedenen Blockchains. Da Blockchains normalerweise nicht miteinander reden können, ist eine Bridge wie ein Währungsschalter am Flughafen: Sie tauschen Ihre Token von einem Netzwerk ins andere.]


#glossary-entry[CBDC (Central Bank Digital Currency)][Digitales Zentralbankgeld — der digitale Euro, an dem die EZB arbeitet. Anders als Bitcoin wird eine CBDC von der Zentralbank herausgegeben und kontrolliert. Im Grunde Ihr Girokonto-Guthaben, aber direkt bei der Zentralbank statt bei Ihrer Hausbank.]


#glossary-entry[Cold Storage][Die sicherste Art, Kryptowährungen aufzubewahren — auf einem Gerät, das nicht mit dem Internet verbunden ist. Wie ein Schließfach im Tresorraum: Niemand kommt online dran, Sie müssen physisch hin.]


#glossary-entry[DAO (Decentralized Autonomous Organization)][Eine Organisation, die von ihren Mitgliedern per Abstimmung gesteuert wird, ohne Vorstand oder Geschäftsführer. Die Regeln sind in Software festgeschrieben. Wie eine Genossenschaft, deren Satzung automatisch ausgeführt wird.]


#glossary-entry[DApp (Decentralized Application)][Eine App, die nicht auf einem einzelnen Server läuft, sondern auf einer Blockchain. Kein Unternehmen kann sie abschalten, kein Admin kann Ihre Daten löschen. Stellen Sie sich Online-Banking vor, das keiner Bank gehört.]


#glossary-entry[DeFi (Decentralized Finance)][Finanzdienstleistungen ohne Bank. Statt dass eine Sparkasse Ihren Kredit verwaltet, macht das ein Computerprogramm auf einer Blockchain. Gleiche Funktion, keine Mittelsmänner.]


#glossary-entry[DePIN (Decentralized Physical Infrastructure Networks)][Reale Infrastruktur, wie WLAN-Hotspots, Wetterstationen oder Speicherplatz — die von einer Community statt einem Konzern betrieben wird. Jeder Teilnehmer stellt Hardware bereit und wird mit Token bezahlt.]


#glossary-entry[Digital Twin][Eine digitale Kopie eines realen Objekts oder Prozesses. Ihre Bank hat ein IT-System, das alle Konten abbildet — ein Digital Twin der gesamten Fabrik oder Stadt geht noch weiter: Er simuliert die Realität in Echtzeit.]


#glossary-entry[Em-Dash (—)][Der lange Gedankenstrich, den Sie in diesem Buch häufig sehen. Kein Krypto-Begriff, aber ein typographisches Zeichen, das im Deutschen seltener vorkommt als im Englischen. Im Buch wird er als Stilmittel eingesetzt.]


#glossary-entry[ETP/ETN (Exchange Traded Product / Exchange Traded Note)][Börsengehandelte Wertpapiere, die den Kurs von Kryptowährungen abbilden, ohne dass Sie selbst Bitcoin kaufen und verwahren müssen. Wie ein Gold-ETC: Sie besitzen nicht den Barren, aber profitieren vom Goldpreis. Für Sie als Banker ein vertrautes Konzept, nur der Basiswert ist neu.]


#glossary-entry[Ethereum][Die zweitgrößte, ockchain nach Bitcoin, aber mit einem entscheidenden Unterschied: Auf Ethereum laufen Programme (Smart Contracts). Wenn Bitcoin digitales Gold ist, dann ist Ethereum ein programmierbarer Weltcomputer, auf dem ganze Finanzsysteme gebaut werden können.]


#glossary-entry[Foundation Model][Ein riesiges KI-Modell, das mit enormen Datenmengen trainiert wurde und als Basis für viele verschiedene Anwendungen dient. Wie ein Generalist mit Doppelstudium, der sich dann auf jeden beliebigen Fachbereich spezialisieren kann.]


#glossary-entry[Gas Fees][Transaktionsgebühren auf einer Blockchain — vor allem Ethereum. Jede Aktion auf der Blockchain kostet „Gas", ähnlich wie jede Überweisung bei Ihrer Bank eine Buchungsgebühr hat. In Stoßzeiten steigen die Gas Fees, wie Taxipreise zur Rush Hour.]


#glossary-entry[GPU (Graphics Processing Unit)][Ursprünglich für Computergrafik entwickelt, sind GPUs heute die Arbeitspferde der KI. Sie können tausende Berechnungen parallel ausführen — perfekt für das Training großer KI-Modelle. Die GPU-Knappheit ist einer der Engpässe der KI-Revolution.]


#glossary-entry[Halluzination][Wenn eine KI überzeugend klingende, aber frei erfundene Antworten gibt. Sie lügt nicht absichtlich — sie „halluziniert", weil sie Muster fortsetzt, statt Fakten zu prüfen. Wie ein Kollege, der lieber eine Antwort erfindet, als „Weiß ich nicht" zu sagen.]


#glossary-entry[Hash Rate][Die Rechenleistung, die ein Mining-Netzwerk aufbringt, gemessen in Hashes pro Sekunde. Je höher die Hash Rate, desto sicherer das Netzwerk. Wie die Anzahl der Sicherheitsschlösser an einem Tresor — mehr ist besser.]


#glossary-entry[Inference][Wenn eine bereits trainierte KI ihre Arbeit tut — Texte schreiben, Bilder erkennen, Entscheidungen treffen. Das Training ist die Ausbildung, die Inference ist der Arbeitstag danach.]


#glossary-entry[KYC/AML (Know Your Customer / Anti-Money Laundering)][Identitätsprüfung und Geldwäscheprävention: das kennen Sie aus Ihrem Berufsalltag. In der Krypto-Welt gelten zunehmend dieselben Regeln: Börsen müssen wissen, wer ihre Kunden sind.]


#glossary-entry[Layer-1 / Layer-2][Layer-1 ist die Haupt-Blockchain (z. B. Ethereum), Layer-2 ist eine Ebene darüber, die Transaktionen schneller und günstiger macht. Vergleich: Layer-1 ist die Autobahn, Layer-2 sind Schnellstraßen, die den Verkehr entlasten und auf die Autobahn zurückführen.]


#glossary-entry[LLM (Large Language Model)][Die KI-Modelle hinter ChatGPT und Co. — trainiert mit riesigen Textmengen, um menschliche Sprache zu verstehen und zu erzeugen. Kein echtes Denken, aber beeindruckend gute Mustererkennung. Wie ein Mitarbeiter, der jedes Buch der Welt gelesen hat, aber trotzdem kein eigenes Urteilsvermögen besitzt.]


#glossary-entry[Loitering Munition][Bewaffnete Drohnen, die über einem Gebiet kreisen und selbständig Ziele angreifen können. Im Buch erwähnt als Beispiel für die Verschmelzung von KI und Militärtechnologie.]


#glossary-entry[MiCA (Markets in Crypto-Assets Regulation)][Das EU-Regelwerk für Kryptowerte, seit 2024 in Kraft. MiCA ist für Krypto das, was MiFID II für Wertpapiere ist: ein einheitlicher europäischer Regulierungsrahmen mit Lizenzpflichten und Verbraucherschutz.]


#glossary-entry[Mining][Der Prozess, bei dem Computer komplexe Rechenaufgaben lösen, um neue Blöcke zur Blockchain hinzuzufügen und dafür Kryptowährungen als Belohnung erhalten. Wie Goldschürfen, nur mit Strom statt Schaufel.]


#glossary-entry[NFT (Non-Fungible Token)][Ein digitales Echtheitszertifikat auf der Blockchain — einzigartig und nicht austauschbar. Jeder Euro ist gleich (fungibel), aber ein NFT ist wie ein nummerierter Kunstdruck: Es gibt nur dieses eine Exemplar mit dieser Nummer.]


#glossary-entry[Node][Ein Computer im Blockchain-Netzwerk, der eine Kopie des gesamten Kassenbuchs speichert und Transaktionen überprüft. Je mehr Nodes, desto dezentraler und sicherer das Netzwerk. Wie eine Filiale, die eigenständig Buchungen validiert.]


#glossary-entry[On-Chain][Alles, was direkt auf der Blockchain passiert und dort für jeden sichtbar gespeichert wird. On-Chain-Daten sind wie notariell beglaubigte Einträge: öffentlich, unveränderlich, nachprüfbar.]


#glossary-entry[Oracle][Ein Dienst, der reale Daten (Aktienkurse, Wetter, Sportergebnisse) in eine Blockchain einspeist. Blockchains leben in ihrer eigenen Welt und brauchen Oracles als Fenster zur Außenwelt. Wie ein Kurier, der der Bank die aktuellen Börsenkurse bringt.]


#glossary-entry[Private Key / Public Key][Ihr Private Key ist das Passwort zu Ihrem Krypto-Vermögen — verlieren Sie ihn, ist das Geld weg. Für immer. Der Public Key ist wie Ihre IBAN: Den dürfen alle kennen, damit man Ihnen Geld schicken kann. Den Private Key zeigen Sie niemandem, wie Ihre TAN-Liste.]
...
#glossary-entry[RWA (Real World Assets)][Reale Vermögenswerte — Immobilien, Anleihen, Gold — die als Token auf einer Blockchain abgebildet werden. Statt einen ganzen Büroturm zu kaufen, besitzen Sie einen Token, der einem Tausendstel entspricht. Wie Fondsanteile, nur auf der Blockchain.]


#glossary-entry[Self-Custody][Sie verwahren Ihre Kryptowährungen selbst, ohne Bank oder Börse dazwischen. Volle Kontrolle, volle Verantwortung. Wie Bargeld im Haustresor statt auf dem Bankkonto: Niemand kann es einfrieren, aber bei Verlust hilft keine Hotline.]


#glossary-entry[Smart Contract][Ein Programm auf der Blockchain, das automatisch ausgeführt wird, wenn bestimmte Bedingungen erfüllt sind. Kein Vertrag im juristischen Sinne, sondern eher ein Automat: Geld rein, Bedingung erfüllt, Aktion ausgeführt. Wie ein Dauerauftrag, nur dass er beliebig komplex sein kann.]


#glossary-entry[SMR (Small Modular Reactor)][Kleine, modulare Kernreaktoren — eine neue Generation von Atomkraftwerken, die kleiner, billiger und schneller zu bauen sind. Im Buch relevant, weil Bitcoin-Mining und KI-Rechenzentren enorme Mengen Strom brauchen.]


#glossary-entry[Stablecoin][Eine Kryptowährung, die an einen stabilen Wert gekoppelt ist — meist den US-Dollar. Während Bitcoin wie eine Achterbahn schwankt, bleibt ein Stablecoin bei ca. 1 Dollar. Das digitale Äquivalent eines Geldmarktfonds: langweilig, aber zuverlässig.]


#glossary-entry[Staking][Sie „parken" Ihre Kryptowährungen im Netzwerk, um es abzusichern, und erhalten dafür Zinsen. Wie eine Festgeldanlage: Ihr Geld arbeitet, solange es gebunden ist.]


#glossary-entry[SWU (Separative Work Unit)][Maßeinheit für den Aufwand bei der Urananreicherung. Im Buch erwähnt im Zusammenhang mit Energieversorgung für Mining und KI. Kein Krypto-Begriff, aber Teil des Energie-Kontexts.]


#glossary-entry[Token][Ein digitaler Vermögenswert auf einer Blockchain. Kann alles repräsentieren — Geld, Stimmrechte, Kunstwerke, Firmenanteile. Bitcoin ist ein Token, aber nicht jeder Token ist Bitcoin. Denken Sie an Wertmarken: gleiche Form, verschiedener Wert.]


#glossary-entry[Tokenisierung][Der Prozess, reale Vermögenswerte in digitale Token umzuwandeln. Eine Immobilie wird in 10.000 Token aufgeteilt, die an einer Blockchain-Börse handelbar sind. Wie eine Verbriefung (ABS), nur transparenter und rund um die Uhr handelbar.]


#glossary-entry[TVL (Total Value Locked)][Der Gesamtwert aller Vermögenswerte, die in einem DeFi-Protokoll hinterlegt sind — die wichtigste Kennzahl der DeFi-Welt. Vergleichbar mit der Bilanzsumme einer Bank: zeigt, wie viel Vertrauen das System genießt.]


#glossary-entry[Wallet][Ihre digitale Geldbörse für Kryptowährungen. Genauer gesagt speichert ein Wallet nicht die Coins selbst, sondern die Schlüssel dazu. Wie ein Schlüsselbund: Die Wertgegenstände liegen in der Blockchain, das Wallet öffnet die Tür.]


#glossary-entry[Yield Farming][Eine DeFi-Strategie, bei der Sie Ihre Kryptowährungen zwischen verschiedenen Protokollen hin- und herschieben, um die höchsten Zinsen zu ergattern. Wie Tagesgeld-Hopping zwischen Banken, nur automatisiert und mit deutlich höheren Risiken.]


#glossary-entry[Zero-Knowledge Proof][Ein kryptographisches Verfahren, mit dem Sie etwas beweisen können, ohne die Information selbst preiszugeben. Beispiel: Sie beweisen, dass Sie über 18 sind, ohne Ihr Geburtsdatum zu verraten. Relevant für Datenschutz auf Blockchains.]


#pagebreak()

#heading(level: 1)[Anhang B — Umsetzung für deutsche Anleger]


Dieses Buch beschreibt eine Investmentthese. Dieser Anhang macht sie praktisch umsetzbar — für jeden, der ein Depot bei einer deutschen Direktbank hat. Stand: Februar 2026. Produkte und ISINs können sich ändern. Aktuelle Informationen finden Sie auf der Companion-Website zum Buch.


#heading(level: 2)[Der sichere Kern: ETFs und Einzelaktien]
...
Energie und Uran: Der Global X Uranium ETF (ISIN: IE000NDWFGA5) investiert in Uranproduzenten und Versorger. Für die Nuklear-These aus Kapitel 7 eine gezielte Wette.


#heading(level: 2)[Die asymmetrische Seite: Krypto-Zugang]
...
#heading(level: 2)[⚠️ Wichtiger Hinweis]
...
#heading(level: 1)[Anhang C — Tokenomics-Vergleich]
...
#heading(level: 1)[Anhang D — Literaturverzeichnis]


#text(style: "italic", size: 9.5pt)[Die folgende Übersicht umfasst alle im Buch zitierten oder referenzierten Werke, geordnet nach Kategorie. Vollständige Einzelbelege finden sich in den Endnotes.]


#heading(level: 2)[Bücher]


#text(size: 9pt)[Acemoglu, Daron / Johnson, Simon: Power and Progress — Our Thousand-Year Struggle Over Technology and Prosperity. PublicAffairs, 2023.]


#text(size: 9pt)[Alden, Lyn: Broken Money — Why Our Financial System Is Failing Us and How We Can Make It Better. Wiley, 2023.]


#text(size: 9pt)[Allison, Graham: Destined for War — Can America and China Escape Thucydides's Trap? Houghton Mifflin Harcourt, 2017.]


#text(size: 9pt)[Aschenbrenner, Leopold: Situational Awareness — The Decade Ahead. situational-awareness.ai, 2024.]


#text(size: 9pt)[Booth, Jeff: The Price of Tomorrow — Why Deflation Is the Key to an Abundant Future. Stanley Press, 2020.]


#text(size: 9pt)[Bostrom, Nick: Deep Utopia — Life and Meaning in a Solved World. Ideapress Publishing, 2024.]


#text(size: 9pt)[Case, Anne / Deaton, Angus: Deaths of Despair and the Future of Capitalism. Princeton University Press, 2020.]


#text(size: 9pt)[Cowen, Tyler: Average Is Over — Powering America Beyond the Age of the Great Stagnation. Dutton, 2013.]


#text(size: 9pt)[Dalio, Ray: Principles for Dealing with the Changing World Order — Why Nations Succeed and Fail. Avid Reader Press, 2021.]


#text(size: 9pt)[Frankl, Viktor E.: Man's Search for Meaning. Beacon Press, 1946/2006. [Im Text: „existentielles Vakuum"]]


#text(size: 9pt)[Frey, Carl B. / Osborne, Michael A.: The Technology Trap — Capital, Labor, and Power in the Age of Automation. Princeton University Press, 2019.]


#text(size: 9pt)[Harari, Yuval Noah: Homo Deus — A Brief History of Tomorrow. Harper, 2017.]


#text(size: 9pt)[Kahneman, Daniel: Thinking, Fast and Slow. Farrar, Straus and Giroux, 2011.]


#text(size: 9pt)[Kurzweil, Ray: The Singularity Is Nearer — When We Merge with AI. Viking, 2024.]


#text(size: 9pt)[Marks, Howard: The Most Important Thing — Uncommon Sense for the Thoughtful Investor. Columbia University Press, 2011.]


#text(size: 9pt)[Marx, Karl / Engels, Friedrich: Manifest der Kommunistischen Partei. 1848. [Im Text: „Die moderne bürgerliche Gesellschaft…"]]


#text(size: 9pt)[Miller, Chris: Chip War — The Fight for the World's Most Critical Technology. Scribner, 2022.]


#text(size: 9pt)[Mostaque, Emad: The Last Economy — Why Intelligence Is the Last Scarce Resource. thelasteconomy.com, 2025.]


#text(size: 9pt)[Sinclair, David A.: Lifespan — Why We Age and Why We Don't Have To. Atria Books, 2019.]


#text(size: 9pt)[Srinivasan, Balaji: The Network State — How to Start a New Country. 1729.com, 2022.]


#text(size: 9pt)[Taleb, Nassim Nicholas: Antifragile — Things That Gain from Disorder. Random House, 2012.]


#text(size: 9pt)[Taleb, Nassim Nicholas: The Black Swan — The Impact of the Highly Improbable. Random House, 2007.]


#text(size: 9pt)[Thiel, Peter (mit Blake Masters): Zero to One — Notes on Startups, or How to Build the Future. Crown Business, 2014.]


#text(size: 9pt)[Zuboff, Shoshana: The Age of Surveillance Capitalism — The Fight for a Human Future at the New Frontier of Power. PublicAffairs, 2019.]


#heading(level: 2)[Wissenschaftliche Arbeiten und Fachaufsätze]


#text(size: 9pt)[Campbell, Gareth: „Myopic Rationality, Overconfidence and Speculative Behaviour — Hallucinations and Inefficient Markets: The British Railway Mania of the 1840s". University of Minnesota, 2010.]


#text(size: 9pt)[Chalmers, David: „Facing Up to the Problem of Consciousness". Journal of Consciousness Studies, 1995.]


#text(size: 9pt)[DeepMind/EMBL-EBI: „AlphaFold Protein Structure Database". Nature, Juli 2022.]


#text(size: 9pt)[Frey, Carl B. / Osborne, Michael A.: „The Future of Employment — How Susceptible Are Jobs to Computerisation?" University of Oxford, 2013.]


#text(size: 9pt)[Shiller, Robert: „Robotization Without Taxation?" Project Syndicate, 22. März 2017.]


#text(size: 9pt)[Stigler, George: „The Theory of Economic Regulation". Bell Journal of Economics, 1971.]


#heading(level: 2)[Institutionelle Reports und Studien]


#text(size: 9pt)[ARK Invest: Big Ideas Report 2025/2026. ark-invest.com.]


#text(size: 9pt)[Canton Network: State of RWA Tokenization 2026. Dezember 2025.]


#text(size: 9pt)[Goldman Sachs: „AI Is Poised to Drive 160% Increase in Data Center Power Demand". Goldman Sachs Research, 2024.]


#text(size: 9pt)[Goldman Sachs: „The Rise of Humanoid Robots — \$38 Billion by 2035". Goldman Sachs Research, 2025.]


#text(size: 9pt)[IEA (International Energy Agency): Electricity 2024. iea.org.]


#text(size: 9pt)[IEA (International Energy Agency): World Energy Outlook 2025. iea.org.]


#text(size: 9pt)[IMF (International Monetary Fund): Global Financial Stability Report. Diverse Ausgaben, 2024/2025.]


#text(size: 9pt)[McKinsey Global Institute: „The Economic Potential of Generative AI — The Next Productivity Frontier". McKinsey & Company, Juni 2023.]


#text(size: 9pt)[NASSCOM: Indian IT Industry Overview. 2025.]


#text(size: 9pt)[PitchBook / CB Insights: AI & FinTech Investment Reports. Diverse Ausgaben, 2024/2025.]


#text(size: 9pt)[S&P Global: „The Future of Copper". 2024.]


#text(size: 9pt)[Stanford HAI: AI Index Report. Jährlich, ai.stanford.edu.]


#text(size: 9pt)[Visa Inc.: Annual Report 2024.]


#text(size: 9pt)[World Economic Forum: Future of Jobs Report. Januar 2025.]


#heading(level: 2)[Datenquellen und On-Chain-Analyse]


#text(size: 9pt)[Artemis (artemis.xyz) — Stablecoin-Volumen und On-Chain-Transaktionsdaten.]


#text(size: 9pt)[Chainalysis / CoinGecko — Stablecoin-Marktdaten und Blockchain-Analysen.]


#text(size: 9pt)[Crunchbase / PitchBook — Startup-Finanzierungsdaten, insbesondere für Longevity und KI.]


#text(size: 9pt)[DefiLlama (defillama.com) — TVL-Daten für alle DeFi-Protokolle, Open Source.]


#text(size: 9pt)[Dune Analytics (dune.com) — Benutzerdefinierte On-Chain-Dashboards für Ethereum, Solana u.a.]


#text(size: 9pt)[Glassnode (glassnode.com) — Bitcoin- und Ethereum-On-Chain-Metriken.]


#text(size: 9pt)[rwa.xyz — Spezialdaten für tokenisierte Real-World Assets: TVL, Protokollvergleiche, Wachstumsraten.]


#text(size: 9pt)[The Block (theblock.co) — Research-Dashboards für Krypto-Marktdaten und institutionelle Flows.]


#heading(level: 2)[Nachrichtenquellen und Medienberichte]


#text(size: 9pt)[+972 Magazine / Local Call: „'Lavender' — The AI Machine Directing Israel's Bombing Spree in Gaza". April 2024.]


#text(size: 9pt)[Bloomberg: Diverse Berichte zu Krypto-Regulierung, KI-Investments und Unternehmensprofile.]


#text(size: 9pt)[CNBC: „OpenAI Closes \$40 Billion in Funding". 31. März 2025.]


#text(size: 9pt)[Neuralink: „Two Years of Telepathy". 2. Februar 2026.]


#text(size: 9pt)[Reuters: „ChatGPT Sets Record for Fastest-Growing User Base". Februar 2023.]


#text(size: 9pt)[Washington Post: „The Google Engineer Who Thinks the Company's AI Has Come to Life". Juni 2022.]


#heading(level: 2)[Weiterbildung und Kurse]


#text(size: 9pt)[Blockchain Fundamentals — edx.org (UC Berkeley).]


#text(size: 9pt)[Google AI Essentials — coursera.org.]


#text(size: 9pt)[NVIDIA GTC Keynotes — nvidia.com/gtc.]


#text(size: 9pt)[Prompt Engineering for Everyone — DeepLearning.AI.]


#pagebreak()

#heading(level: 1)[Anhang E — Das Kinderportfolio: Für Mila und Malou]
...
#heading(level: 2)[Das Junior-Depot]
...
#heading(level: 2)[Die AI-Species-Kinderbarbell]
...
#table(
  ...
  [#text(weight: "bold", size: 8.5pt, font: "Source Sans 3")[Asset]], [#text(weight: "bold", size: 8.5pt, font: "Source Sans 3")[Produkt / ISIN]], [#text(weight: "bold", size: 8.5pt, font: "Source Sans 3")[Anteil]], [#text(weight: "bold", size: 8.5pt, font: "Source Sans 3")[Betrag]],

  [MSCI World ETF], [IE00B4L5Y983 (TER 0,20 %)], [100 %], [200 €],

  table.cell(colspan: 4)[#text(weight: "bold", size: 8.5pt, font: "Source Sans 3", fill: navy)[Variante A — Der einfache Weg (1 ETF): 200 Euro pro Monat in einen MSCI World ETF (ISIN: IE00B4L5Y983, TER: 0,20 Prozent) oder einen Vanguard FTSE All-World (ISIN: IE00BK5BQT80, TER: 0,22 Prozent). Historisch 7 bis 9 Prozent Rendite pro Jahr. Bei 8 Prozent und 18 Jahren: circa 96.000 Euro (eingezahlt: 43.200 Euro).]],
  ...
  table.cell(colspan: 4)[#text(weight: "bold", size: 8.5pt, font: "Source Sans 3", fill: navy)[Gesamt]],

  [100 %], [200 €], [], [],

  table.cell(colspan: 4)[#text(weight: "bold", size: 8.5pt, font: "Source Sans 3", fill: navy)[Variante B — Mit KI-Tilt (3 ETFs): 60 Prozent MSCI World (120 Euro), 25 Prozent Nasdaq-100 (50 Euro, ISIN: IE00BFZXGZ54), 15 Prozent Robotik-ETF (30 Euro, ISIN: IE00BYZK4552). Bei 10 Prozent Rendite: circa 120.000 Euro nach 18 Jahren.]],
...
#heading(level: 2)[Die Steuer-Strategie]
...
#heading(level: 2)[Was ich für Mila und Malou wähle]
...
#v(10pt)
#text(weight: "bold", size: 9pt, font: "Source Sans 3")[Vorwort]
#v(4pt)


[1.] #h(4pt) „Nassim Taleb hat geschrieben, dass man niemandem vertrauen sollte, der nicht selbst von dem betroffen ist, worüber er urteilt." — Nassim Nicholas Taleb, Skin in the Game: Hidden Asymmetries in Daily Life, Random House, 2018.


[2.] #h(4pt) „Peter Thiel hat einmal gesagt, die wertvollsten Unternehmen bauen auf Überzeugungen auf, die fast niemand teilt, die aber richtig sind." — Peter Thiel, Zero to One: Notes on Startups, or How to Build the Future, Crown Business, 2014.


#v(10pt)
#text(weight: "bold", size: 9pt, font: "Source Sans 3")[Kapitel 1: Am Anfang der größten Transformation seit 250 Jahren]
#v(4pt)


[3.] #h(4pt) „Als James Watt 1769 seinen verbesserten Motor patentierte" — James Watts Patent für den separaten Kondensator wurde 1769 erteilt (britisches Patent Nr. 913). Historisch dokumentiert u.a. in: Ben Marsden, Watt's Perfect Engine, Columbia University Press, 2002.


[4.] #h(4pt) „In den 1880er Jahren beleuchtete Thomas Edison die Pearl Street Station in Manhattan, den ersten kommerziellen Stromgenerator der Welt." — Die Pearl Street Station ging am 4. September 1882 in Betrieb. Vgl. Jill Jonnes, Empires of Light, Random House, 2003.


[5.] #h(4pt) „Tim Berners-Lee 1991 das World Wide Web veröffentlichte" — Tim Berners-Lee veröffentlichte das World Wide Web am 6. August 1991 öffentlich. Vgl. Tim Berners-Lee, Weaving the Web, HarperCollins, 1999.


[6.] #h(4pt) „1995, vier Jahre nach dem Launch, nutzten weniger als ein Prozent der Weltbevölkerung das Internet." — Internet Live Stats, basierend auf ITU World Telecommunication/ICT Indicators Database. Ca. 40 Millionen Nutzer bei 5,7 Milliarden Weltbevölkerung.


[7.] #h(4pt) „Der damalige Astronomer Royal Großbritanniens, Martin Rees, gab dem Internet in seiner aktuellen Form ‚ungefähr so viel Zukunft wie dem CB-Funk.'" — Zuschreibung an Martin Rees, häufig zitiert, Originalquelle nicht abschließend belegbar.


[8.] #h(4pt) „Paul Krugman schrieb 1998: ‚By 2005 or so, it will become clear that the Internet's impact on the economy has been no greater than the fax machine's.'" — Paul Krugman, „Why Most Economists' Predictions Are Wrong", Red Herring, Juni 1998.


[9.] #h(4pt) „Die britische Eisenbahnmanie der 1840er Jahre war die erste große Technologie-Blase der Geschichte." — Andrew Odlyzko, „Collective Hallucinations and Inefficient Markets: The British Railway Mania of the 1840s", University of Minnesota, 2010.


[10.] #h(4pt) „Amazon fiel von 113 Dollar auf 5,97 Dollar" — Amazon-Aktienkurs vom Hoch im Dezember 1999 zum Tief im September 2001. Historische Kursdaten, diverse Quellen.


[11.] #h(4pt) „Sir John Templeton einst warnte" — Sir John Templeton, häufig zitiertes Bonmot über die „four most dangerous words in investing". Vgl. Lauren C. Templeton, Investing the Templeton Way, McGraw-Hill, 2008.


[12.] #h(4pt) „Emad Mostaque, der Gründer von Stability AI, nennt das die ‚Intelligence Inversion': die vierte und letzte ökonomische Umwälzung der Menschheitsgeschichte." — Emad Mostaque, The Last Economy, 2025. Kostenlos verfügbar auf thelasteconomy.com.


[13.] #h(4pt) „‚AI replaces the mind itself', schreibt Mostaque in seinem Buch ‚The Last Economy'" — Emad Mostaque, The Last Economy, 2025.


[14.] #h(4pt) „Mostaque gibt der Menschheit dafür ein ‚Thousand-Day Window'." — Emad Mostaque, The Last Economy, 2025.


[15.] #h(4pt) „Mostaque hat in ‚The Last Economy' sieben Grundannahmen identifiziert, die in den ökonomischen Lehrbüchern als Wahrheiten gelten" — Emad Mostaque, The Last Economy, 2025.


#v(10pt)
#text(weight: "bold", size: 9pt, font: "Source Sans 3")[Kapitel 2: Die KI-Revolution in vier Phasen]
#v(4pt)


[16.] #h(4pt) „Am 30. November 2022 veröffentlichte OpenAI ChatGPT. Innerhalb von fünf Tagen hatte die Anwendung eine Million Nutzer. Innerhalb von zwei Monaten hundert Millionen." — Diverse Quellen, u.a. Reuters, „ChatGPT sets record for fastest-growing user base", 2. Februar 2023.


[17.] #h(4pt) „GitHub Copilot, Microsofts KI-Programmierassistent, schreibt mittlerweile über 40 Prozent des gesamten neuen Codes auf der Plattform." — Thomas Dohmke (CEO GitHub), CNBC Interview, 14. Oktober 2022; Sequoia Capital Podcast, November 2025. Die 40 Prozent beziehen sich auf den Anteil des von Copilot generierten Codes in Dateien, in denen er aktiviert ist.


[18.] #h(4pt) „Google DeepMinds AlphaFold hat die dreidimensionale Struktur von über 200 Millionen Proteinen vorhergesagt" — DeepMind/EMBL-EBI, „AlphaFold Protein Structure Database", Juli 2022. Vgl. Nature, „Highly accurate protein structure prediction with AlphaFold", 15. Juli 2021.


[19.] #h(4pt) „McKinsey schätzt das jährliche Wertschöpfungspotenzial generativer KI auf 2,6 bis 4,4 Billionen Dollar." — McKinsey Global Institute, „The economic potential of generative AI: The next productivity frontier", Juni 2023.


[20.] #h(4pt) „Das gesamte BIP Deutschlands beträgt etwa 4,5 Billionen Dollar." — Weltbank, GDP Germany 2023: ca. \$4,46 Billionen; 2024: ca. \$4,66 Billionen.


[21.] #h(4pt) „GPT-5, im August 2025 veröffentlicht, und seine Nachfolger werden von 800 Millionen Nutzern weltweit verwendet." — OpenAI / Sam Altman, TechCrunch, 6. Oktober 2025: ChatGPT erreicht 800 Millionen wöchentlich aktive Nutzer.


[22.] #h(4pt) „Sam Altman spricht offen von ‚persönlicher Superintelligenz' [...] und hat dafür über 40 Milliarden Dollar an Investorengeldern eingesammelt." — CNBC, „OpenAI closes \$40 billion in funding", 31. März 2025. Finanzierungsrunde geführt von SoftBank, Bewertung: \$300 Milliarden.


[23.] #h(4pt) „Die geplante Bewertung beim Börsengang: eine Billion Dollar." — Reuters, 29. Oktober 2025: „OpenAI is laying the groundwork for an IPO that could value the company at up to \$1 trillion."


[24.] #h(4pt) „OpenAI verbrennt dabei rund 9 Milliarden Dollar pro Jahr und plant, 2026 sogar 14 Milliarden zu verlieren." — Fortune, 12. November 2025; The Information, Oktober 2024; Yahoo Finance, 21. Januar 2026.


[25.] #h(4pt) „Dario Amodei, der CEO, hat im Januar 2026 einen Essay veröffentlicht, in dem er warnt: ‚Die Kombination aus Intelligenz, Handlungsfähigkeit und schlechter Kontrollierbarkeit ist ein Rezept für existenzielle Gefahr.'" — Dario Amodei, „The Adolescence of Technology", darioamodei.com, 26. Januar 2026.


[26.] #h(4pt) „Anthropic [...] gerade 30 Milliarden Dollar in einer Finanzierungsrunde eingesammelt, bei einer Bewertung von 380 Milliarden." — Anthropic Pressemitteilung / Bloomberg / Reuters, 12. Februar 2026. Series G, \$30 Mrd., \$380 Mrd. Post-Money-Bewertung.


[27.] #h(4pt) „Demis Hassabis und John Jumper gewannen ihn 2024 für AlphaFold" — Nobelpreis für Chemie 2024, Nobelprize.org, Oktober 2024.


[28.] #h(4pt) „Waymo, das mit autonomen Taxis bereits 350 Millionen Dollar Umsatz macht und auf eine Bewertung von 126 Milliarden Dollar kommt." — Bloomberg / Reuters, Februar 2026.


[29.] #h(4pt) „72 Milliarden Dollar hat Meta 2025 in KI-Infrastruktur investiert, 2026 sollen es 135 Milliarden werden." — Meta Platforms Inc., Earnings Call / Pressemitteilung, 2025/2026. TechCrunch, Juli 2025; DCD, Januar 2026.


[30.] #h(4pt) „In weniger als zwei Jahren hat Musk 555.000 GPUs in einem einzigen Rechenzentrum in Memphis installiert, 18 Milliarden Dollar investiert und xAI dann mit SpaceX fusioniert." — Introl Blog, 3. Januar 2026; TechCrunch, 2. Februar 2026.


[31.] #h(4pt) „Grok [...] erreicht damit 600 Millionen Nutzer." — xAI, Series E-Ankündigung, Januar 2026. Die 600 Millionen beziehen sich auf die kombinierte monatliche Reichweite von X und Grok.


[32.] #h(4pt) „Apple [...] Partnerschaften, aktuell mit Google Gemini für eine Milliarde Dollar pro Jahr" — Bloomberg, 5. November 2025.


[33.] #h(4pt) „zwei Milliarden aktiven Apple-Geräte weltweit" — Apple Inc. / Tim Cook, Earnings Call, Januar 2025: über 2,35 Milliarden aktive Geräte.


[34.] #h(4pt) „Microsoft hat 13,75 Milliarden in OpenAI investiert und 27 Prozent des Unternehmens erhalten." — Microsoft / OpenAI, Oktober 2025. Die gängig berichtete Investitionssumme liegt bei \$13 Milliarden.


[35.] #h(4pt) „Amazon [...] hat 8 Milliarden in Anthropic investiert." — Amazon Pressemitteilungen, 2023–2024.


[36.] #h(4pt) „NVIDIA [...] bei Trainingschips über 80 Prozent Marktanteil hat." — Business Insider, Dezember 2024; Euronews, November 2025. Analysten schätzen NVIDIAs Marktanteil bei AI-Chips auf 80–95 Prozent.


[37.] #h(4pt) „Jensen Huang, der CEO von NVIDIA, schätzt, dass sie bis 2028 über eine Billion Dollar erreichen werden." — Jensen Huang, GTC 2025, März 2025. Prognose: \$1 Trillion Data Center CapEx bis 2028.


[38.] #h(4pt) „Tesla hat seinen humanoiden Roboter Optimus vorgestellt und plant die Produktion in größeren Stückzahlen ab 2026." — Tesla Inc., diverse Earnings Calls und Pressemitteilungen, 2024–2026.


[39.] #h(4pt) „Musk hat im Januar 2026 allerdings eingeräumt, dass ‚keiner der Optimus-Roboter nützliche Arbeit verrichtet'." — Electrek / Tesla Q4 2025 Earnings Call, 28. Januar 2026.


[40.] #h(4pt) „Tesla die Produktion von Model S und Model X einstellt, um die Fabrik in Fremont auf Optimus-Produktion umzurüsten" — CNBC, 28. Januar 2026. Bestätigt durch The Verge, The Guardian.


[41.] #h(4pt) „Boston Dynamics, seit 2020 im Besitz von Hyundai, hat auf der CES im Januar 2026 den neuen elektrischen Atlas vorgestellt." — Boston Dynamics / Hyundai, CES 2026, 5. Januar 2026.


[42.] #h(4pt) „Figure AI hat mit dem Figure 02 etwas geschafft [...] eine 20-Stunden-Schicht in einer BMW-Fabrik." — Figure AI / Humanoids Daily, Mai 2025.


[43.] #h(4pt) „Das Unternehmen [...] ist heute 39 Milliarden Dollar wert. Die Investorenliste: Jeff Bezos, NVIDIA, Microsoft, OpenAI." — Figure AI Finanzierungsrunden, diverse Quellen, 2024–2025.


[44.] #h(4pt) „1X Technologies aus Norwegen hat mit dem NEO den ersten humanoiden Roboter für Konsumenten auf den Markt gebracht: 20.000 Dollar oder 499 Dollar im Monat als Abo." — 1X Technologies / Mashable, Oktober 2025.


[45.] #h(4pt) „EQT, einer der größten Private-Equity-Fonds Europas, hat einen Deal über bis zu 10.000 Einheiten unterschrieben." — 1X Technologies / EQT, BusinessWire, 11. Dezember 2025.


[46.] #h(4pt) „Goldman Sachs prognostiziert den Markt für humanoide Roboter bis 2035 auf 38 Milliarden Dollar." — Goldman Sachs Research, „The global market for humanoid robots could reach \$38 billion by 2035", Februar 2024.


[47.] #h(4pt) „DeepSeek, ein chinesisches KI-Labor, veröffentlichte ein Open-Source-Sprachmodell" — DeepSeek, Januar 2025. Diverse Quellen, u.a. Reuters, Financial Times.


[48.] #h(4pt) „Ray Kurzweil hat diese exponentielle Entwicklung vor Jahrzehnten vorhergesagt. In ‚The Singularity Is Near'" — Ray Kurzweil, The Singularity Is Near, Viking, 2005.


[49.] #h(4pt) „Kurzweil hat für 2029 vorhergesagt, dass KI menschliches Niveau erreicht." — Ray Kurzweil, The Singularity Is Nearer, Viking, 2024.


#v(10pt)
#text(weight: "bold", size: 9pt, font: "Source Sans 3")[Kapitel 3: Warum Maschinen Krypto brauchen]
#v(4pt)


[50.] #h(4pt) „Balaji Srinivasan, der ehemalige CTO von Coinbase, hat dieses Konzept in seinem Denken über den ‚Network State' und die Zukunft des Geldes vorweggenommen." — Balaji Srinivasan, The Network State, 2022.


[51.] #h(4pt) „Im Mai 2025 veröffentlichte Coinbase ein Protokoll namens x402." — Coinbase / x402.org, Mai 2025.


[52.] #h(4pt) „Seit 1992 gibt es im HTTP-Standard [...] einen Statuscode mit der Nummer 402." — IETF RFC 2616 (HTTP/1.1), 1999; ursprünglich RFC 1945, 1996.


[53.] #h(4pt) „bis Ende 2025 hatte x402 über hundert Millionen Transaktionen verarbeitet. Vierhunderttausend Käufer, achtzigtausend Verkäufer." — Phemex News bestätigt über 100 Millionen Transaktionen bis 2025. Käufer- und Verkäuferzahlen basieren auf x402 Foundation-Daten.


[54.] #h(4pt) „Cloudflare gründete gemeinsam mit Coinbase die x402 Foundation. Google integrierte x402 in sein Agent-to-Agent-Protokoll." — Cloudflare Blog, Dezember 2025; x402 Foundation.


[55.] #h(4pt) „Am 3. Oktober 2025 stellte das Unternehmen Robo.ai auf der TOKEN2049 in Dubai etwas vor [...] Roboy339" — Robo.ai, TOKEN2049 Dubai, 3. Oktober 2025. PR Newswire.


[56.] #h(4pt) „Bosch hat mit dem Projekt moveID auf der Blockchain-Plattform peaq bereits demonstriert, wie Fahrzeuge eine eigene digitale Identität erhalten" — Cointelegraph, 18. September 2023; peaq.xyz.


[57.] #h(4pt) „DIMO, ein dezentrales Netzwerk mit über 180.000 angeschlossenen Fahrzeugen" — DIMO Network / The Robot Report, April 2025. Das Netzwerk wächst schnell und hat inzwischen deutlich mehr Fahrzeuge.


[58.] #h(4pt) „peaq hostet 6 Millionen Maschinen-Adressen über 60 dezentrale Infrastrukturprojekte in 22 Industrien." — peaq Network, offizielle Website / Bitrue, 2025/2026.


[59.] #h(4pt) „Fetch.ai hat ein Netzwerk aufgebaut, in dem autonome Agenten Dienstleistungen anbieten, nachfragen und bezahlen" — Fetch.ai, diverse Pressemitteilungen und Dokumentation.


[60.] #h(4pt) „Ocean Protocol hat einen Marktplatz für Daten geschaffen" — Ocean Protocol, offizielle Dokumentation.


[61.] #h(4pt) „21 Millionen Einheiten, nicht inflationierbar, nicht konfiszierbar" — Satoshi Nakamoto, „Bitcoin: A Peer-to-Peer Electronic Cash System", 2008.


[62.] #h(4pt) „Stablecoins haben 2024 ein Transaktionsvolumen von über 27 Billionen Dollar abgewickelt und damit Visa übertroffen." — Diverse Quellen, u.a. Visa Annual Report, Chainalysis / CoinGecko Stablecoin-Reports, 2024/2025.


[63.] #h(4pt) „Tether [...] mit weniger als 100 Mitarbeitern erwirtschaftet Tether Milliarden an Zinserträgen" — Tether Holdings Ltd., Attestation Reports, 2024/2025.


[64.] #h(4pt) „Helium hat ein weltweites IoT- und Mobilfunknetz aufgebaut" — Helium Network, offizielle Dokumentation.


[65.] #h(4pt) „Render ermöglicht es GPU-Besitzern, ihre ungenutzten Grafikprozessoren an ein Netzwerk zu vermieten" — Render Network, offizielle Dokumentation.


[66.] #h(4pt) „Emad Mostaque schlägt in ‚The Last Economy' ein duales Währungssystem vor: ‚Foundation Coins' [...] und ‚Culture Credits'" — Emad Mostaque, The Last Economy, 2025.


#v(10pt)
#text(weight: "bold", size: 9pt, font: "Source Sans 3")[Kapitel 4: Wenn alles ein Token wird]
#v(4pt)


[67.] #h(4pt) „In Dubai hat das Land Department Ende 2025 einen Piloten gestartet, in dem Immobilien [...] tokenisiert werden." — Dubai Land Department / Prypco Mint, Zawya, 25. Mai 2025.


[68.] #h(4pt) „Der Markt für tokenisierte Real-World Assets hat Ende 2025 die 36-Milliarden-Dollar-Marke überschritten." — rwa.xyz / Diverse Analysten-Reports, 2025.


[69.] #h(4pt) „Seit 2020 hat sich der Markt um über 2.200 Prozent vergrößert." — Canton Network, „State of RWA Tokenization 2026", Dezember 2025.


[70.] #h(4pt) „McKinsey erwartet 2 bis 4 Billionen Dollar bis 2030. Boston Consulting Group sagt 16 Billionen. Standard Chartered prognostiziert 30 Billionen bis 2034. Cathie Woods Firma Ark Invest rechnet mit über 11 Billionen." — Jeweilige Research-Reports: McKinsey, BCG/ADDX (Ledger Insights), Standard Chartered (\$30 Billionen bis 2034), ARK Invest (The Block, Januar 2026).


[71.] #h(4pt) „BlackRocks BUIDL-Fund [...] ist von 40 Millionen Dollar bei seinem Start im März 2024 auf fast 3 Milliarden Dollar Ende 2025 gewachsen." — BlackRock, Pressemitteilungen / rwa.xyz, 2024–2025.


[72.] #h(4pt) „RealT verkauft Anteile an US-Mietimmobilien ab 50 Dollar pro Token." — RealT, offizielle Website.


[73.] #h(4pt) „Das Ziel: 7 Prozent des gesamten Dubai-Immobilienmarktes tokenisiert bis 2033, das sind 16 Milliarden Dollar." — Dubai Land Department, Pressemitteilung, Mai 2025.


[74.] #h(4pt) „Hamilton Lane, einer der größten PE-Verwalter der Welt mit 920 Milliarden Dollar unter Verwaltung, hat über die Plattform Securitize Fonds tokenisiert und das Mindestinvestment auf 20.000 Dollar gesenkt." — Hamilton Lane / Securitize, Pressemitteilungen, 2023–2025.


[75.] #h(4pt) „Maple Finance hat kumuliert über 12 Milliarden Dollar an Krediten vergeben." — Maple Finance / 21shares, 2025.


[76.] #h(4pt) „BlackRock verwaltet über 10 Billionen Dollar." — BlackRock, Inc., Quartalsbericht, 2025.


[77.] #h(4pt) „Larry Fink sagt, ‚Tokenisierung wird die nächste Generation der Märkte sein'" — Larry Fink, BlackRock Annual Letter to Investors, 2024.


[78.] #h(4pt) „BUIDL wurde auf Uniswap gelistet." — Uniswap Labs / Securitize, 11. Februar 2026.


[79.] #h(4pt) „JPMorgan hat mit Onyx seine eigene Blockchain-Plattform gebaut. Kinexys, ehemals JPM Coin, wickelt täglich über 2 Milliarden Dollar an Transaktionen ab." — JPMorgan, Pressemitteilungen / Onyx, 2024/2025.


[80.] #h(4pt) „Goldman Sachs hat mit GS DAP eine Plattform für tokenisierte Anleihen aufgebaut." — Goldman Sachs, Pressemitteilungen, 2023–2025.


[81.] #h(4pt) „Citibank prognostiziert, dass Tokenisierung bis 2030 4 bis 5 Billionen Dollar erreicht." — Citi GPS Report, „Money, Tokens, and Games", 2023.


[82.] #h(4pt) „Im Juli 2025 unterzeichnete Trump den GENIUS Act, das erste umfassende Bundesgesetz für Stablecoins." — White House / Latham & Watkins, 18. Juli 2025.


[83.] #h(4pt) „Im Dezember 2025 erteilte die SEC der Depository Trust Company [...] einen No-Action Letter für einen dreijährigen Piloten zur Tokenisierung von Wertpapier-Custody auf Blockchains." — SEC, Division of Trading and Markets, No-Action Letter, 11. Dezember 2025.


[84.] #h(4pt) „Im Januar 2026 veröffentlichte die SEC ihr ‚Playbook für tokenisierte Wertpapiere'" — SEC, Joint Statement on Tokenized Securities, 28. Januar 2026.


[85.] #h(4pt) „Nasdaq [...] Im Januar 2026 beantragte die größte elektronische Börse der Welt bei der SEC, tokenisierte Aktien handeln zu dürfen." — Nasdaq / SEC Filing, eingereicht September 2025, veröffentlicht im Federal Register am 30. Januar 2026.


[86.] #h(4pt) „MiCA, die Markets in Crypto-Assets Regulation, ist seit dem 30. Dezember 2024 vollständig in Kraft." — EU-Verordnung 2023/1114 (MiCA), Amtsblatt der EU.


[87.] #h(4pt) „Das eWpG, das Gesetz über elektronische Wertpapiere, ist seit Juni 2021 in Kraft" — Gesetz über elektronische Wertpapiere (eWpG), BGBl. I S. 1423, Juni 2021.


[88.] #h(4pt) „Singapur hat mit Project Guardian das weltweit ambitionierteste Tokenisierungs-Projekt gestartet." — Monetary Authority of Singapore (MAS), Project Guardian, diverse Pressemitteilungen, 2022–2025.


[89.] #h(4pt) „Im November 2025 unterzeichneten die MAS und die Deutsche Bundesbank ein Memorandum of Understanding für grenzüberschreitende Tokenisierung." — MAS / Deutsche Bundesbank, TNGlobal, 14. November 2025.


[90.] #h(4pt) „Japan [...] erlaubt tokenisierte Immobilien-STOs für Retail-Investoren ab wenigen Hundert Dollar Mindestanlage." — Japan FSA, Regulierung Security Token Offerings. Mindestbeträge variieren je nach Anbieter.


#v(10pt)
#text(weight: "bold", size: 9pt, font: "Source Sans 3")[Kapitel 4 (Fortsetzung): Stablecoins, Dollar-Dominanz und Schulden]
#v(4pt)


[91.] #h(4pt) „Tether und Circle halten zusammen mehr US-Staatsanleihen als Saudi-Arabien. Der IWF hat das im Juli 2025 in seinem External Sector Report dokumentiert." — IWF, External Sector Report, Juli 2025.


[92.] #h(4pt) „Tether allein sitzt auf rund 130 Milliarden Dollar in kurzfristigen Treasury Bills." — Tether Holdings Ltd., Attestation Reports, 2025.


[93.] #h(4pt) „JPMorgan schätzt, dass Stablecoins bis 2027 zusätzliche Dollar-Nachfrage von 1,4 Billionen Dollar erzeugen könnten." — JPMorgan Research / Reuters, 8. Oktober 2025.


[94.] #h(4pt) „Standard Chartered sieht den Stablecoin-Markt bis Ende 2028 bei 2 Billionen Dollar" — Standard Chartered Research / Cointelegraph, 2026.


[95.] #h(4pt) „500 Millionen Nutzer, behauptet Tether." — Tether CEO Paolo Ardoino, 21. Oktober 2025. Bestätigt durch Brave New Coin, Yahoo Finance.


[96.] #h(4pt) „Der Anteil des Dollars an den globalen Zentralbankreserven ist auf 56 Prozent gefallen, den niedrigsten Stand seit 30 Jahren." — IWF, COFER Database, 2025.


[97.] #h(4pt) „Indonesien hat sich generell gegen eine aktive De-Dollarisierung positioniert und signalisiert, weiterhin am Dollar als Reservewährung festzuhalten." — Reuters / AP, 2025. [Quelle nicht unabhängig verifiziert]


[98.] #h(4pt) „Die Vereinigten Staaten sind mit knapp 39 Billionen Dollar verschuldet. 122 Prozent des BIP." — US Treasury / Congressional Budget Office, 2025.


[99.] #h(4pt) „Die Verschuldung steigt um 6,12 Milliarden Dollar pro Tag." — U.S. Congress Joint Economic Committee, Dezember 2025.


[100.] #h(4pt) „Allein die Zinszahlungen auf diese Schulden betrugen im Fiskaljahr 2025 über 1,2 Billionen Dollar." — U.S. Government Accountability Office, GAO-26-107908.


[101.] #h(4pt) „Das Congressional Budget Office projiziert: die Zinszahlungen werden sich bis 2036 auf 2,1 Billionen verdoppeln. Insgesamt 16,2 Billionen Dollar an Zinsen in den nächsten zehn Jahren." — PGPF / CBO, Budget and Economic Outlook, 2026.


[102.] #h(4pt) „Japan führt die globale Schuldenliga an mit über 250 Prozent des BIP. Italien steht bei 137 Prozent, Frankreich bei über 110 Prozent, Großbritannien bei 100 Prozent." — IWF, Fiscal Monitor, 2025.


[103.] #h(4pt) „IMF-Chefin Kristalina Georgieva warnte in Davos: ‚Die Schulden, die auf unseren Schultern lasten und sich 100 Prozent des globalen BIP nähern, werden eine sehr schwere Last sein.'" — Kristalina Georgieva, WEF Davos, Januar 2025.


[104.] #h(4pt) „Das Committee for a Responsible Federal Budget hat im Januar 2026 einen Bericht veröffentlicht: ‚What Would a Fiscal Crisis Look Like?'" — Committee for a Responsible Federal Budget, Januar 2026.


[105.] #h(4pt) „Die Federal Reserve Bank of Dallas hat es in einem Working Paper nüchtern formuliert" — Federal Reserve Bank of Dallas Working Paper. [Quelle nicht unabhängig verifiziert]


[106.] #h(4pt) „Canton Network Report von 2026 dokumentiert Preisunterschiede von 1 bis 3 Prozent für identische tokenisierte Assets auf verschiedenen Blockchains" — Canton Network, „State of RWA Tokenization 2026", Dezember 2025.


#v(10pt)
#text(weight: "bold", size: 9pt, font: "Source Sans 3")[Kapitel 5: Wenn Maschinen Unternehmen gründen]
#v(4pt)


[107.] #h(4pt) „Vitalik Buterin, der Mitgründer von Ethereum, hat das Konzept 2013 entwickelt." — Vitalik Buterin, Ethereum Whitepaper, 2013.


[108.] #h(4pt) „Die erste große DAO startete 2016 auf Ethereum. Sie hieß schlicht ‚The DAO' und sammelte 150 Millionen Dollar ein" — Diverse Quellen, u.a. The New York Times, Juni 2016.


[109.] #h(4pt) „Drei Tage bevor ich diese Zeilen schreibe, am 21. Februar 2026, hat Vitalik Buterin einen neuen Vorschlag veröffentlicht" — Vitalik Buterin, X (Twitter), 21. Februar 2026. Vgl. CoinDesk, CoinCentral.


[110.] #h(4pt) „‚AI becomes the government is dystopian. But AI used well can be empowering.'" — Vitalik Buterin, X (Twitter), 21. Februar 2026. Vollständiges Zitat: „But AI used well can be empowering, and push the frontier of democratic / decentralized modes of governance."


[111.] #h(4pt) „Olas, früher Autonolas, hat im November 2025 Pearl v1 gelauncht" — CoinDesk, 4. November 2025.


[112.] #h(4pt) „Fetch.ai, fusioniert mit SingularityNET und Ocean Protocol zur ASI Alliance" — ASI Alliance Pressemitteilung, 2024.


[113.] #h(4pt) „Der DePIN-Sektor insgesamt [...] umfasst mittlerweile rund 300 Projekte mit über 21 Millionen verbundenen Geräten." — DePIN Ninja / Messari Research, 2025.


[114.] #h(4pt) „Wyoming hat 2021 als erster US-Bundesstaat Gesetze verabschiedet, die es erlauben, DAOs als LLCs zu registrieren." — Wyoming Legislature, DAO LLC Act, 2021.


#v(10pt)
#text(weight: "bold", size: 9pt, font: "Source Sans 3")[Kapitel 6: Die geopolitische Dimension]
#v(4pt)


[115.] #h(4pt) „NVIDIAs Umsatz ist von 27 Milliarden Dollar im Geschäftsjahr 2023 auf über 130 Milliarden im Geschäftsjahr 2025 explodiert" — NVIDIA Corp., Annual Reports, FY2023 und FY2025.


[116.] #h(4pt) „AWS, Azure und Google Cloud kontrollieren zusammen über 65 Prozent des globalen Cloud-Computing-Marktes." — Synergy Research Group, 2025.


[117.] #h(4pt) „Allein 2024 flossen über 100 Milliarden Dollar in amerikanische KI-Startups." — PitchBook / CB Insights, 2024.


[118.] #h(4pt) „Indien hat 100 Millionen wöchentlich aktive ChatGPT-Nutzer." — Indien ist der größte ChatGPT-Markt außerhalb der USA. OpenAI / Similarweb, 2025.


[119.] #h(4pt) „Indien hat über 4 Millionen Software-Ingenieure" — NASSCOM, 2025.


[120.] #h(4pt) „Das Medianalter liegt bei 28 Jahren. In der EU liegt es bei 44." — UN Population Division / Eurostat, 2025.


[121.] #h(4pt) „Im März 2024 startete die indische Regierung die IndiaAI Mission mit einem Budget von 1,24 Milliarden Dollar" — Government of India, IndiaAI Mission, März 2024.


[122.] #h(4pt) „TSMC produziert über 90 Prozent der weltweit fortschrittlichsten Halbleiter" — TechInsights / SemiAnalysis, 2025.


[123.] #h(4pt) „ASMLs EUV-Maschinen [...] kosten über 300 Millionen Dollar pro Stück" — ASML, Annual Report, 2024/2025.


[124.] #h(4pt) „TSMC baut in Arizona die teuerste Chipfabrik der Geschichte. Die Gesamtinvestition ist von ursprünglich 12 Milliarden auf 165 Milliarden Dollar angeschwollen." — TSMC Pressemitteilung, 3. März 2025.


[125.] #h(4pt) „Intel [...] CEO Pat Gelsinger wurde im Dezember 2024 zum Rücktritt gedrängt [...] 7,86 Milliarden Dollar" — Intel Corp. / US CHIPS Act, Dezember 2024.


[126.] #h(4pt) „Samsung [...] Ausbeute bei etwa 50 Prozent [...] Marktanteil ist auf 9,3 Prozent gefallen, TSMC liegt bei 60." — TrendForce / SemiAnalysis, 2025.


[127.] #h(4pt) „Elon Musk hat sich für Samsung entschieden, mit einem 16,5-Milliarden-Dollar-Vertrag" — Bloomberg / Reuters, 2025.


#v(10pt)
#text(weight: "bold", size: 9pt, font: "Source Sans 3")[Kapitel 7: Energie — Der unsichtbare Engpass]
#v(4pt)


[128.] #h(4pt) „Das Training von GPT-4 hat schätzungsweise 50 Gigawattstunden verbraucht." — MIT Technology Review / Epoch AI, 2024/2025.


[129.] #h(4pt) „Goldman Sachs schätzt, dass eine einzelne ChatGPT-Anfrage etwa zehnmal so viel Strom verbraucht wie eine Google-Suche." — Goldman Sachs, „AI is poised to drive 160% increase in data center power demand", Mai 2024.


[130.] #h(4pt) „Rechenzentren [...] verbrauchen bereits heute geschätzt 4,4 Prozent des gesamten US-Stroms." — Pew Research, Oktober 2025: „Data centers accounted for 4% of total U.S. electricity use in 2024." U.S. Energy Information Administration / IEA.


[131.] #h(4pt) „Die Internationale Energieagentur (IEA) prognostiziert, dass sich der Energieverbrauch von Rechenzentren bis 2030 mehr als verdoppeln wird." — IEA, „Electricity 2024" Report.


[132.] #h(4pt) „OpenAI hat die US-Regierung aufgefordert, 100 Gigawatt zusätzliche Stromerzeugungskapazität pro Jahr zu bauen" — OpenAI, Infrastructure Blueprint, 2025.


[133.] #h(4pt) „Kernkraftwerk hat einen Kapazitätsfaktor von 92,5 Prozent [...] Solar liegt bei 23 bis 25 Prozent, Onshore-Wind bei 33 bis 35 Prozent." — U.S. EIA, Electric Power Monthly, 2024/2025.


[134.] #h(4pt) „Ein Kernkraftwerk braucht etwa 3,4 Quadratkilometer für 1 Gigawatt Leistung. Ein Solarpark braucht [...] 115 bis 195 Quadratkilometer." — U.S. Department of Energy / NREL, Land-Use Requirements for Solar and Wind, 2021.


[135.] #h(4pt) „Gordon Hughes, Energieökonom an der University of Edinburgh, hat durchgerechnet [...] 13,3 Milliarden Dollar." — Gordon Hughes, Analyse zu Rechenzentrumsversorgung, 2024/2025. [Quelle nicht unabhängig verifiziert]


[136.] #h(4pt) „Constellation Energy investiert ca. 1,6 Milliarden Dollar in die Wiederinbetriebnahme des Three Mile Island-Reaktors in Pennsylvania. Microsoft hat einen 20-jährigen Stromabnahmevertrag (PPA) unterzeichnet." — Constellation Energy / Utility Dive, September 2024.


[137.] #h(4pt) „Amazon hat 20 Milliarden Dollar in das Kernkraftwerk Susquehanna investiert" — Amazon / Talen Energy, Pressemitteilung, 2024.


[138.] #h(4pt) „Google hat 500 Megawatt Strom von Kairos Energy bestellt" — Google / Kairos Energy, Pressemitteilung, Oktober 2024.


[139.] #h(4pt) „NuScale Power hat als erstes Unternehmen eine NRC-Zertifizierung für ein SMR-Design erhalten" — NuScale Power / NRC, 2023.


[140.] #h(4pt) „Der Uranpreis hat sich seit 2020 mehr als verdoppelt [...] rund 88 Dollar im Februar 2026." — UxC / Cameco / Numerco, Uranpreis-Daten.


[141.] #h(4pt) „Kazatomprom [...] hat für 2026 eine Produktionskürzung von 10 Prozent angekündigt." — Kazatomprom, Pressemitteilung, 2025.


[142.] #h(4pt) „Cameco [...] musste seine Produktionsprognose im August 2025 um 19 Prozent senken." — Cameco Corp., Earnings Report Q2/Q3 2025.


[143.] #h(4pt) „Russlands Rosatom [...] etwa 40 Prozent" der globalen Anreicherungskapazität — World Nuclear Association, 2025.


[144.] #h(4pt) „Im Mai 2024 unterzeichnete Biden den ‚Prohibiting Russian Uranium Imports Act'." — U.S. Congress, Public Law 118-61, Mai 2024.


[145.] #h(4pt) „COP28 hat das Problem offiziell anerkannt: über 20 Länder haben sich zur Verdreifachung der Kernkraftkapazität bis 2050 bekannt." — COP28 Nuclear Energy Pledge, Dubai, Dezember 2023.


[146.] #h(4pt) „Googles Rechenzentrum in Council Bluffs, Iowa, verbrauchte 2024 allein eine Milliarde Gallonen." — The Oregonian / Google Environmental Report, 2024.


[147.] #h(4pt) „Google 2024 über 8 Milliarden Gallonen Wasser [...] Microsofts Wasserverbrauch stieg um 34 Prozent" — Google/Microsoft Environmental Sustainability Reports, 2024.


[148.] #h(4pt) „In The Dalles, Oregon [...] bezahlte Google 100.000 Dollar, um die Klage der Stadt gegen die Zeitung zu finanzieren." — The Oregonian, investigative Recherche, 2023/2024.


#v(10pt)
#text(weight: "bold", size: 9pt, font: "Source Sans 3")[Kapitel 8: Der menschliche Preis]
#v(4pt)


[149.] #h(4pt) „Marx hat das 1848 so formuliert: ‚Die moderne bürgerliche Gesellschaft [...]'" — Karl Marx und Friedrich Engels, Das Kommunistische Manifest, 1848.


[150.] #h(4pt) „Die Begriffe 'White Collar' und 'Blue Collar' sind Erfindungen des 20. Jahrhunderts" — Der Begriff „White Collar" wurde 1919 von Upton Sinclair geprägt (The Brass Check, 1919), „Blue Collar" folgte in den 1920er Jahren.


[151.] #h(4pt) „Eine McKinsey-Studie von 2024 schätzt, dass bis 2030 weltweit 400 Millionen Arbeitsplätze von KI-Automatisierung betroffen sein werden." — McKinsey Global Institute, „Jobs lost, jobs gained", ursprünglich 2017, aktualisiert 2023.


[152.] #h(4pt) „Yuval Noah Harari [...] In ‚Homo Deus' von 2016 hat der israelische Historiker einen Begriff geprägt [...] die ‚useless class'." — Yuval Noah Harari, Homo Deus: A Brief History of Tomorrow, Harvill Secker, 2016.


[153.] #h(4pt) „WEF-Zahl von 170 Millionen neuen Jobs [...] 92 Millionen verdrängten Jobs" — World Economic Forum, Future of Jobs Report, Januar 2025.


[154.] #h(4pt) „Anthropic [...] hat Anfang 2026 eine Studie veröffentlicht [...] observed exposure" — Anthropic Research, „Economic Impacts of AI", Anfang 2026.


[155.] #h(4pt) „Anne Case und Angus Deaton [...] das Phänomen der ‚Deaths of Despair' dokumentiert." — Anne Case und Angus Deaton, Deaths of Despair and the Future of Capitalism, Princeton University Press, 2020.


[156.] #h(4pt) „Japans Hikikomori-Phänomen [...] Mehr als eine Million junger Japaner" — Japanese Cabinet Office, Hikikomori Survey, 2023.


[157.] #h(4pt) „Viktor Frankl, der österreichische Psychiater und Holocaust-Überlebende, nannte es das ‚existentielle Vakuum'" — Viktor Frankl, Man's Search for Meaning (dt.: ...trotzdem Ja zum Leben sagen), 1946.


[158.] #h(4pt) „Finnland hat von 2017 bis 2018 das bekannteste nationale UBI-Experiment durchgeführt. 2.000 zufällig ausgewählte Arbeitslose bekamen monatlich 560 Euro" — Kela (Finnische Sozialversicherung), UBI-Experiment Final Report, 2020.


[159.] #h(4pt) „Sam Altmans eigene Studie [...] OpenResearch [...] 3.000 Teilnehmer in Illinois und Texas erhielten drei Jahre lang 1.000 Dollar monatlich." — OpenResearch, „Unconditional Cash Study", 2024.


[160.] #h(4pt) „In Stockton, Kalifornien [...] Bürgermeister Michael Tubbs gab 125 Einwohnern zwei Jahre lang 500 Dollar monatlich." — Stockton Economic Empowerment Demonstration (SEED), 2019–2021.


[161.] #h(4pt) „In Kenia [...] begleitet von MIT-Nobelpreisträger Abhijit Banerjee." — GiveDirectly / MIT, Kenya UBI Experiment, seit 2016.


[162.] #h(4pt) „Mostaque formuliert das in ‚The Last Economy' prägnant: ‚We are about to achieve post-scarcity in the realm of intelligence [...]'" — Emad Mostaque, The Last Economy, 2025.


[163.] #h(4pt) „JPMorgan investiert 17 Milliarden Dollar pro Jahr in Technologie und hat über 2.000 KI-Anwendungen im Einsatz." — JPMorgan Chase, Annual Report / Jamie Dimon Annual Letter, 2024/2025.


#v(10pt)
#text(weight: "bold", size: 9pt, font: "Source Sans 3")[Kapitel 9: Regulierung]
#v(4pt)


[164.] #h(4pt) „Strafen bei Verstößen: bis zu 35 Millionen Euro oder 7 Prozent des weltweiten Jahresumsatzes." — EU AI Act (Verordnung 2024/1689), Art. 99.


[165.] #h(4pt) „2025 flossen in die USA rund 215 Milliarden Dollar an KI-Risikokapital. In Europa waren es 37 Milliarden." — PitchBook / CB Insights, 2025.


[166.] #h(4pt) „46 CEOs der größten europäischen Unternehmen forderten im Juli 2025, die Umsetzung des AI Act um zwei Jahre zu pausieren." — Financial Times, Juli 2025.


[167.] #h(4pt) „Im Juli 2024 gab Meta bekannt, dass es seine multimodalen KI-Modelle in der EU nicht veröffentlichen werde." — Meta Platforms Inc., Blog / Pressemitteilung, Juli 2024.


[168.] #h(4pt) „Am 1. Dezember 2024 [...] Coinbase stellte das USDC Rewards Programm für alle Kunden im Europäischen Wirtschaftsraum ein." — Coinbase, Kundeninformation, Dezember 2024.


[169.] #h(4pt) „Aleph Alpha [...] Im September 2024 gab Aleph Alpha bekannt, dass es die Entwicklung eigener Sprachmodelle einstellt" — Aleph Alpha, Pressemitteilung, September 2024.


[170.] #h(4pt) „Bill Gates in einem Interview [...] ‚Wenn ein menschlicher Arbeiter in einer Fabrik 50.000 Dollar an Wertschöpfung erbringt [...]'" — Bill Gates, Interview mit Quartz, 17. Februar 2017.


[171.] #h(4pt) „Lawrence Summers [...] nannte den Vorschlag ‚zutiefst fehlgeleitet'." — Lawrence Summers, Washington Post, 2017.


[172.] #h(4pt) „Robert Shiller, Nobelpreisträger für Wirtschaft, sah das differenzierter." — Robert Shiller, „Robotization Without Taxation?", Project Syndicate, 22. März 2017.


[173.] #h(4pt) „Südkorea [...] 2018 [...] erste Art Robotersteuer" — ITIF, „How South Korea's Robot Tax Decreased Automation Investment", Februar 2026.


[174.] #h(4pt) „Eine Studie des Information Technology & Innovation Foundation von Februar 2026 fand, dass betroffene Industrien ihre Roboterinstallationen um 28 Prozent reduzierten." — ITIF Report, Februar 2026.


[175.] #h(4pt) „Im April 2024 enthüllte das israelische Magazin +972 ein System namens Lavender." — +972 Magazine / Local Call, „'Lavender': The AI machine directing Israel's bombing spree in Gaza", April 2024.


[176.] #h(4pt) „Palantir ist über 160 Milliarden Dollar wert, ein Kursanstieg von 330 Prozent in einem Jahr." — Palantir Technologies, Börsenkurs, 2025.


[177.] #h(4pt) „Anduril [...] wurde im Juni 2025 mit 30,5 Milliarden Dollar bewertet. Peter Thiels Founders Fund investierte eine Milliarde Dollar" — CNBC / Reuters, 5. Juni 2025.


[178.] #h(4pt) „Shield AI [...] steht bei 5,6 Milliarden." — Shield AI Finanzierungsrunde, 2025.


#v(10pt)
#text(weight: "bold", size: 9pt, font: "Source Sans 3")[Kapitel 10: Das wahrscheinlichste Szenario: 2026–2035]
#v(4pt)


[179.] #h(4pt) „Im Januar 2026 ging ein Open-Source-Projekt namens OpenClaw viral [...] Mitte Februar 2026 holte OpenAI den Entwickler an Bord." — Diverse Quellen, OpenClaw/ClawdBot GitHub, Februar 2026.


[180.] #h(4pt) „Microsoft schreibt bereits 30 Prozent seines Codes mit KI." — Microsoft / Satya Nadella, Earnings Call, 2025/2026.


[181.] #h(4pt) „McKinsey Global Institute hat im November 2025 berechnet, dass KI und Robotik bereits heute 57 Prozent aller US-Arbeitsstunden theoretisch automatisieren könnten." — McKinsey Global Institute, November 2025.


[182.] #h(4pt) „Goldman Sachs prognostiziert, dass 6 bis 7 Prozent aller US-Arbeitsplätze direkt verdrängt werden, bis zu 300 Millionen weltweit." — Goldman Sachs Research, 2024/2025.


[183.] #h(4pt) „Challenger, Gray & Christmas zählt für 2025 fast 55.000 Entlassungen in den USA, die direkt auf KI zurückgeführt werden." — Challenger, Gray & Christmas, Annual Report, 2025.


[184.] #h(4pt) „Amazon hat 14.000 Unternehmensstellen gestrichen [...] Microsoft entließ 6.000 Programmierer. Salesforce reduzierte seinen Kundensupport von 9.000 auf 5.000 Mitarbeiter [...] Klarna [...] 700 Vollzeitkräften" — Jeweilige Unternehmenspressemitteilungen, 2024/2025.


[185.] #h(4pt) „Goldman Sachs hat im August 2025 einen Befund veröffentlicht [...] Arbeitslosigkeit bei 20- bis 30-Jährigen [...] um fast 3 Prozentpunkte gestiegen" — Goldman Sachs Research, August 2025.


[186.] #h(4pt) „Entry-Level-Stellenausschreibungen im Softwarebereich sind in den USA um 67 Prozent eingebrochen. In Großbritannien fielen Tech-Absolventenstellen 2024 um 46 Prozent" — Diverse Quellen, u.a. Indeed, LinkedIn Economic Graph, ISE (UK).


[187.] #h(4pt) „San Franciscos Büroleerstand liegt bei 27,7 Prozent [...] Manhattan steht bei 22,3 Prozent" — CBRE / JLL, Commercial Real Estate Reports, 2025/2026.


[188.] #h(4pt) „Im Februar 2026 verloren nationale Office-REITs 16 Prozent ihres Werts in einer einzigen Woche" — REIT-Börsenkurse, Februar 2026.


[189.] #h(4pt) „71.000 neue Wohneinheiten aus Büro-Konversionen sind in den USA geplant." — CBRE / RentCafe, Office-to-Residential Conversion Report, 2025/2026.


[190.] #h(4pt) „Aurora Innovation hat im Mai 2025 den kommerziellen fahrerlosen LKW-Betrieb in Texas gestartet." — Aurora Innovation, Pressemitteilung, Mai 2025.


[191.] #h(4pt) „Waymo betreibt Robotaxis in 10 US-Städten mit über 400.000 Fahrten pro Woche" — Reuters, Februar 2026.


[192.] #h(4pt) „WIRED titelte im Januar 2026: ‚The Real AI Talent War Is for Plumbers and Electricians'" — WIRED Magazine, Januar 2026.


[193.] #h(4pt) „Kurzweil hat im Laufe der Jahre 147 Prognosen gemacht. Etwa 86 Prozent davon waren [...] korrekt" — Ray Kurzweil, The Singularity Is Nearer, Viking, 2024.


[194.] #h(4pt) „Mostaque [...] drei ‚Attraktorzustände' [...] Digital Feudalism [...] The Great Fragmentation [...] Human Symbiosis" — Emad Mostaque, The Last Economy, 2025.


#v(10pt)
#text(weight: "bold", size: 9pt, font: "Source Sans 3")[Kapitel 11: Das nächste Interface]
#v(4pt)


[195.] #h(4pt) „Neuralink hat sein ‚Telepathy'-Implantat bisher in 21 menschliche Patienten eingesetzt" — Neuralink, „Two Years of Telepathy", 2. Februar 2026.


[196.] #h(4pt) „Das System erreicht Tippgeschwindigkeiten von 40 Wörtern pro Minute" — Neuralink, PRIME Study Updates.


[197.] #h(4pt) „Neuralink hat über 650 Millionen Dollar eingesammelt, bei einer Bewertung von 9,7 Milliarden Dollar" — Neuralink Finanzierungsrunden, diverse Quellen.


[198.] #h(4pt) „Synchron hat 200 Millionen Dollar in einer Series D [...] eingesammelt." — Synchron, Pressemitteilung, 2025.


[199.] #h(4pt) „Paradromics hat Informationsübertragungsraten von über 200 Bit pro Sekunde demonstriert" — Paradromics, wissenschaftliche Publikation.


[200.] #h(4pt) „Im Januar 2026 führte OpenAI eine 250-Millionen-Dollar-Seed-Runde in Merge Labs an [...] bei einer Bewertung von 850 Millionen Dollar." — OpenAI / Merge Labs, Pressemitteilung, Januar 2026.


[201.] #h(4pt) „Der BCI-Markt soll mit einer jährlichen Wachstumsrate von über 15 Prozent wachsen [...] Die gesamte BCI-Finanzierung hat sich 2025 auf 867 Millionen Dollar verdreifacht." — Grand View Research / PitchBook, 2025.


[202.] #h(4pt) „Google DeepMinds Genie 3, veröffentlicht im August 2025, kann interaktive 3D-Umgebungen aus einem einfachen Textprompt generieren" — Google DeepMind, „Genie 3", August 2025.


[203.] #h(4pt) „Das bewusste Denken verarbeitet etwa 50 Bit Information pro Sekunde, das unbewusste Gehirn schätzungsweise 11 Millionen Bit pro Sekunde." — Diverse neurowissenschaftliche Quellen, u.a. Tor Nørretranders, The User Illusion, 1998.


[204.] #h(4pt) „Smartphone-Sucht betrifft geschätzt 6,3 Prozent der Weltbevölkerung, etwa 500 Millionen Menschen." — Diverse Meta-Studien, u.a. Journal of Behavioral Addictions.


[205.] #h(4pt) „Zwischen 2 und 20 Prozent der aktuellen VR-Nutzer zeigen bereits problematische Nutzungsmuster." — Frontiers in Virtual Reality, diverse Studien.


[206.] #h(4pt) „Südkorea hat die niedrigste Geburtenrate der Welt: 0,72 Kinder pro Frau (Stand 2023)" — Statistics Korea, 2023. Die Rate stieg 2024 leicht auf 0,75.


#v(10pt)
#text(weight: "bold", size: 9pt, font: "Source Sans 3")[Kapitel 12: Ethik und Philosophie der Maschinenökonomie]
#v(4pt)


[207.] #h(4pt) „Ray Kurzweil [...] ‚The Singularity Is Nearer'" — Ray Kurzweil, The Singularity Is Nearer: When We Merge with AI, Viking, 2024.


[208.] #h(4pt) „David Chalmers, der Philosoph, der das ‚Hard Problem of Consciousness' formuliert hat" — David Chalmers, „Facing Up to the Problem of Consciousness", Journal of Consciousness Studies, 1995.


[209.] #h(4pt) „Nick Bostrom [...] ‚Deep Utopia' von 2024" — Nick Bostrom, Deep Utopia: Life and Meaning in a Solved World, Ideapress Publishing, 2024.


[210.] #h(4pt) „‚People will look back on 2025 and shudder in horror'" — Nick Bostrom, Interview, 2025.


[211.] #h(4pt) „Yuval Noah Harari [...] In ‚Nexus' von 2024" — Yuval Noah Harari, Nexus: A Brief History of Information Networks from the Stone Age to AI, Random House, 2024.


[212.] #h(4pt) „Yoshua Bengio, Turing-Preisträger [...] 2025 gründete er ein 30-Millionen-Dollar-Nonprofit für KI-Sicherheit." — Yoshua Bengio, diverse Pressemitteilungen, 2025.


[213.] #h(4pt) „Im Dezember 2025 warnte er im Guardian, KI zeige Anzeichen von Selbsterhaltung." — Yoshua Bengio, The Guardian, Dezember 2025.


[214.] #h(4pt) „Peter Singer, der einflussreichste lebende Ethiker" — Peter Singer, Position zu KI-Rechten, diverse Interviews und Publikationen.


[215.] #h(4pt) „Im Juni 2022 behauptete Blake Lemoine, ein Google-Ingenieur [...] dass Googles Chatbot-System LaMDA empfindungsfähig sei." — Washington Post, „The Google engineer who thinks the company's AI has come to life", 11. Juni 2022.


[216.] #h(4pt) „Eric Schwitzgebel, Philosoph an der UC Riverside, hat das Argument auf den Punkt gebracht" — Eric Schwitzgebel, diverse Publikationen zu KI-Bewusstsein und Moral, 2023/2024.


[217.] #h(4pt) „Im Februar 2024 fällte ein Gericht in British Columbia ein Urteil [...] Air Canadas KI-Chatbot" — Moffatt v. Air Canada, British Columbia Civil Resolution Tribunal, Februar 2024.


[218.] #h(4pt) „Im August 2025 wurde Tesla zu einem Drittel haftbar für einen tödlichen Unfall mit dem Autopilot-System erklärt. 243 Millionen Dollar Schadenersatz." — Huang v. Tesla, US-Gericht, August 2025.


[219.] #h(4pt) „Shoshana Zuboff hat den ‚Surveillance Capitalism' beschrieben" — Shoshana Zuboff, The Age of Surveillance Capitalism, PublicAffairs, 2019.


[220.] #h(4pt) „Marshall McLuhan hat argumentiert, dass Medien Erweiterungen des Menschen sind." — Marshall McLuhan, Understanding Media: The Extensions of Man, McGraw-Hill, 1964.


[221.] #h(4pt) „Mostaque [...] ‚Alignment Economy' [...] ‚AI is the action layer'" — Emad Mostaque, The Last Economy, 2025.


#v(10pt)
#text(weight: "bold", size: 9pt, font: "Source Sans 3")[Kapitel 13: Unsterblichkeit als Investmentthese]
#v(4pt)


[222.] #h(4pt) „David Sinclair, Professor für Genetik an der Harvard Medical School" — David Sinclair, Lifespan: Why We Age — and Why We Don't Have To, Atria Books, 2019.


[223.] #h(4pt) „Im Januar 2026 [...] erhielt Life Biosciences [...] die FDA-Zulassung für die erste klinische Studie zur partiellen epigenetischen Reprogrammierung am Menschen." — Life Biosciences, Pressemitteilung, Januar 2026.


[224.] #h(4pt) „Sam Altman [...] hat 180 Millionen Dollar in Retro Biosciences investiert." — Retro Biosciences / Sam Altman, diverse Quellen, u.a. MIT Technology Review, 2023.


[225.] #h(4pt) „Retro strebt eine Bewertung von 5 Milliarden Dollar an" — Bloomberg / The Information, 2025/2026.


[226.] #h(4pt) „Brian Armstrong, der CEO von Coinbase, hat NewLimit mitgegründet [...] 130 Millionen Dollar" — NewLimit, Pressemitteilung, Series B, 2025.


[227.] #h(4pt) „Google hat Calico Labs bereits 2013 gegründet, mit über 1,5 Milliarden Dollar Finanzierung" — Alphabet/Calico Labs, diverse Quellen.


[228.] #h(4pt) „Jeff Bezos hat in Altos Labs investiert, ein Startup mit 3 Milliarden Dollar Finanzierung" — Altos Labs, Pressemitteilung, 2022.


[229.] #h(4pt) „Die gesamte Longevity-Investition überstieg 2024/2025 die Marke von 8,5 Milliarden Dollar." — Longevity Technology / PitchBook, 2025.


[230.] #h(4pt) „Der Longevity-Markt wird für 2026 auf über 30 Milliarden Dollar geschätzt und soll bis 2031 auf fast 47 Milliarden wachsen." — Grand View Research / Allied Market Research, 2025.


[231.] #h(4pt) „2011 haben Forscher an der Mayo Clinic den Beweis erbracht." — Baker et al., „Clearance of p16Ink4a-positive senescent cells delays ageing-associated disorders", Nature, November 2011.


[232.] #h(4pt) „Immortio Bio [...] gegründet Ende 2023, geführt von CEO Dr. Boris Resnik und dem wissenschaftlichen Leiter Dr. Thomas Ichim, der über 130 Publikationen und 360 Patente [...] vorweisen kann." — Immortio Bio, offizielle Website und Pressemitteilungen, 2024–2026.


[233.] #h(4pt) „Im Januar 2026, auf der Biotech Showcase während der JPM-Woche [...] präsentierte [...] Daten" — Immortio Bio, Biotech Showcase Präsentation, Januar 2026.


[234.] #h(4pt) „Shinya Yamanaka, der 2012 den Nobelpreis für seine Arbeit zur Zellreprogrammierung erhielt" — Nobelprize.org, Nobelpreis für Physiologie oder Medizin 2012.


#v(10pt)
#text(weight: "bold", size: 9pt, font: "Source Sans 3")[Kapitel 14: Die Barbell-Strategie]
#v(4pt)


[235.] #h(4pt) „Nassim Nicholas Taleb [...] Barbell-Strategie" — Nassim Nicholas Taleb, Antifragile: Things That Gain from Disorder, Random House, 2012.


[236.] #h(4pt) „Ray Dalio [...] auf der Münchner Sicherheitskonferenz im Februar 2026 gewarnt hat, dass die USA in Phase 5 stecken" — Ray Dalio, Münchner Sicherheitskonferenz, Februar 2026.


[237.] #h(4pt) „Raoul Pal [...] 80 bis 90 Prozent in Krypto hält und den ‚Everything Code' predigt." — Raoul Pal, Real Vision / Interviews, diverse, 2024–2026.


[238.] #h(4pt) „Cathie Wood [...] Bitcoin bei 1,5 Millionen Dollar bis 2030" — Cathie Wood / ARK Invest, „Big Ideas Report", 2025/2026.


[239.] #h(4pt) „Warren Buffett, der Bitcoin immer noch ‚Rattengift zum Quadrat' nennt" — Warren Buffett, Berkshire Hathaway Annual Meeting, 2018.


[240.] #h(4pt) „Lyn Alden, Autorin von ‚Broken Money'" — Lyn Alden, Broken Money: Why Our Financial System is Failing Us and How We Can Make it Better, Timestamp Press, 2023.


[241.] #h(4pt) „Jeff Booth [...] In ‚The Price of Tomorrow'" — Jeff Booth, The Price of Tomorrow: Why Deflation is the Key to an Abundant Future, Stanley Press, 2020.


[242.] #h(4pt) „Paul Tudor Jones [...] 4,5 Prozent seines 9-Milliarden-Portfolios in Bitcoin-ETFs" — Paul Tudor Jones, CNBC Interview / SEC Filings, 2024.


[243.] #h(4pt) „Howard Marks [...] ‚The Most Important Thing'" — Howard Marks, The Most Important Thing: Uncommon Sense for the Thoughtful Investor, Columbia University Press, 2011.


[244.] #h(4pt) „Stanley Druckenmiller [...] 30 Jahre lang 30 Prozent durchschnittliche Jahresrendite" — Diverse Quellen, Bloomberg/CNBC Profile.


[245.] #h(4pt) „Michael Saylor [...] über 714.000 Bitcoin" — Strategy (MicroStrategy) SEC Filings / Phemex, Februar 2026.


[246.] #h(4pt) „Benjamin Graham [...] ‚Mr. Market'" — Benjamin Graham, The Intelligent Investor, Harper & Brothers, 1949.


[247.] #h(4pt) „George Stiglers ‚Theory of Regulation' aus den 1970er Jahren" — George Stigler, „The Theory of Economic Regulation", Bell Journal of Economics, 1971.


[248.] #h(4pt) „Graham Allisons ‚Thucydides Trap'" — Graham Allison, Destined for War: Can America and China Escape Thucydides's Trap?, Houghton Mifflin Harcourt, 2017.


[249.] #h(4pt) „Eine Studie des US-Außenministeriums beziffert die jährlichen globalen Wirtschaftsverluste einer chinesischen Blockade oder Invasion Taiwans auf über 2 Billionen Dollar." — U.S. State Department / Diverse Think-Tank-Studien (CSIS, Bloomberg Economics), 2024/2025.


[250.] #h(4pt) „The New York Times titelte am 24. Februar 2026: ‚The Looming Taiwan Chip Disaster That Silicon Valley Has Long Ignored.'" — The New York Times, 24. Februar 2026.


[251.] #h(4pt) „Wood Mackenzie prognostiziert für 2025 ein Angebotsdefizit von 30 Prozent bei Leistungstransformatoren." — Wood Mackenzie, Power Transformer Market Report, 2025.


[252.] #h(4pt) „S&P Global prognostiziert ein Angebotsdefizit von 10 Millionen Metrischen Tonnen [Kupfer] bis 2040" — S&P Global, „The Future of Copper", 2024.


[253.] #h(4pt) „China kontrolliert über 80 Prozent der weltweiten Wolfram-Produktion" — U.S. Geological Survey, Mineral Commodity Summaries, 2025.


[254.] #h(4pt) „Hallgarten [...] nennt es ein Monopol" — Hallgarten & Company, Research Report zu Materion, 2025.


#v(10pt)
#text(weight: "bold", size: 9pt, font: "Source Sans 3")[Kapitel 15: Risiken und Gegenargumente]
#v(4pt)


[255.] #h(4pt) „Die fünf großen Hyperscaler geben 2026 voraussichtlich über 600 Milliarden Dollar für KI-Infrastruktur aus. Die KI-Einnahmen liegen bei 50 bis 60 Milliarden." — Futurum, Februar 2026. Tatsächlich \$660–\$690 Milliarden CapEx für 2026. Diverse Analysten-Schätzungen, Goldman Sachs, Morgan Stanley.


[256.] #h(4pt) „Geoffrey Hinton, Nobelpreisträger [...] schätzt eine zehn- bis zwanzigprozentige Wahrscheinlichkeit, dass KI innerhalb der nächsten dreißig Jahre zur menschlichen Auslöschung führt." — Geoffrey Hinton, diverse Interviews, 2023–2025.


[257.] #h(4pt) „Über hundert KI-Professoren haben ein Statement unterzeichnet, das KI-Risiko auf eine Stufe mit Pandemien und Atomkrieg stellt." — Center for AI Safety, Statement, Mai 2023.


[258.] #h(4pt) „98 Milliarden Dollar an Rechenzentrums-Projekten wurden 2025 durch lokalen Widerstand gestoppt oder verzögert." — Diverse Quellen, u.a. Data Center Dynamics, 2025.


[259.] #h(4pt) „Daniel Kahneman hat gezeigt, dass der Schmerz eines Verlustes psychologisch etwa doppelt so schwer wiegt" — Daniel Kahneman und Amos Tversky, „Prospect Theory: An Analysis of Decision under Risk", Econometrica, 1979.


[260.] #h(4pt) „Bitcoin ist dreimal um mehr als 70 Prozent gefallen, bevor er neue Höchststände erreichte." — Historische Bitcoin-Kursdaten, CoinGecko/CoinMarketCap.


[261.] #h(4pt) „Yuval Noah Harari [...] 2023 warnte er im Guardian, dass KI-Komplexität katastrophale Finanzkrisen auslösen kann." — Yuval Noah Harari, The Guardian, 2023.


[262.] #h(4pt) „Auf dem Weltwirtschaftsforum 2026 in Davos hat er das zugespitzt: KI erzeugt ‚digitale Einwanderer'" — Yuval Noah Harari, WEF Davos, Januar 2026.


#v(10pt)
#text(weight: "bold", size: 9pt, font: "Source Sans 3")[Kapitel 16: Warum jetzt]
#v(4pt)


[263.] #h(4pt) „Peter Thiel hat ein Konzept beschrieben, das er ‚definite optimism' nennt" — Peter Thiel, Zero to One, Crown Business, 2014.


[264.] #h(4pt) „Howard Marks schreibt in ‚The Most Important Thing', dass die besten Investments oft die sind, die sich am unbequemsten anfühlen." — Howard Marks, The Most Important Thing, Columbia University Press, 2011.


[265.] #h(4pt) „Warren Buffett hat gesagt: ‚Die Börse ist eine Maschine, die Geld von den Ungeduldigen zu den Geduldigen transferiert.'" — Warren Buffett zugeschrieben, häufig zitiert, Originalquelle nicht gesichert.
...
#block(below: 5pt)[
  #text(weight: "semibold", font: "Source Sans 3")[Abbildung 1]
  #h(6pt)
  Die Konvergenz-These — KI, Robotik und Krypto verschmelzen zur Maschinenökonomie
]

#text(size: 8.2pt, fill: rgb("#666"))[Kapitel 1  |  Eigene Darstellung]
#v(4pt)


#block(below: 5pt)[
  #text(weight: "semibold", font: "Source Sans 3")[Abbildung 2]
  #h(6pt)
  250 Jahre technologische Umbrüche — von der Dampfmaschine zur Maschinenökonomie
]
...
#block(below: 5pt)[
  #text(weight: "semibold", font: "Source Sans 3")[Abbildung 3]
  #h(6pt)
  Infrastruktur schlägt Anwendung: das wiederkehrende Muster
]
...
#block(below: 5pt)[
  #text(weight: "semibold", font: "Source Sans 3")[Abbildung 4]
  #h(6pt)
  Die vier Phasen der KI — vom Werkzeug zur autonomen Maschine
]

#text(size: 8.2pt, fill: rgb("#666"))[Kapitel 2  |  Eigene Darstellung]
#v(4pt)


#block(below: 5pt)[
  #text(weight: "semibold", font: "Source Sans 3")[Abbildung 5]
  #h(6pt)
  Das KI-Ökosystem — Labore, Hyperscaler und ihre Verflechtungen
]

#text(size: 8.2pt, fill: rgb("#666"))[Kapitel 2  |  Eigene Darstellung, basierend auf öffentlichen Unternehmensdaten (u.a. Anthropic, OpenAI, Google, Microsoft, NVIDIA)]
#v(4pt)


#block(below: 5pt)[
  #text(weight: "semibold", font: "Source Sans 3")[Abbildung 6]
  #h(6pt)
  DeepSeek — Der Sputnik-Moment der KI (Trainingskosten im Vergleich)
]

#text(size: 8.2pt, fill: rgb("#666"))[Kapitel 2  |  Eigene Darstellung, basierend auf öffentlichen Angaben von DeepSeek und branchenüblichen Schätzungen]
#v(4pt)


#block(below: 5pt)[
  #text(weight: "semibold", font: "Source Sans 3")[Abbildung 7]
  #h(6pt)
  Warum Maschinen kein Bankkonto eröffnen können
]

#text(size: 8.2pt, fill: rgb("#666"))[Kapitel 3  |  Eigene Darstellung]
#v(4pt)


#block(below: 5pt)[
  #text(weight: "semibold", font: "Source Sans 3")[Abbildung 8]
  #h(6pt)
  Stablecoin-Volumen überholt Visa (2024: \$27,6 Billionen)
]

#text(size: 8.2pt, fill: rgb("#666"))[Kapitel 3  |  Eigene Darstellung, basierend auf Daten von Visa Annual Report 2024 und Artemis/DefiLlama]
#v(4pt)


#block(below: 5pt)[
  #text(weight: "semibold", font: "Source Sans 3")[Abbildung 9]
  #h(6pt)
  Von der physischen zur tokenisierten Welt
]

#text(size: 8.2pt, fill: rgb("#666"))[Kapitel 4  |  Eigene Darstellung]
#v(4pt)


#block(below: 5pt)[
  #text(weight: "semibold", font: "Source Sans 3")[Abbildung 10]
  #h(6pt)
  Wer tokenisiert was? Die Wall-Street-Giganten steigen ein
]

#text(size: 8.2pt, fill: rgb("#666"))[Kapitel 4  |  Eigene Darstellung, basierend auf öffentlichen Unternehmensankündigungen (BlackRock, JPMorgan, Goldman Sachs u.a.)]
#v(4pt)


#block(below: 5pt)[
  #text(weight: "semibold", font: "Source Sans 3")[Abbildung 11]
  #h(6pt)
  Anatomie einer Maschinen-Firma (DAO)
]

#text(size: 8.2pt, fill: rgb("#666"))[Kapitel 5  |  Eigene Darstellung]
#v(4pt)


#block(below: 5pt)[
  #text(weight: "semibold", font: "Source Sans 3")[Abbildung 12]
  #h(6pt)
  Die KI-Weltkarte — USA dominiert, China rivalisiert, Europa reguliert
]

#text(size: 8.2pt, fill: rgb("#666"))[Kapitel 6  |  Eigene Darstellung]
#v(4pt)


#block(below: 5pt)[
  #text(weight: "semibold", font: "Source Sans 3")[Abbildung 13]
  #h(6pt)
  Der Chip-Krieg — TSMCs Nadelöhr in der globalen KI-Lieferkette
]
...
#block(below: 5pt)[
  #text(weight: "semibold", font: "Source Sans 3")[Abbildung 14]
  #h(6pt)
  Tech-Giganten werden Energiekonzerne
]

#text(size: 8.2pt, fill: rgb("#666"))[Kapitel 7  |  Eigene Darstellung, basierend auf öffentlichen Unternehmensankündigungen]
#v(4pt)


#block(below: 5pt)[
  #text(weight: "semibold", font: "Source Sans 3")[Abbildung 15]
  #h(6pt)
  Energiehunger der KI — Rechenzentren fressen immer mehr Strom
]

#text(size: 8.2pt, fill: rgb("#666"))[Kapitel 7  |  Eigene Darstellung, basierend auf IEA World Energy Outlook 2025 und Goldman Sachs Research]
#v(4pt)


#block(below: 5pt)[
  #text(weight: "semibold", font: "Source Sans 3")[Abbildung 16]
  #h(6pt)
  Welche Jobs verschwinden, welche entstehen
]

#text(size: 8.2pt, fill: rgb("#666"))[Kapitel 8  |  Eigene Darstellung, basierend auf WEF Future of Jobs Report 2025]
#v(4pt)


#block(below: 5pt)[
  #text(weight: "semibold", font: "Source Sans 3")[Abbildung 17]
  #h(6pt)
  Die Geschichte der Arbeit — vier Epochen und der aktuelle Umbruch
]

#text(size: 8.2pt, fill: rgb("#666"))[Kapitel 8  |  Eigene Darstellung]
#v(4pt)


#block(below: 5pt)[
  #text(weight: "semibold", font: "Source Sans 3")[Abbildung 18]
  #h(6pt)
  Regulierungs-Geschwindigkeiten — USA, China und Europa im Vergleich
]

#text(size: 8.2pt, fill: rgb("#666"))[Kapitel 9  |  Eigene Darstellung]
#v(4pt)


#block(below: 5pt)[
  #text(weight: "semibold", font: "Source Sans 3")[Abbildung 19]
  #h(6pt)
  Szenario 2026–2035 — Die drei Phasen der Maschinenökonomie
]

#text(size: 8.2pt, fill: rgb("#666"))[Kapitel 10  |  Eigene Darstellung]
#v(4pt)


#block(below: 5pt)[
  #text(weight: "semibold", font: "Source Sans 3")[Abbildung 20]
  #h(6pt)
  Von der Tastatur zum Gedanken — Interface-Evolution
]

#text(size: 8.2pt, fill: rgb("#666"))[Kapitel 11  |  Eigene Darstellung]
#v(4pt)


#block(below: 5pt)[
  #text(weight: "semibold", font: "Source Sans 3")[Abbildung 21]
  #h(6pt)
  Das Smart Money wettet auf Unsterblichkeit
]

#text(size: 8.2pt, fill: rgb("#666"))[Kapitel 13  |  Eigene Darstellung, basierend auf öffentlichen Finanzierungsdaten (Crunchbase, PitchBook)]
#v(4pt)


#block(below: 5pt)[
  #text(weight: "semibold", font: "Source Sans 3")[Abbildung 22]
  #h(6pt)
  Die Barbell-Strategie — Kern (60–70%) vs. asymmetrische Wetten (30–40%)
]

#text(size: 8.2pt, fill: rgb("#666"))[Kapitel 14  |  Eigene Darstellung]
#v(4pt)


#block(below: 5pt)[
  #text(weight: "semibold", font: "Source Sans 3")[Abbildung 23]
  #h(6pt)
  Drei Portfolio-Varianten — konservativ, ausgewogen, aggressiv
]
...
#block(below: 5pt)[
  #text(weight: "semibold", font: "Source Sans 3")[Abbildung 24]
  #h(6pt)
  Risiko-Matrix — Wahrscheinlichkeit vs. Impact
]

#text(size: 8.2pt, fill: rgb("#666"))[Kapitel 15  |  Eigene Darstellung]
#v(4pt)


#pagebreak()

#heading(level: 1)[Stichwortverzeichnis]


#v(8pt)
#text(weight: "bold", size: 12pt, fill: gold)[A]
#v(2pt)


#text(size: 9pt)[Agentenökonomie  —  Kap. 3, Kap. 9, Kap. 10]


#v(8pt)
#text(weight: "bold", size: 12pt, fill: gold)[B]
#v(2pt)


#text(size: 9pt)[Barbell-Strategie  —  Vorwort, Kap. 1, Kap. 10, Kap. 14, Kap. 15, Kap. 16]


#text(size: 9pt)[Bitcoin  —  Vorwort, Kap. 1, Kap. 3, Kap. 4, Kap. 6, Kap. 8, Kap. 9, Kap. 10, Kap. 14, Kap. 15, Kap. 16]


#text(size: 9pt)[Blockchain  —  Kap. 3, Kap. 4, Kap. 5, Kap. 8, Kap. 10, Kap. 12, Kap. 14, Kap. 15, Kap. 16]


#text(size: 9pt)[Brain-Computer Interface (BCI)  —  Vorwort, Kap. 7, Kap. 11, Kap. 12, Kap. 13, Kap. 14, Kap. 16]


#v(8pt)
#text(weight: "bold", size: 12pt, fill: gold)[C]
#v(2pt)


#text(size: 9pt)[CBDC  —  Kap. 4, Kap. 16]


#text(size: 9pt)[Circle (USDC)  —  Kap. 3, Kap. 4, Kap. 6, Kap. 14]


#v(8pt)
#text(weight: "bold", size: 12pt, fill: gold)[D]
#v(2pt)


#text(size: 9pt)[DAO  —  Kap. 5, Kap. 12, Kap. 14, Kap. 15, Kap. 16]


#text(size: 9pt)[DeepSeek  —  Kap. 2, Kap. 6, Kap. 9, Kap. 14, Kap. 15]


#text(size: 9pt)[DeFi  —  Kap. 3, Kap. 4, Kap. 5, Kap. 9, Kap. 14, Kap. 16]


#text(size: 9pt)[DePIN  —  Kap. 3, Kap. 5, Kap. 16]


#text(size: 9pt)[DIMO  —  Kap. 3, Kap. 14]


#v(8pt)
#text(weight: "bold", size: 12pt, fill: gold)[E]
#v(2pt)


#text(size: 9pt)[Eisenbahn-Analogie  —  Kap. 1, Kap. 9, Kap. 15]


#text(size: 9pt)[Energie / Stromverbrauch KI  —  Kap. 2, Kap. 7, Kap. 10, Kap. 14, Kap. 15, Kap. 16]


#text(size: 9pt)[Ethereum  —  Vorwort, Kap. 1, Kap. 3, Kap. 4, Kap. 5, Kap. 6, Kap. 8, Kap. 9, Kap. 14, Kap. 15, Kap. 16]


#v(8pt)
#text(weight: "bold", size: 12pt, fill: gold)[G]
#v(2pt)


#text(size: 9pt)[GENIUS Act  —  Kap. 4]


#text(size: 9pt)[Geopolitik  —  Vorwort, Kap. 4, Kap. 6, Kap. 7, Kap. 9, Kap. 15]


#text(size: 9pt)[GPT / ChatGPT / OpenAI  —  Kap. 1, Kap. 2, Kap. 4, Kap. 6, Kap. 7, Kap. 8, Kap. 9, Kap. 10, Kap. 11, Kap. 12, Kap. 13, Kap. 14, Kap. 15, Kap. 16]


#v(8pt)
#text(weight: "bold", size: 12pt, fill: gold)[H]
#v(2pt)


#text(size: 9pt)[HTTP 402 / x402  —  Kap. 3, Kap. 14]


#v(8pt)
#text(weight: "bold", size: 12pt, fill: gold)[I]
#v(2pt)


#text(size: 9pt)[Immortio Bio  —  Kap. 13]


#v(8pt)
#text(weight: "bold", size: 12pt, fill: gold)[K]
#v(2pt)


#text(size: 9pt)[Kernenergie / Atomkraft  —  Vorwort, Kap. 7, Kap. 11, Kap. 14, Kap. 15, Kap. 16]


#text(size: 9pt)[Kurzweil, Ray  —  Kap. 2, Kap. 10, Kap. 12, Kap. 16]


#v(8pt)
#text(weight: "bold", size: 12pt, fill: gold)[L]
#v(2pt)


#text(size: 9pt)[Longevity  —  Kap. 13, Kap. 14, Kap. 16]


#v(8pt)
#text(weight: "bold", size: 12pt, fill: gold)[M]
#v(2pt)


#text(size: 9pt)[MiCA  —  Kap. 4, Kap. 6, Kap. 9, Kap. 14, Kap. 15, Kap. 16]


#text(size: 9pt)[MicroStrategy / Saylor  —  Kap. 14]


#v(8pt)
#text(weight: "bold", size: 12pt, fill: gold)[N]
#v(2pt)


#text(size: 9pt)[Neuralink  —  Kap. 11]


#text(size: 9pt)[NVIDIA  —  Kap. 1, Kap. 2, Kap. 6, Kap. 8, Kap. 9, Kap. 10, Kap. 11, Kap. 13, Kap. 14, Kap. 15, Kap. 16]


#v(8pt)
#text(weight: "bold", size: 12pt, fill: gold)[P]
#v(2pt)


#text(size: 9pt)[peaq  —  Kap. 3, Kap. 5, Kap. 14, Kap. 16]


#v(8pt)
#text(weight: "bold", size: 12pt, fill: gold)[R]
#v(2pt)


#text(size: 9pt)[Regulierung / AI Act  —  Kap. 3, Kap. 4, Kap. 5, Kap. 6, Kap. 8, Kap. 9, Kap. 10, Kap. 12, Kap. 13, Kap. 14, Kap. 15, Kap. 16]


#text(size: 9pt)[Robotik / Roboter  —  Vorwort, Kap. 1, Kap. 2, Kap. 3, Kap. 4, Kap. 5, Kap. 6, Kap. 7, Kap. 8, Kap. 9, Kap. 10, Kap. 11, Kap. 12, Kap. 13, Kap. 14, Kap. 15, Kap. 16]


#v(8pt)
#text(weight: "bold", size: 12pt, fill: gold)[S]
#v(2pt)


#text(size: 9pt)[Senovax  —  Kap. 13]


#text(size: 9pt)[Singularität  —  Kap. 2, Kap. 5, Kap. 12, Kap. 14, Kap. 16]


#text(size: 9pt)[Skin in the Game  —  Vorwort, Kap. 14]


#text(size: 9pt)[Smart Contract  —  Kap. 3, Kap. 4, Kap. 5, Kap. 9, Kap. 12, Kap. 14, Kap. 15, Kap. 16]


#text(size: 9pt)[Solana  —  Kap. 3, Kap. 4, Kap. 5, Kap. 14, Kap. 16]


#text(size: 9pt)[Stablecoin  —  Kap. 3, Kap. 4, Kap. 5, Kap. 6, Kap. 8, Kap. 9, Kap. 10, Kap. 14, Kap. 16]


#v(8pt)
#text(weight: "bold", size: 12pt, fill: gold)[T]
#v(2pt)


#text(size: 9pt)[Taleb, Nassim Nicholas  —  Vorwort, Kap. 1, Kap. 14, Kap. 15, Kap. 16]


#text(size: 9pt)[Thiel, Peter  —  Kap. 1, Kap. 10, Kap. 11, Kap. 14, Kap. 16]


#text(size: 9pt)[Tokenisierung  —  Kap. 3, Kap. 4, Kap. 5, Kap. 8, Kap. 13, Kap. 14, Kap. 15, Kap. 16]


#text(size: 9pt)[TSMC  —  Kap. 6, Kap. 15]


#v(8pt)
#text(weight: "bold", size: 12pt, fill: gold)[U]
#v(2pt)


#text(size: 9pt)[UBI (Universal Basic Income)  —  Kap. 3, Kap. 8, Kap. 9, Kap. 10, Kap. 11]


#text(size: 9pt)[USDC  —  Kap. 3, Kap. 4, Kap. 5, Kap. 6, Kap. 14]


#text(size: 9pt)[USDT / Tether  —  Kap. 3, Kap. 4, Kap. 6]


#v(8pt)
#text(weight: "bold", size: 12pt, fill: gold)[W]
#v(2pt)


#text(size: 9pt)[Waymo  —  Kap. 2, Kap. 5, Kap. 10, Kap. 14, Kap. 15]


#pagebreak()

#heading(level: 1)[Über den Autor]
...
Thomas Huhn lebt am Starnberger See. Er ist Vater zweier Töchter und Großvater von Mila und Malou. Begeisterter Gym-Athlet und ehemaliger Amateur-Rockmusiker.


#v(6pt)
#text(font: "Source Sans 3", size: 9.8pt, fill: navy)[theaispecies.world]
