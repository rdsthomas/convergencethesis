...
#align(center)[#text(size: 9pt, style: "italic", fill: rgb("666666"))[Abbildung 1: Die Konvergenz-These — KI, Robotik und Krypto verschmelzen zur Maschinenökonomie]]
...
#align(center)[#text(size: 9pt, style: "italic", fill: rgb("666666"))[Abbildung 2: 250 Jahre technologische Umbrüche — von der Dampfmaschine zur Maschinenökonomie]]
...
#align(center)[#text(size: 9pt, style: "italic", fill: rgb("666666"))[Abbildung 3: Infrastruktur schlägt Anwendung — das wiederkehrende Muster]]
...
#figure(
  image("../epub-build/images/01-250-jahre-umbrueche-color.png", width: 85%),
  caption: [Abbildung 2: 250 Jahre technologische Umbrüche — Gewinner und Verlierer jeder Revolution],
) <fig-01_250_jahre_umbrueche_color>


#figure(
  image("../epub-build/images/01b-infrastruktur-vs-anwendung-color.png", width: 85%),
  caption: [Abbildung 3: Infrastruktur schlägt Anwendung — das gleiche Muster in vier Revolutionen],
) <fig-01b_infrastruktur_vs_anwendung_color>
...
#align(center)[#text(size: 9pt, style: "italic", fill: rgb("666666"))[Abbildung 4: Die vier Phasen der KI — vom Werkzeug zur autonomen Maschine]]
...
#align(center)[#text(size: 9pt, style: "italic", fill: rgb("666666"))[Abbildung 5: Das KI-Ökosystem — Labore, Hyperscaler und ihre Verflechtungen]]
...
#figure(
  image("../epub-build/images/02a-vier-phasen-ki-color.png", width: 85%),
  caption: [Abbildung 4: Die vier Phasen der KI — vom Werkzeug zur autonomen Maschine],
) <fig-02a_vier_phasen_ki_color>


#figure(
  image("../epub-build/images/02b-ki-landscape-color.png", width: 85%),
  caption: [Abbildung 5: Das KI-Ökosystem — Labore, Hyperscaler und ihre Verflechtungen],
) <fig-02b_ki_landscape_color>


#figure(
  image("../epub-build/images/02c-deepseek-kosten-color.png", width: 85%),
  caption: [Abbildung 6: DeepSeek — Der Sputnik-Moment der KI (Trainingskosten im Vergleich)],
) <fig-02c_deepseek_kosten_color>
...
#align(center)[#text(size: 9pt, style: "italic", fill: rgb("666666"))[Abbildung 8: Stablecoin-Volumen überholt Visa (2024: \$27,6 Billionen)]]
...
#figure(
  image("../epub-build/images/03a-maschine-vs-bank-color.png", width: 85%),
  caption: [Abbildung 7: Maschine vs. Bankensystem — warum Krypto die Antwort ist],
) <fig-03a_maschine_vs_bank_color>


#figure(
  image("../epub-build/images/03b-stablecoin-vs-visa-color.png", width: 85%),
  caption: [Abbildung 8: Stablecoin-Volumen überholt Visa (2024: \$27.6 Billionen)],
) <fig-03b_stablecoin_vs_visa_color>
...
#align(center)[#text(size: 9pt, style: "italic", fill: rgb("666666"))[Abbildung 10: Wer tokenisiert was? Die Wall-Street-Giganten steigen ein]]
...
#figure(
  image("../epub-build/images/03c-tokenisierung-flow-color.png", width: 85%),
  caption: [Abbildung 9: Von der physischen zur tokenisierten Welt],
) <fig-03c_tokenisierung_flow_color>


#figure(
  image("../epub-build/images/03d-wer-tokenisiert-was-color.png", width: 85%),
  caption: [Abbildung 10: Wer tokenisiert was? Die Wall-Street-Giganten steigen ein],
) <fig-03d_wer_tokenisiert_was_color>
...
#figure(
  image("../epub-build/images/03e-dao-anatomie-color.png", width: 85%),
  caption: [Abbildung 11: Anatomie einer Maschinen-Firma (DAO) — vom Auto zur autonomen Wirtschaftseinheit],
) <fig-03e_dao_anatomie_color>
...
#align(center)[#text(size: 9pt, style: "italic", fill: rgb("666666"))[Abbildung 13: Der Chip-Krieg — TSMCs Nadelöhr in der globalen KI-Lieferkette]]
...
#figure(
  image("../epub-build/images/04a-ki-weltkarte-color.png", width: 85%),
  caption: [Abbildung 12: Die KI-Weltkarte — USA dominiert, China rivalisiert, Europa reguliert],
) <fig-04a_ki_weltkarte_color>


#figure(
  image("../epub-build/images/04b-chip-krieg-tsmc-color.png", width: 85%),
  caption: [Abbildung 13: Der Chip-Krieg — TSMCs Nadelöhr in der globalen KI-Lieferkette],
) <fig-04b_chip_krieg_tsmc_color>
...
#align(center)[#text(size: 9pt, style: "italic", fill: rgb("666666"))[Abbildung 15: Energiehunger der KI — Rechenzentren fressen immer mehr Strom]]
...
#figure(
  image("../epub-build/images/05a-kraftwerk-kaeufer-color.png", width: 85%),
  caption: [Abbildung 14: Tech-Giganten werden Energiekonzerne — die größten Kraftwerk-Deals der KI-Ära],
) <fig-05a_kraftwerk_kaeufer_color>


#figure(
  image("../epub-build/images/05b-energiehunger-ki-color.png", width: 85%),
  caption: [Abbildung 15: Energiehunger der KI — US-Rechenzentren fressen 12% des Stromnetzes bis 2030],
) <fig-05b_energiehunger_ki_color>
...
#align(center)[#text(size: 9pt, style: "italic", fill: rgb("666666"))[Abbildung 17: Die Geschichte der Arbeit — vier Epochen und der aktuelle Umbruch]]
...
#figure(
  image("../epub-build/images/06a-jobs-verschwinden-entstehen-color.png", width: 85%),
  caption: [Abbildung 16: Welche Jobs verschwinden, welche entstehen (WEF Future of Jobs Report)],
) <fig-06a_jobs_verschwinden_entstehen_color>


#figure(
  image("../epub-build/images/06b-geschichte-der-arbeit-color.png", width: 85%),
  caption: [Abbildung 17: Die Geschichte der Arbeit — vier Epochen und der aktuelle Umbruch],
) <fig-06b_geschichte_der_arbeit_color>
...
#figure(
  image("../epub-build/images/07-regulierung-ampel-color.png", width: 85%),
  caption: [Abbildung 18: Regulierungs-Geschwindigkeiten — USA, China und Europa im Vergleich],
) <fig-07_regulierung_ampel_color>
...
#figure(
  image("../epub-build/images/08-szenario-2026-2035-color.png", width: 85%),
  caption: [Abbildung 19: Die Zeitleiste 2026–2035 — vom KI-Agenten zum Roboter-Haushalt],
) <fig-08_szenario_2026_2035_color>
...
#figure(
  image("../epub-build/images/09-bci-interface-evolution-color.png", width: 85%),
  caption: [Abbildung 20: Die Evolution der Interfaces — von der Lochkarte zum Gedanken],
) <fig-09_bci_interface_evolution_color>
...
#figure(
  image("../epub-build/images/11-longevity-smart-money-color.png", width: 85%),
  caption: [Abbildung 21: Das Smart Money wettet auf Unsterblichkeit — die größten Longevity-Investments],
) <fig-11_longevity_smart_money_color>
...
#align(center)[#text(size: 9pt, style: "italic", fill: rgb("666666"))[Abbildung 23: Drei Portfolio-Varianten — konservativ, ausgewogen, aggressiv]]
...
#figure(
  image("../epub-build/images/12a-barbell-strategie-color.png", width: 85%),
  caption: [Abbildung 22: Die Barbell-Strategie — Kern (60–70%) vs. asymmetrische Wetten (30–40%)],
) <fig-12a_barbell_strategie_color>


#figure(
  image("../epub-build/images/12b-portfolio-varianten-color.png", width: 85%),
  caption: [Abbildung 23: Drei Portfolio-Varianten — konservativ, ausgewogen, aggressiv],
) <fig-12b_portfolio_varianten_color>
...
#figure(
  image("../epub-build/images/13-risiko-matrix-color.png", width: 85%),
  caption: [Abbildung 24: Risiko-Matrix — Wahrscheinlichkeit vs. Impact der größten Risiken],
) <fig-13_risiko_matrix_color>
